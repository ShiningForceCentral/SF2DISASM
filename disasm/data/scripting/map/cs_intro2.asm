...
IntroCutscene2:
		textCursor $106A        
						; Initial text line $106A : "Quite a storm.{D2}"
		mapLoad $41,$7,$2
		...
		csWait $14
		nextSingleText $0,$81   
						; "It's unusual for this time{N}of year.{D2}"
		csWait $1E
		nextSingleText $0,$82   
						; "Excuse me, your majesty.{D2}"
		setEntityDir $81,$3
		moveEntity $82,$FF,$1,$3
		endMove $8080
		setCamDest $7,$4
		nextSingleText $0,$81   
						; "Is it time to go to the{N}Ancient Tower?{D2}"
		entityNod $82
		nextSingleText $0,$82   
						; "Yes, sire.{D2}"
		...
		endMove $8080
		nextSingleText $0,$81   
						; "It's stormy outside.{N}Be careful.{D2}"
		entityNod $82
		csWait $1E
		setCameraEntity $82
		...
		nextSingleText $0,$81   
						; "Excuse me, sire?{D2}"
		nextSingleText $80,$80  
						; "I have a bad feeling...{N}Oh, well.{D2}"
		csWait $28
		setEntityDir $81,$2
		csWait $28
		...
		nextSingleText $0,$81   
						; "Oh, a gust of wind!{D2}"
		csWait $14
		entityShiver $80
		setEntityDir $80,$3
		nextSingleText $80,$80  
						; "Make sure all the doors and{N}windows are shut!{D2}"
		playSound SFX_SPELL_CAST
		csWait $1E
