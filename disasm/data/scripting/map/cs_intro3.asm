...
IntroCutscene3:
		textCursor $1077        
						; Initial text line $1077 : "Well?{D2}"
		mapLoad $2A,$15,$1
		...
		entityShiver $80
		nextSingleText $0,$80   
						; "Ugh!  Ugghhh!{N}Phew...I can't...{D2}"
		moveEntity $81,$FF,$1,$1
		moreMove $A,$1
		endMove $8080
		setEntityDir $80,$0
		nextSingleText $0,$81   
						; "You wimp!{N}Let me do it!{D2}"
		entityShiver $80
		csWait $14
		moveEntity $81,$0,$2,$1
		moreMove $B,$1
		...
		csWait $14
		nextSingleText $80,$5   
						; "This time, I'll pull both of{N}the jewels at the same time!{D2}"
		...
		nextSingleText $FF,$FF  
						; "{NAME;5} the thief{N}grabbed the two jewels.{D2}"
		csWait $14
		nextSingleText $80,$5   
						; "One...two...{D2}"
		entityShiver $5
		...
		setEntityDir $80,$3
		nextSingleText $0,$81   
						; "You did it!{N}You have the legendary{N}jewels!{D2}"
		csWait $14
		setEntityDir $5,$1
		entitySprite $5,$3B
		setActscript $5,$FF,eas_Init
		...
		entityShakeHead $5
		nextSingleText $80,$5   
						; "Oh, I got them!{N}I have the legendary{N}jewels!  Bravo!{D2}"
		setActscript $5,$FF,eas_Jump
		setActscript $5,$FF,eas_Jump
		csWait $28
		setActscript $5,$FF,eas_Jump
		...
		setQuakeAmount $0
		nextSingleText $80,$5   
						; "We must escape from the{N}shrine!  Follow me!{D2}"
		setQuakeAmount $5
		customActscript $5,$FF
		dc.w $10                
