...
word_44DEA:
		dc.w $30                
						; 0030 BRANCH TO CURRENT ADDR. + $54
		dc.w eas_ControlledCharacter-word_44DEA
		dc.w 4                  
						; 0004 MOVE TO RELATIVE DEST X=X+$1 Y=Y+$FFFF
		dc.w 1
		dc.w $FFFF
		dc.w 1                  
						; 0001 WAIT UNTIL DESTINATION
word_44DF6:
		dc.w $30                
						; 0030 BRANCH TO CURRENT ADDR. + $48
		dc.w eas_ControlledCharacter-word_44DF6
		dc.w 4                  
						; 0004 MOVE TO RELATIVE DEST X=X+$0 Y=Y+$FFFF
		dc.w 0
		dc.w $FFFF
		dc.w 1                  
						; 0001 WAIT UNTIL DESTINATION
word_44E02:
		dc.w $30                
						; 0030 BRANCH TO CURRENT ADDR. + $3C
		dc.w eas_ControlledCharacter-word_44E02
		dc.w 4                  
						; 0004 MOVE TO RELATIVE DEST X=X+$FFFF Y=Y+$FFFF
		dc.w $FFFF
		dc.w $FFFF
		dc.w 1                  
						; 0001 WAIT UNTIL DESTINATION
word_44E0E:
		dc.w $30                
						; 0030 BRANCH TO CURRENT ADDR. + $30
		dc.w eas_ControlledCharacter-word_44E0E
		dc.w 4                  
						; 0004 MOVE TO RELATIVE DEST X=X+$FFFF Y=Y+$0
		dc.w $FFFF
		dc.w 0
		dc.w 1                  
						; 0001 WAIT UNTIL DESTINATION
word_44E1A:
		dc.w $30                
						; 0030 BRANCH TO CURRENT ADDR. + $24
...
word_44E26:
		dc.w $30                
						; 0030 BRANCH TO CURRENT ADDR. + $18
...
word_44E32:
		dc.w $30                
						; 0030 BRANCH TO CURRENT ADDR. + $C
		dc.w eas_ControlledCharacter-word_44E32
		dc.w 4                  
						; 0004 MOVE TO RELATIVE DEST X=X+$1 Y=Y+$1
		dc.w 1
		dc.w 1
		dc.w 1                  
						; 0001 WAIT UNTIL DESTINATION
...
word_45086:
		...
		dc.w $FFFF
		dc.w 4                  
						; 0004 MOVE TO RELATIVE DEST X=X+$FFFE Y=Y+$FFFE
		dc.w $FFFE
		dc.w $FFFE
		dc.w 1                  
						; 0001 WAIT UNTIL DESTINATION
eas_4509E:
		...
		dc.w $FF00
		dc.w 4                  
						; 0004 MOVE TO RELATIVE DEST X=X+$FFFE Y=Y+$2
		dc.w $FFFE
		dc.w 2
		dc.w 1                  
						; 0001 WAIT UNTIL DESTINATION
		...
		dc.w $FFFF
		dc.w 4                  
						; 0004 MOVE TO RELATIVE DEST X=X+$2 Y=Y+$2
		dc.w 2
		dc.w 2
		dc.w 1                  
						; 0001 WAIT UNTIL DESTINATION
		...
		dc.w $FF00
		dc.w 4                  
						; 0004 MOVE TO RELATIVE DEST X=X+$2 Y=Y+$FFFE
		dc.w 2
		dc.w $FFFE
		dc.w 1                  
						; 0001 WAIT UNTIL DESTINATION
...
word_450EA:
		...
		dc.w $FFFF
		dc.w 4                  
						; 0004 MOVE TO RELATIVE DEST X=X+$FFFD Y=Y+$FFFD
		dc.w $FFFD
		dc.w $FFFD
		dc.w 1                  
						; 0001 WAIT UNTIL DESTINATION
		...
		dc.w $FF00
		dc.w 4                  
						; 0004 MOVE TO RELATIVE DEST X=X+$FFFD Y=Y+$3
		dc.w $FFFD
		dc.w 3
		dc.w 1                  
						; 0001 WAIT UNTIL DESTINATION
		...
		dc.w $FFFF
		dc.w 4                  
						; 0004 MOVE TO RELATIVE DEST X=X+$3 Y=Y+$3
		dc.w 3
		dc.w 3
		dc.w 1                  
						; 0001 WAIT UNTIL DESTINATION
		...
		dc.w $FF00
		dc.w 4                  
						; 0004 MOVE TO RELATIVE DEST X=X+$3 Y=Y+$FFFD
		dc.w 3
		dc.w $FFFD
		dc.w 1                  
						; 0001 WAIT UNTIL DESTINATION
word_4514A:
		...
		dc.w $A
		dc.w $14                
						; 0014 SET ANIM COUNTER $FFFF
		dc.w $FFFF
word_4516A:
		dc.w $30                
						; 0030 BRANCH TO CURRENT ADDR. + $92
		...
		dc.w 5
		dc.w 4                  
						; 0004 MOVE TO RELATIVE DEST X=X+$0 Y=Y+$0
		dc.w 0
		dc.w 0
		dc.w $15                
						; 0015 SET ABILITY TO CHANGE FACING $FFFF
		dc.w $FFFF
word_451A0:
		dc.w $30                
						; 0030 BRANCH TO CURRENT ADDR. + $5C
		...
		dc.w 0
		dc.w 4                  
						; 0004 MOVE TO RELATIVE DEST X=X+$0 Y=Y+$FFFE
		dc.w 0
		dc.w $FFFE
		dc.w 1                  
						; 0001 WAIT UNTIL DESTINATION
		dc.w 4                  
						; 0004 MOVE TO RELATIVE DEST X=X+$2 Y=Y+$0
		dc.w 2
		dc.w 0
		dc.w 1                  
						; 0001 WAIT UNTIL DESTINATION
...
word_451DC:
		dc.w $30                
						; 0030 BRANCH TO CURRENT ADDR. + $20
