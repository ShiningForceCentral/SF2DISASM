...
bbcs_39:
		textCursor $BD5         
						; Initial text line $BD5 : "I just heard that Geshp{N}lost.{W2}"
		...
		jumpIfFlagClear $4C,cs_4E40C
						; Zynk is a follower
		entityPosDir $1A,$8,$7,$3
cs_4E40C:
		jumpIfFlagClear $47,cs_4E41A
						; Lemon is a follower
...
cs_4E41A:
		...
		setCamDest $3,$12
		nextText $0,$80         
						; "I just heard that Geshp{N}lost.{W2}"
		nextSingleText $0,$80   
						; "All greater devils have been{N}defeated except for Odd Eye.{W1}"
		moveEntity $80,$FF,$3,$1
		endMove $8080
		nextText $0,$80         
						; "This is a good chance for us{N}to become greater devils!{W2}"
		nextSingleText $0,$80   
						; "I'm sure Zeon will promote{N}us if we can get the jewel.{W1}"
		...
		setEntityDir $80,$1
		nextSingleText $0,$80   
						; "Excellent!{N}Welcome to your graveyard!{W1}"
		csc_end                 
