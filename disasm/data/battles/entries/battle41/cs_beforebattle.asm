...
bbcs_41:
		textCursor $C0B         
						; Initial text line $C0B : "Who are you?!{N}Oh, are you from Granseal?{W1}"
...
cs_4ED48:
		...
		fadeInB
		nextSingleText $0,$80   
						; "Who are you?!{N}Oh, are you from Granseal?{W1}"
		setEntityDir $0,$1
		setCamDest $C,$4
		nextSingleText $0,$80   
						; "But, Odd Eye went to...{W2}"
		moveEntity $80,$FF,$3,$2
		endMove $8080
		nextText $0,$80         
						; "Impossible!{N}He was defeated?{W2}"
		nextText $0,$80         
						; "Inconceivable!  But...{N}OK, I'll stop you here.{W2}"
		nextSingleText $0,$80   
						; "You shall die now!{W1}"
		csc_end                 
