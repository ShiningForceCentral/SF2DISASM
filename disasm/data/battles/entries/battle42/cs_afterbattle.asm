...
abcs_battle42:
		textCursor $C22         
						; Initial text line $C22 : "Auuugh...{W1}"
...
cs_4EF5E:
		...
		entityShiver $80
		nextText $C0,$80        
						; "I've never lost to anybody{N}but the gods.{W2}"
		nextSingleText $C0,$80  
						; "I don't understand!{W1}"
		setEntityDir $80,$1
		nextSingleText $0,$1C   
						; "Oh, King Galam...poor{N}King Galam....{W1}"
		entityShiver $81
		setEntityDir $7,$2
		...
		setEntityDir $81,$2
		nextSingleText $C0,$81  
						; "Sir Astral?  Oh, what{N}happened?{W1}"
		setEntityDir $81,$3
		csWait $1E
		setEntityDir $81,$1
		csWait $1E
		...
		setActscript $7,$FF,eas_Jump
		nextSingleText $0,$7    
						; "I'm {NAME;7}.  And this is{N}our leader.{W1}"
		moveEntity $7,$FF,$3,$2
		moreMove $2,$1
		endMove $8080
		setEntityDir $81,$3
		...
		setEntityDir $1F,$3
		nextSingleText $0,$1F   
						; "{NAME;7}, don't bother them!{N}This is a private moment!{W1}"
		setQuakeAmount $2
		csWait $1E
		setQuakeAmount $0
		csWait $5
		...
		csWait $78
		nextSingleText $0,$7    
						; "An earthquake!{N}Deep below us....{W1}"
		nextSingleText $0,$1C   
						; "Something is coming up{N}through the earth...{W1}"
		setEntityDir $1F,$1
		nextSingleText $0,$1F   
						; "I almost forgot...about...{N}the other devil....{W1}"
		moveEntity $0,$0,$1,$2
		moreMove $0,$1
		endMove $8080
		moveEntity $1C,$0,$1,$1
		...
		csWait $28
		nextSingleText $0,$1F   
						; "This doesn't look promising.{W1}"
		playSound SFX_BATTLEFIELD_DEATH
		...
		nextSingleText $C0,$82  
						; "Gggggrrr...you destroyed my{N}minions!{W1}"
		nextSingleText $0,$1F   
						; "Zeon!{W1}"
		nextText $C0,$82        
						; "You resisted me....{W2}"
		...
		setEntityDir $1F,$2
		nextSingleText $0,$1F   
						; "{LEADER}, we had better{N}run away and return later.{W1}"
		setEntityDir $7,$2
		nextSingleText $0,$7    
						; "Sir Astral, we can't!{W1}"
		setEntityDir $1F,$0
		nextSingleText $0,$1F   
						; "Why not?{W1}"
		nextSingleText $0,$7    
						; "Princess Elis fainted when{N}she saw Zeon.{W1}"
		setEntityDir $1F,$3
		setEntityDir $1C,$2
		setActscript $1F,$FF,eas_Jump
		nextSingleText $0,$1F   
		...
		csWait $1E
		nextSingleText $0,$1C   
						; "And now we're surrounded{N}by devils.{W1}"
		csWait $5
		setActscript $7,$0,eas_461B6
		setEntityDir $1F,$2
		csWait $28
		setEntityDir $1F,$1
		nextText $0,$1F         
						; "{LEADER}, believe in your{N}sword and the jewel!{N}We must fight Zeon now!{W1}"
		nextSingleText $0,$1F   
						; "Let's go!{W1}"
		setEntityDir $0,$1
		setEntityDir $7,$1
