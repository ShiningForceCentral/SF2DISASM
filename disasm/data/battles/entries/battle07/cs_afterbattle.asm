...
abcs_battle07:
		textCursor $951         
						; Initial text line $951 : "King Galam!  You've lost{N}your followers!{W1}"
		...
		endMove $8080
		nextSingleText $0,$86   
						; "King Galam!  You've lost{N}your followers!{W1}"
		nextSingleText $0,$85   
						; "Princess Elis, come here.{N}Come here.{W1}"
		setCamDest $8,$D
		nextSingleText $0,$84   
						; "Father...{W1}"
		...
		setEntityDir $82,$3
		nextText $C0,$82        
						; "What a good hostage she is!{W2}"
		nextSingleText $C0,$82  
						; "Stay there!  Or she'll die!{W1}"
		moveEntity $85,$FF,$1,$1
		endMove $8080
		nextSingleText $0,$85   
						; "Stop this, King Galam!{N}Leave her alone!  Please!{W1}"
		moveEntity $86,$FF,$1,$1
		endMove $8080
		nextSingleText $0,$86   
						; "Princess Elis...I'll save{N}you!{W1}"
		nextSingleText $FF,$FF  
						; "King Galam murmurs a{N}magic spell.{W1}"
		setEntityDir $84,$0
		csWait $28
		setActscript $84,$FF,eas_Jump
		setEntityDir $84,$3
		...
		entityShakeHead $85
		nextSingleText $0,$85   
						; "Don't worry...I'm fine.{W1}"
		nextSingleText $C0,$82  
						; "That was just a warning!{N}Do you want me to attack{N}again?{W1}"
		...
		nextText $0,$83         
						; "King Granseal...{W2}"
		nextSingleText $0,$83   
						; "Galam, please tell me...{N}What's in this tower?{N}In Ground Seal?{W1}"
		nextSingleText $C0,$82  
						; "You really want to know?{N}Ha, ha!  OK, I'll tell you.{W1}"
		setCamDest $8,$D
		setEntityDir $82,$1
		nextSingleText $FF,$FF  
						; "King Galam displays the{N}Jewel of Evil.{W1}"
		nextSingleText $C0,$82  
						; "I'll open the door to the{N}Evil World!{N}Observe!{W1}"
		...
		setEntityDir $82,$3
		nextSingleText $C0,$82  
						; "Now do you understand?  I{N}plan on opening the sealed{N}door!{W1}"
		nextSingleText $0,$83   
						; "Why?  What's inside?{W1}"
		nextSingleText $C0,$82  
						; "You'll find out soon enough.{W1}"
		setEntityDir $82,$1
		entityFlashWhite $82,$28
		nextSingleText $0,$85   
						; "What's he doing now??{W1}"
		nextSingleText $C0,$82  
						; "Here they come!{N}Ha, ha, ha!{W1}"
		nextSingleText $0,$83   
						; "What?{W1}"
		setCamDest $8,$3
		entitySprite $80,$B4
		...
		dc.w $8080              
						; 0014 END OF CUSTOM ACTSCRIPT
		nextSingleText $0,$0    
						; "I have a bad feeling about{N}this!{W1}"
		moveEntity $80,$0,$3,$5
		endMove $8080
		...
		setCamDest $8,$8
		nextSingleText $0,$86   
						; "Princess Elis is swallowed{N}by a light tube.{W1}"
		moveEntity $80,$0,$3,$5
		endMove $8080
		setEntityDir $84,$1
		...
		setCamDest $8,$D
		nextSingleText $C0,$82  
						; "Farewell for now!{N}Going up!{W1}"
		customActscript $82,$FF
		dc.w $10                
		...
		endMove $8080
		nextSingleText $0,$83   
						; "He's using the light tube{N}to go through the doorway!{W1}"
		setCamDest $8,$11
		nextSingleText $0,$83   
						; "Save her.  Save her now!{W1}"
		csWait $5
		setActscript $83,$0,eas_461B6
		csWait $78
		setEntityDir $83,$3
		nextSingleText $0,$83   
						; "{LEADER}, you're good{N}at performing acrobatics!{W1}"
		...
		nextSingleText $0,$86   
						; "Y...yes...but how?{W1}"
		nextSingleText $0,$83   
						; "Throw {LEADER} towards{N}the light tubes!{W1}"
		...
		endMove $8080
		nextSingleText $0,$83   
						; "Oops, we lost our grip!{N}But...{W1}"
		moveEntity $80,$0,$1,$8
		endMove $8080
		moveEntity $81,$0,$1,$8
		endMove $8080
		...
		setQuakeAmount $0
		nextSingleText $FF,$FF  
						; "{LEADER} grasped the{N}Jewel of Evil.{W1}"
		...
		setCameraEntity $FFFF
		nextSingleText $C0,$82  
						; "Don't touch my jewel!{N}Don't touch it!{W1}"
		setCameraEntity $0
		entityShiver $0
		stopEntity $0
		setCameraEntity $FFFF
		nextText $C0,$82        
						; "I said, don't touch it!{W2}"
		setCameraEntity $0
		setCameraEntity $FFFF
		nextSingleText $C0,$82  
						; "I'll shake you off!{W1}"
		setCameraEntity $0
		entityShiver $0
		stopEntity $0
		setCameraEntity $FFFF
		nextSingleText $C0,$82  
						; "You're still there?{W1}"
		setCameraEntity $0
		setCameraEntity $FFFF
		nextSingleText $0,$0    
						; "Wow!  He's so brave.  Hmmm....{W1}"
		setCameraEntity $0
		setCameraEntity $FFFF
		nextSingleText $C0,$82  
						; "I've almost got you now!{W1}"
		setCameraEntity $0
		entityShiver $0
		stopEntity $0
		setCameraEntity $FFFF
		nextSingleText $0,$84   
						; "No, you'll fall if you{N}open your hands now!{W1}"
		setCameraEntity $0
		setCameraEntity $FFFF
		nextSingleText $FF,$FF  
						; "{LEADER}'s jewel suddenly{N}flared!{W1}"
		setCameraEntity $0
		...
		setCameraEntity $FFFF
		nextSingleText $C0,$82  
						; "Whoa!  The light...the{N}light!{W1}"
		setCameraEntity $0
		setCameraEntity $FFFF
		nextSingleText $FF,$FF  
						; "The Jewel of Evil fused{N}to {LEADER}'s neck.{W1}"
		setCameraEntity $0
		csc45 $38               
						; (null)
		customActscript $0,$FF
		...
		csc45 $28               
						; (null)
		nextSingleText $FF,$FF  
						; "The two jewels merge{N}together.{W1}"
		setF $181               
		...
		nextSingleText $C0,$82  
						; "I have to go back and get{N}my jewel....{N}Noooooooo!{W1}"
		setActscript $82,$0,eas_463AE
		animEntityFadeInOut $80,$6
		nextSingleText $0,$84   
						; "Father...{N}{LEADER}...help meeeeee!{W1}"
		...
		csWait $3C
		nextSingleText $0,$85   
						; "She's gone....{N}Elis!{W1}"
		nextSingleText $0,$83   
						; "We couldn't help the{N}Princess.{W1}"
		entitySprite $0,$0
		setActscript $0,$FF,eas_Init
		startEntity $0
		entityShakeHead $0
		nextSingleText $C0,$0   
						; "(Sigh)....{W1}"
		nextSingleText $0,$83   
						; "{LEADER}, why do you{N}have two jewels?{W1}"
		nextSingleText $FF,$FF  
						; "{LEADER} explains{N}what happened.{W1}"
		entityNod $83
		entityNod $0
		nextSingleText $0,$83   
						; "Indeed, perhaps...these{N}jewels are the key to{N}solving this....{W1}"
		setQuakeAmount $2
		csWait $5
		...
		nextSingleText $0,$83   
						; "What?! Another earthquake?{W1}"
		nextSingleText $0,$86   
						; "Wow!  It's getting worse!{W1}"
		moveEntity $86,$FF,$3,$1
		endMove $8080
		setEntityDir $86,$2
		nextSingleText $C0,$85  
						; "Whoa!{W1}"
		nextSingleText $0,$86   
						; "Sssiirrr Astral!{N}What should we do?!{W1}"
		nextSingleText $0,$83   
						; "I'm not sure.{W1}"
		...
		setEntityDir $83,$3
		nextText $0,$83         
						; "Let's get out of here!{W2}"
		nextSingleText $0,$83   
						; "We'll come back later with{N}soldiers to rescue her.{W1}"
		setEntityDir $83,$2
		nextSingleText $C0,$85  
						; "But, Sir Astral...{W1}"
		setEntityDir $83,$3
		nextSingleText $0,$83   
						; "He won't budge.{N}We'll have to carry him.{W1}"
		nextSingleText $FF,$FF  
						; "The Minister nods.{W1}"
		entityNod $83
		moveEntity $83,$0,$2,$1
		endMove $8080
		moveEntity $86,$FF,$3,$1
		...
		setEntityDir $83,$1
		nextText $0,$83         
						; "{LEADER}, you'll be{N}buried in the tower!{W2}"
		nextSingleText $0,$83   
						; "Come on!{W1}"
		csWait $32
