...
abcs_battle04:
		dc.w 4                  
						; 0004 INIT TEXT CURSOR 90F : "Your battle strategy was{N}wonderful!  I praise you.{W1}"
		dc.w $90F
		dc.w $37                
						; 0037 LOAD MAP AND FADE IN 42 9 10
		dc.w $42
		dc.w 9
		dc.w $10
		dc.w $42                
						; 0042 RELATED TO LOADING MAP ENTITIES 49A6A
		dc.l word_49A6A
		dc.w $15                
		...
		dc.l eas_Init           
		dc.w $19                
						; 0019 SET ENTITY POS AND FACING 1 E 15 3
		dc.b 1
		dc.b $E
		dc.b $15
		dc.b 3
		dc.w $19                
						; 0019 SET ENTITY POS AND FACING 2 C 15 3
		dc.b 2
		dc.b $C
		dc.b $15
		dc.b 3
		dc.w $19                
						; 0019 SET ENTITY POS AND FACING 3 D 16 3
		dc.b 3
		dc.b $D
		dc.b $16
		dc.b 3
		dc.w $19                
						; 0019 SET ENTITY POS AND FACING 4 B 16 3
		dc.b 4
		dc.b $B
		dc.b $16
		dc.b 3
		...
		dc.w 0
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 1C : "Your battle strategy was{N}wonderful!  I praise you.{W1}"
		dc.w $1C
		dc.b $80                
						; WAIT 5
		dc.b 5
		...
		dc.b $50
		dc.w $19                
						; 0019 SET ENTITY POS AND FACING 1C 12 16 1
		dc.b $1C
		dc.b $12
		dc.b $16
		dc.b 1
		...
		dc.b 0
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 1C : "But, I can't let you escape.{W1}"
		dc.w $1C
		dc.w $14                
		...
		dc.w $8080
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 1C : "That lad is their leader.{N}Take him!{W1}"
		dc.w $1C
		dc.w $2D                
						; 002D MOVE ENTITY 82 0 1 1
		dc.b $82
		dc.b 0
		dc.b 1
		dc.b 1
		...
		dc.b 3
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 1C : "Don't worry.  He has only{N}fainted.  Take them to Galam!{W1}"
		dc.w $1C
		dc.w $2D                
						; 002D MOVE ENTITY 1C FF 0 1
		dc.b $1C
		...
		dc.w $8080
		dc.w 7                  
						; 0007 EXECUTE MAP SYSTEM EVENT 11000000
		dc.l $11000000
		dc.w $FFFF              
