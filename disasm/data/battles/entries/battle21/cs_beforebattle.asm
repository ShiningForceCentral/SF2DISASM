...
bbcs_21:        textCursor $A10         ; Initial text line $A10 : "(Sniff, sniff)...I smell{N}more invaders from the east.{W2}"
		loadMapFadeIn $43,$5,$12
		loadMapEntities ce_4B84C; Entity data to figure out and format
