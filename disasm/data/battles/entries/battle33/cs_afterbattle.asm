...
abcs_battle33:  textCursor $B3C         ; Initial text line $B3C : "There may be some survivors{N}somewhere.{W1}"
		loadMapFadeIn $1F,$8,$6
		loadMapEntities ce_4D322; Entity data to figure out and format
