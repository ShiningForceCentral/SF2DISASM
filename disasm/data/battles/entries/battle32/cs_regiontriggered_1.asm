...
rbcs_battle32:
		textCursor $B21         
						; Initial text line $B21 : "I'm tired of this.  I can no{N}longer fight for devils.{W1}"
		...
		csWait $3C
		nextSingleText $0,$17   
						; "I'm tired of this.  I can no{N}longer fight for devils.{W1}"
		setCameraEntity $80
		csWait $3C
		nextSingleText $0,$80   
						; "{NAME;23}, what?{W1}"
		...
		setEntityDir $17,$1
		nextSingleText $0,$17   
						; "Didn't you hear me?{W1}"
		setEntityDir $17,$3
		nextSingleText $0,$17   
						; "Hey, Granseal guys!{N}I'm on your side from now{N}on! OK?{W1}"
		csc54 $17,$FFFF         
						; 0054 UNKNOWN
		setF $182               
						; set during battle 32, after Jaro switches sides
		csc_end                 
