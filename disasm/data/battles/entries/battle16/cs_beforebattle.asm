...
bbcs_16:
		textCursor $9D1         
						; Initial text line $9D1 : "Huh?  The raft stopped!{W1}"
		...
		setEntityDir $1F,$3
		nextSingleText $C0,$7   
						; "Huh?  The raft stopped!{W1}"
		setEntityDir $0,$2
		setEntityDir $7,$2
		setEntityDir $1F,$0
		nextSingleText $0,$1F   
						; "Did the water stop flowing?{N}What's happening?{W1}"
		csWait $1E
		setEntityDir $7,$1
		csWait $1E
		...
		setQuakeAmount $4002
		nextSingleText $C0,$7   
						; "M...{D1}monster!{N}It appeared from the river!{W1}"
		nextText $0,$1F         
						; "It must be the monster they{N}mentioned in Polca.{W2}"
		nextSingleText $0,$1F   
						; "Watch out!{W1}"
		csWait $3C
		csc_end                 
