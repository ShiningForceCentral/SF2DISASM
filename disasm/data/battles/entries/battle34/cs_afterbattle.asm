...
abcs_battle34:  textCursor $B5F         ; Initial text line $B5F : "{LEADER}, I lost?!{N}Take this.{W1}"
		loadMapFadeIn $37,$2,$7
		loadMapEntities ce_4D69E; Entity data to figure out and format
...
cs_4D620:       textCursor $B74         ; Initial text line $B74 : "We will see them when we{N}arrive at Grans.{W1}"
		moveEntity $7,$FF,$2,$1
		endMove $8080
...
cs_4D692:       csc_end                 ; END OF CUTSCENE SCRIPT
