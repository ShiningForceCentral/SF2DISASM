...
abcs_battle18:
		textCursor $9E0         
						; Initial text line $9E0 : "{LEADER}, you're much{N}stronger than I thought.{W1}"
		loadMapFadeIn $C,$7,$5
		...
		csWait $3C
		nextSingleText $0,$B    
						; "{LEADER}, you're much{N}stronger than I thought.{W1}"
		setEntityDir $0,$2
		setEntityDir $7,$2
		setEntityDir $1F,$2
		csWait $1E
		...
		csWait $14
		nextSingleText $0,$B    
						; "It's so small.  I'll just{N}try to...get inside....{W1}"
		moveEntity $B,$0,$2,$1
		endMove $8080
		csWait $3
		...
		setEntityDir $1F,$2
		nextSingleText $0,$7    
						; "I hope he comes back.{N}Did {NAME;11} lie to us?{W1}"
		csWait $1E
		setEntityDir $0,$3
		setEntityDir $7,$3
		setEntityDir $1F,$3
		...
		setEntityDir $B,$3
		nextSingleText $0,$B    
						; "The Ancients were...how{N}should I say this...great!{W1}"
		moveEntity $B,$FF,$0,$1
		endMove $8080
		setEntityDir $B,$1
		nextSingleText $0,$B    
						; "No wonder the Caravan is so{N}small.  It carries miniaturized{N}people and items.{W2}"
		moveEntity $B,$FF,$1,$2
		endMove $8080
		setEntityDir $B,$3
		nextSingleText $0,$B    
						; "I can drive this excellent{N}vehicle.  May I go with you{N}as a driver?{W1}"
		csWait $1E
		nextSingleText $FF,$FF  
						; "{NAME;11} the historian{N}tags along with the force.{W1}"
		moveEntity $7,$FF,$1,$1
		endMove $8080
		nextSingleText $0,$7    
						; "You're kidding, right?{W1}"
		moveEntity $7,$FF,$3,$1
		endMove $8080
		setEntityDir $7,$2
		setEntityDir $0,$0
		setEntityDir $1F,$2
		nextSingleText $0,$7    
						; "Well, at least we can bring{N}a lot of soldiers with us.{W1}"
		moveEntity $B,$FF,$3,$1
		endMove $8080
		setEntityDir $0,$1
		setEntityDir $7,$1
		setEntityDir $1F,$1
		nextSingleText $0,$B    
						; "But soldiers in the Caravan{N}cannot enter battle 'cause{N}they've been miniaturized.{W1}"
		nextSingleText $0,$7    
						; "We'll just have to see.{W1}"
		setEntityDir $0,$0
		setEntityDir $7,$2
		setEntityDir $1F,$2
		nextSingleText $0,$7    
						; "Humph.  I don't like this guy.{W1}"
		moveEntity $B,$FF,$1,$1
		endMove $8080
		setEntityDir $B,$3
		csWait $14
		...
		setEntityDir $1F,$1
		nextSingleText $0,$B    
						; "I wonder what adventures{N}we'll find with this Caravan!{W1}"
		csWait $1E
		moveEntity $B,$0,$1,$1
		endMove $8080
		csWait $3
