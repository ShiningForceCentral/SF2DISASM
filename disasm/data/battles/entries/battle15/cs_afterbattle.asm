...
abcs_battle15:
		textCursor $9CA         
						; Initial text line $9CA : "It was lucky for me that I{N}met you.  Thank you.{W1}"
		...
		endMove $8080
		nextSingleText $0,$1E   
						; "It was lucky for me that I{N}met you.  Thank you.{W1}"
		setEntityDir $1E,$0
		nextSingleText $0,$1E   
						; "Follow me to the Ancient{N}Tunnel.{W1}"
		...
		fadeInB
		nextText $0,$1E         
						; "Why is this door closed?{N}That's strange...{W2}"
		nextSingleText $0,$1E   
						; "Oh well, let's go in.{W1}"
		entityFlashWhite $1E,$28
		csWait $3C
		setActscript $1E,$FF,eas_Jump
		nextSingleText $0,$1E   
						; "What?  Let me try again.{W1}"
		...
		csWait $5A
		nextSingleText $0,$1E   
						; "Petro, my grandson, locked{N}the door.{W1}"
		...
		setF $2DC               
						; set after the old man fails to open the way to Grans in the Wooden Panel shrine
		followEntity $7,$0,$2
		followEntity $1F,$7,$2
