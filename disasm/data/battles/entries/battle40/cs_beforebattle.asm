...
bbcs_40:
		textCursor $BDC         
						; Initial text line $BDC : "{LEADER}, you're finally{N}here.{W1}"
...
cs_4E544:
		...
		nextSingleText $C0,$81  
						; "{LEADER}, you're finally{N}here.{W1}"
		...
		nextSingleText $0,$7    
						; "Is that...?{W1}"
		nextSingleText $C0,$81  
						; "Did you forget about me,{N}{LEADER} and {NAME;7}!{W1}"
		nextSingleText $0,$7    
						; "Oddler, are you Odd Eye?{N}Zalbard said...{W1}"
		nextSingleText $C0,$81  
						; "Yes, I am he.{W1}"
		nextSingleText $0,$1F   
						; "You're the leader of the Devil{N}Army who attacked Bedoe...{W1}"
		nextSingleText $C0,$81  
						; "Yes I am, Sir Astral.{W1}"
		nextSingleText $0,$1F   
						; "How do you know me?{W1}"
		nextSingleText $C0,$81  
						; "{LEADER} told me about{N}you repeatedly.{W1}"
		nextSingleText $0,$7    
						; "What do YOU want?{W1}"
		nextSingleText $C0,$81  
						; "Don't talk to me like that.{N}I'm very sad.{W1}"
		nextSingleText $0,$7    
						; "Sad?{N}You've got to be joking!{W1}"
		setEntityDir $81,$2
		nextSingleText $C0,$81  
						; "Well, yes I am.{N}I'm really quite evil.{W1}"
		setEntityDir $81,$3
		nextSingleText $C0,$81  
						; "Don't you think so, Red{N}Baron?{W1}"
		nextSingleText $0,$1C   
						; "Uhh...(shiver).{W1}"
		moveEntity $81,$FF,$3,$1
		endMove $8080
		nextText $C0,$81        
						; "Anyway, I came here to{N}deliver an ultimatum.{W2}"
		nextText $C0,$81        
						; "Think long and well before{N}answering me.{W2}"
		nextSingleText $C0,$81  
						; "Leave the jewel, your{N}weapons, and your items{N}here...or DIE!{W1}"
		nextSingleText $0,$7    
						; "That means...we don't have{N}to fight him.{W1}"
		nextSingleText $0,$1F   
						; "True, but we can't take the{N}easy way out.  We mustn't{N}give him the jewel.{W1}"
		nextSingleText $C0,$81  
						; "You know how strong I am.{N}I think you had better{N}accept the offer.{W1}"
		nextSingleText $0,$0    
						; "Hmmm....{W1}"
		nextSingleText $0,$7    
						; "Oh, what should we do?!{W1}"
		nextSingleText $0,$1F   
						; "We have to fight!{W1}"
		nextSingleText $C0,$81  
						; "Times up!  We need space{N}to battle.{W1}"
		...
		nextSingleText $C0,$81  
						; "I'm very sorry, {LEADER},{N}but I must kill you!{W1}"
		setCamDest $B,$1F
		setEntityDir $7,$0
		setEntityDir $0,$2
		nextSingleText $0,$7    
						; "{LEADER}, are we really{N}going to fight Oddler?{W1}"
		moveEntity $1F,$FF,$2,$1
		endMove $8080
		setEntityDir $1F,$1
		setEntityDir $1C,$0
		nextSingleText $0,$1F   
						; "That's enough out of you!{W1}"
		moveEntity $1F,$FF,$0,$1
		endMove $8080
		setEntityDir $1F,$1
		setEntityDir $0,$3
		nextSingleText $0,$1F   
						; "{LEADER}, let's do it!{W1}"
