...
abcs_battle26:  textCursor $A4D         ; Initial text line $A4D : "Is he alright?{W1}"
		loadMapFadeIn $48,$D,$B
		loadMapEntities ce_4BE4A; Entity data to figure out and format
		...
		csc56 $13               ; 0056 UNKNOWN, SOMETHING WITH AN ENTITY
