...
abcs_battle13:
		textCursor $9BF         
						; Initial text line $9BF : "{NAME;10}, are you OK?  {NAME;10}!{W1}"
		playSound $FD
		loadMapFadeIn $D,$B,$8
		...
		csWait $32
		nextSingleText $0,$7    
						; "{NAME;10}, are you OK?  {NAME;10}!{W1}"
		csWait $32
		setActscript $A,$FF,eas_Init
		setActscript $A,$FF,eas_Jump
		entityShakeHead $A
		nextSingleText $C0,$A   
						; "Squawk!  They knocked me{N}senseless.{W1}"
		csWait $5
		setActscript $A,$0,eas_461B6
		csWait $3C
		nextText $C0,$A         
						; "Where are the devils?{N}{LEADER}, did you defeat{N}them?{W2}"
		setEntityDir $A,$1
		nextSingleText $C0,$A   
						; "Nobody in Bedoe can fight{N}like that.  Thank you.{W1}"
		setEntityDir $A,$2
		nextSingleText $0,$7    
						; "He's a great fighter.{N}Volcanon doesn't know how{N}good he is!{W1}"
		nextText $C0,$A         
						; "He'll learn.{W2}"
		nextSingleText $C0,$A   
						; "Let's go see the mayor and{N}get a raft!{W1}"
		setEntityDir $A,$1
		nextSingleText $FF,$FF  
						; "{CLEAR}{LEADER} decides to take{N}{NAME;10} the BDMN with him.{W1}{CLEAR}"
		setF $4B                
						; Luke is a follower
		mapSysEvent $D100C03
		csc_end                 
