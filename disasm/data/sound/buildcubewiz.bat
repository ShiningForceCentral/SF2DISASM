...
cd ../../code/common/tech/sound/cubewiz
    ..\..\..\..\..\..\tools\asw\asw.exe -x -E errors.log .\cubewiz.asm
    ..\..\..\..\..\..\tools\asw\p2bin.exe .\cubewiz.p ..\..\..\..\..\..\disasm\data\sound\%buildname%.bin -k -r $0000-$1fff
