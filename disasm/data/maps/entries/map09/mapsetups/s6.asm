...
cs_568F6:
		textCursor $55C         
						; Initial text line $55C : "Where are you from?{W1}"
		setEntityDir $0,$0      
		...
		nextSingleText $0,$7    
						; "{LEADER} came from{N}Grans Island.{W1}"
		...
		setEntityDir $82,$2     
						; 0023 SET ENTITY FACING 82 2
		nextText $C0,$82        
						; "Our ancestors came to{N}Parmecia to chase after{N}a soldier called Max.{W2}"
		nextText $C0,$82        
						; "They lost his trail at the{N}shore and then split into{N}two groups.{W2}"
		nextSingleText $C0,$82  
						; "One group went back to{N}Grans by way of Devil's Tail.{W1}"
		csWait $14              
						; WAIT 14
		nextSingleText $0,$7    
						; "Hmmm...and what happened{N}to Max?{W1}"
		csWait $14              
						; WAIT 14
		nextText $C0,$82        
						; "He wasn't found in Parmecia,{N}so maybe he went to Grans.{N}I'm not really sure.{W2}"
		nextSingleText $C0,$82  
...
cs_569BC:
		textCursor $566         
						; Initial text line $566 : "(Sniff)...(sniff)...I smell{N}something old....{W1}"
		...
		setEntityDir $0,$3      
						; 0023 SET ENTITY FACING 0 3
		nextText $C0,$B         
						; "(Sniff)...(sniff)...I smell{N}something old....{W1}"
		setEntityDir $B,$1      
						; 0023 SET ENTITY FACING B 1
		nextSingleText $C0,$B   
						; "That sword must be really{N}old.  Oh, my!{N}It's the Achilles Sword!{W2}"
		...
		endMove $8080
		nextText $C0,$B         
						; "You're an adventurer, right?{N}Don't you need a vehicle?{N}Huh?{W2}"
		nextSingleText $C0,$B   
						; "You can get the Ancient{N}Caravan with that sword!{W1}"
		setEntityDest $7,$F,$3A 
						; 0029 SET ENTITY DEST 7 F 3A
		setEntityDir $7,$0      
						; 0023 SET ENTITY FACING 7 0
		nextSingleText $0,$7    
						; "You wouldn't listen to us{N}just a short time ago!{W1}"
		setEntityDir $B,$2      
		...
		nextText $C0,$B         
						; "Let me join you!{W2}"
		nextText $C0,$B         
						; "I'm the only one who can{N}drive it!{W2}"
		nextText $C0,$B         
						; "You are going to get the{N}Caravan, aren't you?!{W1}"
		yesNo                   
						; 0011 STORY YESNO PROMPT
		jumpIfFlagSet $59,cs_56A82
...
cs_56A70:
		textCursor $56F         
						; Initial text line $56F : "You don't know what you'll{N}be missing!{W1}"
		nextSingleText $C0,$B   
						; "You don't know what you'll{N}be missing!{W1}"
		setEntityDir $B,$3      
...
cs_56A82:
		textCursor $572         
						; Initial text line $572 : "Great!  Good lad!{W1}"
		nextSingleText $C0,$B   
						; "Great!  Good lad!{W1}"
		nextSingleText $FF,$FF  
						; "{CLEAR}{LEADER} decides to take{N}Dr. {NAME;11} with him.{W1}{CLEAR}"
...
cs_56AE6:
		textCursor $570         
						; Initial text line $570 : "You again?!{W1}"
		nextText $C0,$B         
						; "You again?!{W1}"
		nextText $C0,$B         
						; "You changed your mind?{N}Hmmm....{W1}"
		yesNo                   
						; 0011 STORY YESNO PROMPT
		jumpIfFlagSet $59,cs_56A82
						; YES/NO prompt answer
...
cs_56B02:
		textCursor $583         
						; Initial text line $583 : "Are you the boy who killed{N}the legendary Kraken?{W2}"
		csc53 $C,$FFFF          
						; 0053 UNKNOWN
		csc53 $0,$0             
						; 0053 UNKNOWN
		nextText $0,$C          
						; "Are you the boy who killed{N}the legendary Kraken?{W2}"
		nextText $0,$C          
						; "I got to Hassan thanks to{N}you.{W2}"
		nextSingleText $0,$C    
						; "I didn't know this was such a{N}dull town.{W1}"
		csWait $14              
						; WAIT 14
		setEntityDir $C,$1      
		...
		csc52 $C,$7             
						; 0052 UNKNOWN, RELATED TO TWO ENTITIES
		nextSingleText $C0,$7   
						; "It's the Caravan...an ancient{N}vehicle found in the shrine.{W1}"
		csWait $14              
						; WAIT 14
		csc52 $C,$0             
						; 0052 UNKNOWN, RELATED TO TWO ENTITIES
		nextText $0,$C          
						; "I love interesting{N}things like that!{W2}"
		nextText $0,$C          
						; "Wow!  You found it?!{W2}"
		nextSingleText $0,$C    
						; "I want to go with you to{N}see some more interesting{N}things!{W1}"
		join $C                 
						; 0008 JOIN FORCE C
		nextSingleText $0,$C    
						; "Adventure!{N}Yo Ho!  Let's go!{W1}"
		setActscript $C,$FF,eas_Jump
						; 0015 SET ACTSCRIPT C FF 45E44
		setActscript $C,$FF,eas_Jump
						; 0015 SET ACTSCRIPT C FF 45E44
