...
cs_568F6:       textCursor $55C         ; Initial text line $55C : "Where are you from?{W1}"
...
cs_569BC:       textCursor $566         ; Initial text line $566 : "(Sniff)...(sniff)...I smell{N}something old....{W1}"
		...
		endMove $8080
cs_56A70:       textCursor $56F         ; Initial text line $56F : "You don't know what you'll{N}be missing!{W1}"
		nextSingleText $C0,$B   ; "You don't know what you'll{N}be missing!{W1}"
		setEntityDir $B,$3      ; 0023 SET ENTITY FACING B 3
		jump cs_56AD4           ; 000B JUMP 56AD4
cs_56A82:       textCursor $572         ; Initial text line $572 : "Great!  Good lad!{W1}"
...
cs_56AD4:       setActscript $0,$FF,eas_Init; 0015 SET ACTSCRIPT 0 FF 460CE
		followEntity $7,$0,$2   ; 002C FOLLOW ENTITY 7 0 2
		csc_end                 ; END OF CUTSCENE SCRIPT
cs_56AE6:       textCursor $570         ; Initial text line $570 : "You again?!{W1}"
		nextText $C0,$B         ; "You again?!{W1}"
		nextText $C0,$B         ; "You changed your mind?{N}Hmmm....{W1}"
		yesNo                   ; 0011 STORY YESNO PROMPT
		jumpIfFlagSet $59,cs_56A82; YES/NO prompt answer
		jump cs_56A70           ; 000B JUMP 56A70
cs_56B02:       textCursor $583         ; Initial text line $583 : "Are you the boy who killed{N}the legendary Kraken?{W2}"
		csc53 $C,$FFFF          ; 0053 UNKNOWN
		csc53 $0,$0             ; 0053 UNKNOWN
		...
		csWait $14              ; WAIT 14
		setEntityDir $C,$1      ; 0023 SET ENTITY FACING C 1
		csWait $1E              ; WAIT 1E
		setActscript $C,$FF,eas_Jump; 0015 SET ACTSCRIPT C FF 45E44
		csWait $14              ; WAIT 14
		csc52 $C,$0             ; 0052 UNKNOWN, RELATED TO TWO ENTITIES
		nextSingleText $0,$C    ; "Wh...what's that?!{W1}"
		csc52 $7,$C             ; 0052 UNKNOWN, RELATED TO TWO ENTITIES
		csc52 $C,$7             ; 0052 UNKNOWN, RELATED TO TWO ENTITIES
		...
		csWait $14              ; WAIT 14
		csc53 $0,$FFFF          ; 0053 UNKNOWN
		csc56 $C                ; 0056 UNKNOWN, SOMETHING WITH AN ENTITY
		csc_end                 ; END OF CUTSCENE SCRIPT
