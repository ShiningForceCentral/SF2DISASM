...
cs_55832:       textCursor $50A         ; 0004 INIT TEXT CURSOR 50A : "One year has passed.{W1}"
		mapLoad $7,$6,$2        ; 0048 LOAD MAP 7 6 2
		loadMapEntities ce_559AE; 0042 RELATED TO LOADING MAP ENTITIES 559AE
		...
		reloadMap $6,$2         ; 0046  6 2
		nextText $FF,$FF        ; "One year has passed.{W1}"
		textCursor $470         ; 0004 INIT TEXT CURSOR 470 : "(Cough)...our town is being{N}rebuilt, as you can see.{W2}"
		...
		reloadEntities ms_map7_Entities; 0044  553C6
		csc_end
ce_559AE:       dc.w $B
		dc.w 7
		dc.w 1
		...
		dc.l eas_Init           
		dc.w $FFFF
cs_55A36:       textCursor $4AE         ; 0004 INIT TEXT CURSOR 4AE : "Are you a phoenix?{N}The legendary bird?{W1}"
		...
		endMove $8080
		mapSysEvent $6,$B,$1,$3 ; 0007 EXECUTE MAP SYSTEM EVENT 60B0103
		csc_end
cs_55BEE:       textCursor $4E1         ; 0004 INIT TEXT CURSOR 4E1 : "Welcome back, {LEADER}.{W1}"
		...
		entityNod $0            ; 0026 MAKE ENTITY NOD 0
		followEntity $7,$0,$2   ; 002C FOLLOW ENTITY 7 0 2
		addNewFollower $8B      ; 0056 SOMETHING WITH AN ENTITY 8B
