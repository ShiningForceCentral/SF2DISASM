...
cs_5DD8E:       csc2B $1A,$B,$8,$3,$FF  ; 002B  1A B 8 3 FF
...
cs_5DD9C:       entityPosDir $80,$E,$1A,$3; 0019 SET ENTITY POS AND FACING 80 E 1A 3
		textCursor $854         ; Initial text line $854 : "Galam soldiers!  Run!{W1}"
		csWait $1               ; WAIT 1
...
cs_5DE2E:       textCursor $86A         ; Initial text line $86A : "Sir Petro, don't leave me{N}alone!{W1}"
		...
		csc_end                 ; END OF CUTSCENE SCRIPT
cs_5DE76:       textCursor $879         ; Initial text line $879 : "What's wrong with {NAME;26}?{W1}"
