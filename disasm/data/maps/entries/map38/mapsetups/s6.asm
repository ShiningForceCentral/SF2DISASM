...
cs_5DD8E:       newEntity $1A,$B,$8,$3,$FF; 002B  1A B 8 3 FF
		setFacing $1A,$3        ; 0023 SET ENTITY FACING 1A 3
		csc_end
cs_5DD9C:       entityPosDir $80,$E,$1A,$3; 0019 SET ENTITY POS AND FACING 80 E 1A 3
		textCursor $854         ; 0004 INIT TEXT CURSOR 854 : "Galam soldiers!  Run!{W1}"
		csWait $1
		entityPosDir $0,$E,$1C,$1; 0019 SET ENTITY POS AND FACING 0 E 1C 1
		entityPosDir $7,$D,$1D,$1; 0019 SET ENTITY POS AND FACING 7 D 1D 1
		entityPosDir $1F,$E,$1D,$1; 0019 SET ENTITY POS AND FACING 1F E 1D 1
		jumpIfFlagSet $4C,cs_5DE22; Zynk is a follower
cs_5DDC2:       playSound MUSIC_TOWN    ; 0005 PLAY SOUND MUSIC_TOWN
		...
		moveEntity $80,$FF,$2,$2; 002D MOVE ENTITY 80 FF 2 2
		endMove $8080
		...
		csc_end
cs_5DE22:       entityPosDir $1A,$F,$1D,$1; 0019 SET ENTITY POS AND FACING 1A F 1D 1
		jump cs_5DDC2           ; 000B JUMP 5DDC2
cs_5DE2E:       textCursor $86A         ; 0004 INIT TEXT CURSOR 86A : "Sir Petro, don't leave me{N}alone!{W1}"
		stopEntity $8E          ; 001C STOP ENTITY ANIM 8E
		playSound $FD           ; 0005 PLAY SOUND 
		setCamDest $8,$0        ; 0032 SET CAMERA DEST 8 0
		...
		playSound $FB           ; 0005 PLAY SOUND 
		csc_end
cs_5DE76:       textCursor $879         ; 0004 INIT TEXT CURSOR 879 : "What's wrong with {NAME;26}?{W1}"
		setActscript $7,$FF,eas_Init; 0015 SET ACTSCRIPT 7 FF 460CE
		setActscript $1F,$FF,eas_Init; 0015 SET ACTSCRIPT 1F FF 460CE
		setCameraEntity $1A     ; 0024 SET ENTITY FOLLOWED BY CAMERA 1A
		setEntityDest $0,$C,$9  ; 0029 SET ENTITY DEST 0 C 9
		setEntityDest $7,$C,$8  ; 0029 SET ENTITY DEST 7 C 8
		setEntityDest $7,$D,$8  ; 0029 SET ENTITY DEST 7 D 8
		setEntityDest $1F,$C,$8 ; 0029 SET ENTITY DEST 1F C 8
		setEntityDest $1F,$E,$8 ; 0029 SET ENTITY DEST 1F E 8
		setActscript $1A,$FF,eas_Init; 0015 SET ACTSCRIPT 1A FF 460CE
		setEntityDest $1A,$B,$8 ; 0029 SET ENTITY DEST 1A B 8
		setFacing $0,$2         ; 0023 SET ENTITY FACING 0 2
		setFacing $7,$2         ; 0023 SET ENTITY FACING 7 2
		setFacing $1F,$2        ; 0023 SET ENTITY FACING 1F 2
		moveEntity $1A,$FF,$2,$2; 002D MOVE ENTITY 1A FF 2 2
		endMove $8080
		moveEntity $7,$FF,$2,$2 ; 002D MOVE ENTITY 7 FF 2 2
		endMove $8080
		moveEntity $1F,$FF,$2,$1; 002D MOVE ENTITY 1F FF 2 1
		endMove $8080
		moveEntity $1A,$FF,$3,$1; 002D MOVE ENTITY 1A FF 3 1
		endMove $8080
		moveEntity $1A,$FF,$0,$1; 002D MOVE ENTITY 1A FF 0 1
		endMove $8080
		moveEntity $1A,$FF,$1,$1; 002D MOVE ENTITY 1A FF 1 1
		endMove $8080
		moveEntity $1A,$FF,$2,$2; 002D MOVE ENTITY 1A FF 2 2
		endMove $8080
		setActscript $1A,$FF,eas_Jump; 0015 SET ACTSCRIPT 1A FF 45E44
		setActscript $1A,$0,eas_Jump; 0015 SET ACTSCRIPT 1A 0 45E44
		...
		endMove $8080
		csWait $1E
		entityNod $1A           ; 0026 MAKE ENTITY NOD 1A
