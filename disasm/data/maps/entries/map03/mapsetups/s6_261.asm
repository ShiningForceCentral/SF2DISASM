...
cs_513CE:       hideEntity $3           ; 002E HIDE ENTITY 3
		csc_end
...
cs_513D6:       moveEntity $1,$FF,$2,$1 ; 002D MOVE ENTITY 1 FF 2 1
		moreMove $1,$1
		endMove $8080
		csc_end
cs_513E2:       textCursor $216         ; 0004 INIT TEXT CURSOR 216 : "{LEADER}, so you decided{N}to go?{W1}"
		nextText $0,$1          ; "{LEADER}, so you decided{N}to go?{W1}"
		yesNo                   ; 0011 STORY YESNO PROMPT
		jumpIfFlagSet $59,cs_51406; YES/NO prompt answer
		textCursor $214         ; 0004 INIT TEXT CURSOR 214 : "No?  Really?{N}Then I'm not going either!{W2}"
		...
		jump cs_51650           ; 000B JUMP 51650
cs_51406:       textCursor $217         ; 0004 INIT TEXT CURSOR 217 : "Great!{N}Let's go right now!{N}Hurry!{W1}"
		...
		join $80                ; 0008 JOIN FORCE 80
		followEntity $1,$0,$2   ; 002C FOLLOW ENTITY 1 0 2
		followEntity $2,$1,$2   ; 002C FOLLOW ENTITY 2 1 2
		entityPosDir $8A,$1B,$3,$3; 0019 SET ENTITY POS AND FACING 8A 1B 3 3
		entityPosDir $8B,$1F,$3,$3; 0019 SET ENTITY POS AND FACING 8B 1F 3 3
		csc_end
cs_51444:       moveEntityNextToPlayer $8C,$2; 0028 MOVE ENTITY NEXT TO PLAYER 8C 2
		csc_end
cs_5144C:       moveEntityNextToPlayer $8A,$1; 0028 MOVE ENTITY NEXT TO PLAYER 8A 1
		csc_end
cs_51454:       moveEntityNextToPlayer $8B,$1; 0028 MOVE ENTITY NEXT TO PLAYER 8B 1
		csc_end
cs_5145C:       setActscript $80,$FF,eas_Init; 0015 SET ACTSCRIPT 80 FF 460CE
		moveEntity $80,$FF,$1,$2; 002D MOVE ENTITY 80 FF 1 2
		moreMove $A,$14
		endMove $8080
		textCursor $1FE         ; 0004 INIT TEXT CURSOR 1FE : "Good morning {LEADER}!{N}You woke up late this{N}morning.{W2}"
		nextText $0,$80         ; "Good morning {LEADER}!{N}You woke up late this{N}morning.{W2}"
		nextText $0,$80         ; "Did the storm wake you up?{W2}"
		textCursor $1E3         ; 0004 INIT TEXT CURSOR 1E3 : "Hurry to school!{N}Sir Astral and {NAME;1} must{N}be waiting.{W1}"
		...
		csc_end
cs_5148C:       entityPosDir $1,$29,$A,$1; 0019 SET ENTITY POS AND FACING 1 29 A 1
		entityPosDir $80,$6,$4,$1; 0019 SET ENTITY POS AND FACING 80 6 4 1
		csc_end
cs_5149A:       textCursor $205         ; 0004 INIT TEXT CURSOR 205 : "Is everybody here?{N}OK, let's start.{W2}"
		csWait $14
		setFacing $0,$1         ; 0023 SET ENTITY FACING 0 1
		csWait $3C
		entityPosDir $8E,$2E,$7,$2; 0019 SET ENTITY POS AND FACING 8E 2E 7 2
		moveEntity $8E,$FF,$2,$1; 002D MOVE ENTITY 8E FF 2 1
		moreMove $3,$1
		moreMove $2,$3
		endMove $8080
		...
		moveEntity $8E,$FF,$1,$1; 002D MOVE ENTITY 8E FF 1 1
		endMove $8080
		csWait $78
		...
		entityPosDir $8F,$29,$11,$1; 0019 SET ENTITY POS AND FACING 8F 29 11 1
		moveEntity $8F,$FF,$1,$6; 002D MOVE ENTITY 8F FF 1 6
		moreMove $0,$1
		moreMove $1,$2
		endMove $8080
		setFacing $0,$1         ; 0023 SET ENTITY FACING 0 1
		...
		moveEntity $8F,$FF,$1,$1; 002D MOVE ENTITY 8F FF 1 1
		endMove $8080
		entityNod $8F           ; 0026 MAKE ENTITY NOD 8F
		entityNod $8F           ; 0026 MAKE ENTITY NOD 8F
		...
		csWait $F
		setActscript $8F,$FF,eas_Init; 0015 SET ACTSCRIPT 8F FF 460CE
		moveEntity $8F,$0,$3,$3 ; 002D MOVE ENTITY 8F 0 3 3
		endMove $8080
		moveEntity $8E,$FF,$3,$3; 002D MOVE ENTITY 8E FF 3 3
		endMove $8080
		setFacing $0,$3         ; 0023 SET ENTITY FACING 0 3
		setFacing $1,$3         ; 0023 SET ENTITY FACING 1 3
		setFacing $2,$3         ; 0023 SET ENTITY FACING 2 3
		moveEntity $8F,$0,$3,$1 ; 002D MOVE ENTITY 8F 0 3 1
		moreMove $2,$1
		moreMove $3,$2
		endMove $8080
		moveEntity $8E,$FF,$3,$2; 002D MOVE ENTITY 8E FF 3 2
		moreMove $2,$1
		moreMove $C,$14
		moreMove $0,$1
		endMove $8080
		setFacing $8F,$1        ; 0023 SET ENTITY FACING 8F 1
		setFacing $8E,$1        ; 0023 SET ENTITY FACING 8E 1
		setCamDest $26,$7       ; 0032 SET CAMERA DEST 26 7
		nextSingleText $0,$8E   ; "Sorry, kids.  I have to go{N}to the castle.{N}Stay here.{W1}"
		moveEntity $8E,$FF,$2,$1; 002D MOVE ENTITY 8E FF 2 1
		endMove $8080
		moveEntity $8F,$0,$3,$3 ; 002D MOVE ENTITY 8F 0 3 3
		endMove $8080
		moveEntity $8E,$FF,$3,$5; 002D MOVE ENTITY 8E FF 3 5
		endMove $8080
		hideEntity $8E          ; 002E HIDE ENTITY 8E
		hideEntity $8F          ; 002E HIDE ENTITY 8F
		setCamDest $26,$6       ; 0032 SET CAMERA DEST 26 6
		...
		moveEntity $1,$FF,$3,$1 ; 002D MOVE ENTITY 1 FF 3 1
		moreMove $0,$3
		endMove $8080
		setFacing $1,$1         ; 0023 SET ENTITY FACING 1 1
		setFacing $0,$3         ; 0023 SET ENTITY FACING 0 3
		...
		nextText $0,$1          ; "No?  Really?{N}Then I'm not going either!{W2}"
		nextSingleText $0,$1    ; "But, if you change your{N}mind, let me know right{N}away!{W1}"
		moveEntity $1,$FF,$2,$2 ; 002D MOVE ENTITY 1 FF 2 2
		moreMove $1,$1
		endMove $8080
		setFacing $2,$1         ; 0023 SET ENTITY FACING 2 1
		jump cs_51650           ; 000B JUMP 51650
cs_51614:       textCursor $217         ; 0004 INIT TEXT CURSOR 217 : "Great!{N}Let's go right now!{N}Hurry!{W1}"
		nextSingleText $0,$1    ; "Great!{N}Let's go right now!{N}Hurry!{W1}"
		setFacing $2,$2         ; 0023 SET ENTITY FACING 2 2
		nextSingleText $0,$2    ; "What?  {LEADER}, are you{N}going?  I'm going too!{W1}"
		setF $258               ; set after agreeing to try getting into the castle
		...
		entityPosDir $8B,$1F,$3,$3; 0019 SET ENTITY POS AND FACING 8B 1F 3 3
cs_51650:       csc_end
cs_51652:       textCursor $219         ; 0004 INIT TEXT CURSOR 219 : "Halt!{N}Where do you think you're{N}going?{W1}"
		moveEntity $8A,$0,$0,$1 ; 002D MOVE ENTITY 8A 0 0 1
		endMove $8080
		...
		moveEntity $8A,$0,$2,$1 ; 002D MOVE ENTITY 8A 0 2 1
		endMove $8080
		...
		setFacing $8B,$3        ; 0023 SET ENTITY FACING 8B 3
		csc_end
cs_516A8:       textCursor $296         ; 0004 INIT TEXT CURSOR 296 : "Here you are!{N}I've been waiting.{W1}"
		nextSingleText $0,$3    ; "Here you are!{N}I've been waiting.{W1}"
		moveEntityNextToPlayer $3,$2; 0028 MOVE ENTITY NEXT TO PLAYER 3 2
		...
		join $3                 ; 0008 JOIN FORCE 3
		nextSingleText $0,$3    ; "Let's go!{W1}"
		followEntity $3,$2,$2   ; 002C FOLLOW ENTITY 3 2 2
		csc_end
