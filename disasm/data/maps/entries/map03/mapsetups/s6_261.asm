...
cs_513D6:       moveEntity $1,$FF,$2,$1 ; 002D MOVE ENTITY 1 FF 2 1
		...
		endMove $8080
		csc_end                 ; END OF CUTSCENE SCRIPT
cs_513E2:       textCursor $216         ; Initial text line $216 : "{LEADER}, so you decided{N}to go?{W1}"
		nextText $0,$1          ; "{LEADER}, so you decided{N}to go?{W1}"
		yesNo                   ; 0011 STORY YESNO PROMPT
		jumpIfFlagSet $59,cs_51406; YES/NO prompt answer
		textCursor $214         ; Initial text line $214 : "No?  Really?{N}Then I'm not going either!{W2}"
...
cs_51406:       textCursor $217         ; Initial text line $217 : "Great!{N}Let's go right now!{N}Hurry!{W1}"
...
cs_5145C:       setActscript $80,$FF,eas_Init; 0015 SET ACTSCRIPT 80 FF 460CE
		...
		moreMove $A,$14
		endMove $8080
		textCursor $1FE         ; Initial text line $1FE : "Good morning {LEADER}!{N}You woke up late this{N}morning.{W2}"
		nextText $0,$80         ; "Good morning {LEADER}!{N}You woke up late this{N}morning.{W2}"
		nextText $0,$80         ; "Did the storm wake you up?{W2}"
		textCursor $1E3         ; Initial text line $1E3 : "Hurry to school!{N}Sir Astral and {NAME;1} must{N}be waiting.{W1}"
...
cs_5148C:       entityPosDir $1,$29,$A,$1; 0019 SET ENTITY POS AND FACING 1 29 A 1
		...
		csc_end                 ; END OF CUTSCENE SCRIPT
cs_5149A:       textCursor $205         ; Initial text line $205 : "Is everybody here?{N}OK, let's start.{W2}"
		csWait $14              ; WAIT 14
		...
		moreMove $0,$1
		endMove $8080
		setEntityDir $8F,$1     ; 0023 SET ENTITY FACING 8F 1
		setEntityDir $8E,$1     ; 0023 SET ENTITY FACING 8E 1
		...
		setEntityDir $2,$1      ; 0023 SET ENTITY FACING 2 1
		jump cs_51650           ; 000B JUMP 51650
cs_51614:       textCursor $217         ; Initial text line $217 : "Great!{N}Let's go right now!{N}Hurry!{W1}"
		nextSingleText $0,$1    ; "Great!{N}Let's go right now!{N}Hurry!{W1}"
		setEntityDir $2,$2      ; 0023 SET ENTITY FACING 2 2
		nextSingleText $0,$2    ; "What?  {LEADER}, are you{N}going?  I'm going too!{W1}"
		setF $258               ; set after agreeing to try getting into the castle
		...
		entityPosDir $8A,$1B,$3,$3; 0019 SET ENTITY POS AND FACING 8A 1B 3 3
		entityPosDir $8B,$1F,$3,$3; 0019 SET ENTITY POS AND FACING 8B 1F 3 3
cs_51650:       csc_end                 ; END OF CUTSCENE SCRIPT
cs_51652:       textCursor $219         ; Initial text line $219 : "Halt!{N}Where do you think you're{N}going?{W1}"
		...
		setEntityDir $8B,$3     ; 0023 SET ENTITY FACING 8B 3
		csc_end                 ; END OF CUTSCENE SCRIPT
cs_516A8:       textCursor $296         ; Initial text line $296 : "Here you are!{N}I've been waiting.{W1}"
