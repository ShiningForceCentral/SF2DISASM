...
ms_map3_flag609_Entities:
                ...
                msFixedEntity 27, 13, LEFT, MAPSPRITE_OLD_WOMAN, eas_Init
                msFixedEntity 25, 13, RIGHT, MAPSPRITE_WOMAN, eas_Init
                msFixedEntity 27, 3, DOWN, MAPSPRITE_GUARD, eas_Init
                msFixedEntity 31, 3, DOWN, MAPSPRITE_GUARD, eas_Init
                ...
                msFixedEntity 37, 21, DOWN, MAPSPRITE_WOMAN, eas_Init
                msWalkingEntity 47, 24, DOWN, MAPSPRITE_YOUNG_MAN, 47, 24, 2
                ...
                msWalkingEntity 29, 7, DOWN, MAPSPRITE_YOUNG_MAN, 29, 7, 1
