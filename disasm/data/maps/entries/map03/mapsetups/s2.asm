...
sub_50F54:
		...
		trap    #TEXTBOX
		dc.w $200               
						; "Hi, {LEADER}!{N}How are you?{W2}"
loc_50F6A:
		
		trap    #TEXTBOX
		dc.w $1E0               
						; "Sir Astral is in the{N}basement, but he looks{N}"
		trap    #TEXTBOX
		dc.w $1E1               
						; "strange today.{W1}"
		trap    #CHECK_FLAG
...
loc_50F84:
		...
		trap    #TEXTBOX
		dc.w $1F6               
						; "What's wrong with you?{N}Your seat is next to{N}{NAME;2}!{W1}"
loc_50F88:
...
sub_50F98:
		...
		trap    #TEXTBOX
		dc.w $1E2               
						; "Hooo...I'm sleepy.{N}{NAME;3} must be sleeping{N}soundly about now.{W1}"
		bra.s   loc_50FB2
loc_50FAA:
		
		trap    #TEXTBOX
		dc.w $1F7               
						; "Zzzzz...zzzzz...{N}...ye...yes!{W1}"
		trap    #TEXTBOX
		dc.w $1F8               
						; "Oh, it's you, {LEADER}.{N}I thought it was Sir Astral!{W1}"
loc_50FB2:
...
loc_50FB4:
		...
		trap    #TEXTBOX
		dc.w $1FB               
						; "Yeah, I do want to go to{N}the castle, but {LEADER},{N}how about you?{W1}"
return_50FB8:
...
loc_50FC6:
		...
		trap    #TEXTBOX
		dc.w $1F9               
						; "I'm busy!{N}The storm last night{N}messed up the house.{W1}"
return_50FCA:
...
sub_50FCC:
		...
		trap    #TEXTBOX
		dc.w $1E4               
						; "He thinks of you as his own{N}grandson.{W2}"
		trap    #TEXTBOX
		dc.w $1E5               
						; "Sometimes he may badger{N}you, but that's because he{N}loves you.{W1}"
		rts
...
sub_50FD6:
		...
		trap    #TEXTBOX
		dc.w $1E6               
						; "Hi, boy!  Good morning.{N}Are you going to school?{W2}"
		trap    #TEXTBOX
		dc.w $1E7               
						; "Say, Sir Astral certainly{N}is a great person.{W2}"
		trap    #TEXTBOX
		dc.w $1E8               
						; "He even teaches a{N}mischievous kid like you.{W1}"
		rts
...
sub_50FE4:
		...
		trap    #TEXTBOX
		dc.w $1E9               
						; "Good morning {LEADER}!{N}It's a wonderful day,{N}isn't it?{W1}"
		rts
...
sub_50FF0:
		...
		trap    #TEXTBOX
		dc.w $1EB               
						; "Sir Astral is the wisest{N}person in Granseal.{W2}"
		trap    #TEXTBOX
		dc.w $1EC               
						; "He's such a great man, he{N}opened a school all{N}by himself.{W2}"
		trap    #TEXTBOX
		dc.w $1ED               
						; "You must realize how lucky{N}you are.{W1}"
		rts
...
sub_50FFE:
		...
		trap    #TEXTBOX
		dc.w $1EE               
						; "Hi, would-be customer!{N}Sorry, we are not open yet.{W1}"
		rts
...
sub_51004:
		...
		trap    #TEXTBOX
		dc.w $1EF               
						; "Granseal's harbor is behind{N}me.{W2}"
		trap    #TEXTBOX
		dc.w $1F0               
						; "All ships left early this{N}morning.{W1}"
		rts
...
loc_5101A:
		...
		trap    #TEXTBOX
		dc.w $1FC               
						; "To deliver him a package?{N}Really?{W1}"
return_5101E:
...
loc_5102C:
		...
		trap    #TEXTBOX
		dc.w $1FD               
						; "(Cough!)  Be good in the{N}castle, OK?{W1}"
return_51030:
...
sub_51044:
		...
		trap    #TEXTBOX
		dc.w $1F4               
						; "Oh, morning {LEADER}.{N}When did you come in?{W2}"
		trap    #SET_FLAG
		dc.w $105
loc_51052:
		...
		trap    #TEXTBOX
		dc.w $1F5               
						; "Is it time to start school?{N}OK, I'm coming up soon.{W1}"
		trap    #SET_FLAG
		dc.w $25A               
						; set after Astral's second basement line
return_5105A:
