...
sub_5D248:
		...
		trap    #TEXTBOX
		dc.w $7A4               
						; "Ketto is on the southern{N}edge of North Parmecia.{W1}"
		rts
...
sub_5D24E:
		...
		trap    #TEXTBOX
		dc.w $7A5               
						; "Where did you come from,{N}boy?{W2}"
		trap    #TEXTBOX
		dc.w $7A6               
						; "From South Parmecia?{N}Really?{W2}"
		trap    #TEXTBOX
		dc.w $7A7               
						; "The tunnel to the south is{N}blocked.{W1}"
		rts
...
sub_5D25C:
		...
		trap    #TEXTBOX
		dc.w $7A8               
						; "From South Parmecia?{N}Why did you come here?{W2}"
		trap    #TEXTBOX
		dc.w $7A9               
						; "Pacalon has become isolated{N}since we opposed the devils.{W2}"
		trap    #TEXTBOX
		dc.w $7AA               
						; "If I were you, I'd leave.{W1}"
		rts
...
sub_5D26A:
		...
		trap    #TEXTBOX
		dc.w $7AB               
						; "It's unusually hot!{W2}"
		trap    #TEXTBOX
		dc.w $7AC               
						; "Is Mitula as sick as I've{N}heard?{W1}"
		rts
...
sub_5D274:
		...
		trap    #TEXTBOX
		dc.w $7AD               
						; "The devils forbade us to go{N}out. {W1}"
		rts
...
sub_5D27A:
		...
		trap    #TEXTBOX
		dc.w $7AE               
						; "Blast!  I hate devils....{W1}"
		move.b  #1,((MESSAGE_SPEED-$1000000)).w
		trap    #TEXTBOX
		dc.w $7AF               
						; "Ah, are you a customer?{N}Wow!{W2}"
		move.b  #2,((MESSAGE_SPEED-$1000000)).w
		trap    #TEXTBOX
		dc.w $7B0               
						; "It's a secret, OK?{N}I have very good weapons.{N}Hee, hee.{W2}"
		move.b  #3,((MESSAGE_SPEED-$1000000)).w
		trap    #TEXTBOX
		dc.w $7B1               
						; "Do you want to buy one?{N}Oh, you do?!  OK, come to my{N}shop!{W1}"
		movem.l (sp)+,d0
		move.b  d0,((MESSAGE_SPEED-$1000000)).w
		trap    #SET_FLAG
		dc.w $320               
						; set after the merchant in Ketto runs to his store
		lea     cs_5D3B8(pc), a0
		trap    #6
		bra.s   return_5D2D0
loc_5D2C4:
...
sub_5D2D2:
		...
		trap    #TEXTBOX
		dc.w $7B3               
						; "Sorry, I can't open my{N}church for you.{N}Please understand.{W1}"
		trap    #SET_FLAG
		dc.w $100               
...
sub_5D2EA:
		...
		trap    #TEXTBOX
		dc.w $7B5               
						; "Pacalon was always a good{N}customer for us!{N}They bought a lot!{W2}"
		trap    #TEXTBOX
		dc.w $7B6               
						; "But, now we can't sell our{N}weapons because of the{N}devils!{W2}"
		trap    #TEXTBOX
		dc.w $7B7               
						; "Annoying devils!{W1}"
		bra.s   loc_5D31E
