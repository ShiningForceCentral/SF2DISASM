...
cs_5C6CA:       textCursor $E3A         ; 0004 INIT TEXT CURSOR E3A : "It's my job!{W1}"
		...
		setFacing $1E,$1        ; 0023 SET ENTITY FACING 1E 1
		...
		setBlocks $B,$0,$1,$1,$5,$6; 0034 SET BLOCKS B00 101 506
		csWait $1E
