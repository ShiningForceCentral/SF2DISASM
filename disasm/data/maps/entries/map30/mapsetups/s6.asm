...
cs_5A30C:       setBlocks $1506,$202,$705; 0034 SET BLOCKS 1506 202 705
		setBlocks $1500,$404,$600; 0034 SET BLOCKS 1500 404 600
...
cs_5A31E:       customActscript $82,$FF ; 0014 SET MANUAL ACTSCRIPT 82
		...
		csc_end                 ; END OF CUTSCENE SCRIPT
cs_5A33A:       textCursor $6AF         ; Initial text line $6AF : "Where is the sick dwarf?{W1}"
		...
		endMove $8080
		setEntityDir $9E,$0     ; 0023 SET ENTITY FACING 9E 0
		...
		setEntityDir $9E,$1     ; 0023 SET ENTITY FACING 9E 1
		...
		endMove $8080
		csc_end                 ; END OF CUTSCENE SCRIPT
cs_5A4FE:       textCursor $6C2         ; Initial text line $6C2 : "We use it to destroy large{N}rocks.{W1}"
		setEntityDir $81,$2     ; 0023 SET ENTITY FACING 81 2
		setEntityDir $82,$2     ; 0023 SET ENTITY FACING 82 2
		setEntityDir $83,$2     ; 0023 SET ENTITY FACING 83 2
		setEntityDir $84,$2     ; 0023 SET ENTITY FACING 84 2
		...
		setBlocks $1506,$202,$705; 0034 SET BLOCKS 1506 202 705
		csc_end                 ; END OF CUTSCENE SCRIPT
