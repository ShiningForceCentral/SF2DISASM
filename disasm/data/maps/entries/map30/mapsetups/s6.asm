...
cs_5A33A:
		dc.w 4                  
						; 0004 INIT TEXT CURSOR 6AF : "Where is the sick dwarf?{W1}"
		dc.w $6AF
		dc.w $32                
		...
		dc.w $B
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 9E : "Where is the sick dwarf?{W1}"
		dc.w $9E
		dc.b $80                
						; WAIT 5
		dc.b 5
		...
		dc.b 0
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 80 : "Oh, thank goodness.{N}I sure am glad to see you.{W1}"
		dc.w $80
		dc.w $15                
		...
		dc.b 2
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 80 : "Here, please examine him.{W1}"
		dc.w $80
		dc.w $24                
		...
		dc.b $3C
		dc.w 2                  
						; 0002 DISPLAY TEXT BOX 9E : "Oh, I hope I'm not too late.{W2}"
		dc.w $9E
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 9E : "Ok, let's see.{W1}"
		dc.w $9E
		dc.b $80                
						; WAIT 32
		dc.b $32
		...
		dc.b 2
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 81 : "How is he?{W1}"
		dc.w $81
		dc.b $80                
						; WAIT F
		dc.b $F
		...
		dc.w $84
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 84 : "I don't know yet....{W1}"
		dc.w $84
		dc.b $80                
						; WAIT 3C
		dc.b $3C
		...
		dc.w $82
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 82 : "Whoa!{W1}"
		dc.w $82
		dc.b $80                
						; WAIT 5
		dc.b 5
		...
		dc.b 1
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 82 : "What?{W1}"
		dc.w $82
		dc.w $2D                
		...
		dc.b 0
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 81 : "Hey, are you OK?{W1}"
		dc.w $81
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 82 : "I'm OK.  I'm fine.{N}I feel great!{W1}"
		dc.w $82
		dc.b $80                
						; WAIT 14
		dc.b $14
		...
		dc.b 1
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 80 : "Oh, how can we thank you?{W1}"
		dc.w $80
		dc.w $26                
						; 0026 MAKE ENTITY NOD 82
		dc.w $82
		dc.w 2                  
						; 0002 DISPLAY TEXT BOX 9E : "I don't need anything.{W2}"
		dc.w $9E
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 9E : "But, why don't you help{N}{LEADER}?{W1}"
		dc.w $9E
		dc.b $80                
						; WAIT F
		dc.b $F
		...
		dc.w $8080
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 9E : "{LEADER}, I'm  going now.{W2}{N}I hope your journey is safe{N}and uneventful.  Bye!{W1}"
		dc.w $9E
		dc.w $24                
...
cs_5A4FE:
		dc.w 4                  
						; 0004 INIT TEXT CURSOR 6C2 : "We use it to destroy large{N}rocks.{W1}"
		dc.w $6C2
		dc.w $23                
						; 0023 SET ENTITY FACING 81 2
		dc.b $81
		...
		dc.w 7
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 80 : "We use it to destroy large{N}rocks.{W1}"
		dc.w $80
		dc.w $2D                
						; 002D MOVE ENTITY 80 FF 0 1
		dc.b $80
		...
		dc.w $8080
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 80 : "OK, guys!{N}Let's go back to Grans{N}Island!{W2}"
		dc.w $80
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 80 : "Everybody dig!{W1}"
		dc.w $80
		dc.w $15                
