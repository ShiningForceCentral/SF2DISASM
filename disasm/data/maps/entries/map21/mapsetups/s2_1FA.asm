...
sub_53EAE:
		...
		trap    #TEXTBOX
		dc.w $238               
						; "This west tower leads to{N}the Ancient Tower.{W2}"
		trap    #SET_FLAG
		dc.w $100               
						; .0118=apparently reset on map load, usually used to skip some lines of entities
loc_53EC2:
		...
		trap    #TEXTBOX
		dc.w $239               
						; "The Ancient Tower is a{N}sacred place where only the{N}King can go.{W1}"
		bra.s   return_53EDC
loc_53EC8:
		
		trap    #TEXTBOX
		dc.w $243               
						; "Sir Astral is already{N}inside the tower.  Hurry!{W1}"
		trap    #CHECK_FLAG
		dc.w $100               
						; .0118=apparently reset on map load, usually used to skip some lines of entities
		bne.s   return_53EDC
...
sub_53EEE:
		...
		trap    #TEXTBOX
		dc.w $245               
						; "It was a devil!{N}I don't want to stand{N}here any more!{W2}{N}Hey, you!  Can you stand{N}guard for me here?{W1}"
nullsub_126:
