...
byte_5C4EE:
		textCursor $575         
						; Initial text line $575 : "Who are they?{W1}"
		csc45 $30               
						; (null)
		...
		setEntityDest $0,$5,$17 
						; 0029 SET ENTITY DEST 0 5 17
		setEntityDest $7,$4,$16 
		...
		nextSingleText $0,$7    
						; "They're looking for something.{W1}"
		csWait $5               
						; WAIT 5
		setActscript $81,$0,eas_461B6
						; 0015 SET ACTSCRIPT 81 0 461B6
		...
		csWait $28              
						; WAIT 28
		nextSingleText $0,$83   
						; "He's not here...not under{N}the cliff....{W1}"
		...
		nextText $0,$81         
						; "There are marks of a battle{N}here and there!{W2}"
		nextSingleText $0,$81   
						; "Against the birdmen of{N}Bedoe?{W1}"
		entityNod $80           
						; 0026 MAKE ENTITY NOD 80
		nextText $0,$80         
						; "Could be...{W2}"
		nextSingleText $0,$80   
						; "see those volcanic rocks?{W1}"
		csWait $5               
						; WAIT 5
		...
		csWait $3C              
						; WAIT 3C
		nextText $0,$80         
						; "Nobody but Volcanon can do{N}that!{W2}"
		setEntityDir $81,$0     
						; 0023 SET ENTITY FACING 81 0
		nextSingleText $0,$80   
						; "He has never before killed{N}birdmen, but...{W1}"
		...
		endMove $8080
		nextText $0,$80         
						; "Polcan people are cowards that{N}live in peace.{W2}"
		setEntityDir $80,$1     
						; 0023 SET ENTITY FACING 80 1
		setEntityDir $83,$1     
						; 0023 SET ENTITY FACING 83 1
		nextSingleText $0,$80   
						; "They shall never return{N}alive!{W1}"
		setStoryFlag $C         
						; Battle 12 unlocked
		mapSysEvent $34000000   
						; 0007 EXECUTE MAP SYSTEM EVENT 34000000
		csc_end                 
						; END OF CUTSCENE SCRIPT
byte_5C622:
		entityPosDir $7,$16,$8,$0
						; 0019 SET ENTITY POS AND FACING 7 16 8 0
		textCursor $9BD         
						; Initial text line $9BD : "{LEADER}, did you hear{N}that?  He said, he had{N}been waiting for you.{W2}"
		fadeInB                 
						; 0039 FADE IN FROM BLACK
		nextText $0,$7          
						; "{LEADER}, did you hear{N}that?  He said, he had{N}been waiting for you.{W2}"
		nextSingleText $0,$7    
						; "Why do the devils want you?{W1}"
		csc_end                 
						; END OF CUTSCENE SCRIPT
