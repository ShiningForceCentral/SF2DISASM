...
cs_54E78:       entityPosDir $8A,$3F,$3F,$3; 0019 SET ENTITY POS AND FACING 8A 3F 3F 3
		...
		csc_end                 ; END OF CUTSCENE SCRIPT
cs_54E86:       textCursor $42A         ; Initial text line $42A : "A strange animal?{N}Really?{W1}"
		...
		csWait $32              ; WAIT 32
		setEntityDir $8B,$2     ; 0023 SET ENTITY FACING 8B 2
		...
		csc_end                 ; END OF CUTSCENE SCRIPT
cs_54F26:       textCursor $432         ; Initial text line $432 : "Oooo...it's big!{N}I want to touch him!{W1}"
		...
		setEntityDir $84,$1     ; 0023 SET ENTITY FACING 84 1
		...
		setEntityDir $8D,$1     ; 0023 SET ENTITY FACING 8D 1
		...
		setEntityDir $87,$0     ; 0023 SET ENTITY FACING 87 0
		setEntityDir $8B,$0     ; 0023 SET ENTITY FACING 8B 0
		setEntityDir $8D,$0     ; 0023 SET ENTITY FACING 8D 0
		...
		endMove $8080
		setEntityDir $91,$0     ; 0023 SET ENTITY FACING 91 0
		setEntityDir $92,$2     ; 0023 SET ENTITY FACING 92 2
		csWait $1E              ; WAIT 1E
		...
		setEntityDir $82,$3     ; 0023 SET ENTITY FACING 82 3
		csc_end                 ; END OF CUTSCENE SCRIPT
cs_55242:       textCursor $463         ; Initial text line $463 : "Welcome back, {LEADER}!{N}I heard your journey was{N}hard.{W2}"
		csc2B $8E,$B,$0,$3,$CE  ; 002B  8E B 0 3 CE
		...
		csc_end                 ; END OF CUTSCENE SCRIPT
cs_55288:       textCursor $466         ; Initial text line $466 : "I finally found you.{N}You're {LEADER}, right?{W1}"
		csc2B $12,$10,$16,$3,$12; 002B  12 10 16 3 12
