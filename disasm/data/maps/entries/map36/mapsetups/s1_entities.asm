...
ms_map36_Entities:
                ...
                msWalkingEntity 18, 24, DOWN, MAPSPRITE_CENTAUR_MALE, 18, 24, 1
                msFixedEntity 33, 26, LEFT, MAPSPRITE_CENTAUR_MALE, eas_Init
                msFixedEntity 7, 5, RIGHT, MAPSPRITE_CENTAUR_MALE, eas_Init
                msFixedEntity 4, 22, RIGHT, MAPSPRITE_CENTAUR_MALE, eas_Init
