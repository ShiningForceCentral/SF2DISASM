...
sub_5D96A:
		...
		trap    #TEXTBOX
		dc.w $CEC               
						; "Thanks to the rain, I'm fine.{W1}"
		rts
...
sub_5D970:
		...
		trap    #TEXTBOX
		dc.w $CED               
						; "The devils escaped when they{N}saw our soldiers. {W2}"
		trap    #TEXTBOX
		dc.w $CEE               
						; "They're such chickens!{W1}"
		rts
...
sub_5D97A:
		...
		trap    #TEXTBOX
		dc.w $CEF               
						; "Vicar {NAME;22} wants to go{N}to Moun and save the people.{W2}"
		trap    #TEXTBOX
		dc.w $CF0               
						; "But, the devils will surge{N}into Parmecia as soon as{N}he opens the gate!{W1}"
		rts
...
sub_5D984:
		...
		trap    #TEXTBOX
		dc.w $CF1               
						; "I'm no longer thirsty,{N}but I'm not totally healthy{N}yet.{W1}"
		rts
...
sub_5D98A:
		...
		trap    #TEXTBOX
		dc.w $CF2               
						; "Practice!  Who needs{N}practice?!  Ha!{W2}"
		trap    #SET_FLAG
		dc.w $101
loc_5D998:
		...
		trap    #TEXTBOX
		dc.w $CF3               
						; "Oooh...I can't lift this{N}spear!{W1}"
		rts
...
sub_5D99E:
		...
		trap    #TEXTBOX
		dc.w $CF4               
						; "I just saw a warrior who{N}came from the south a year{N}ago.{W2}"
		trap    #TEXTBOX
		dc.w $CF5               
						; "He was shocked to find out{N}that the tunnel was blocked,{N}and went to Moun.{W1}"
		rts
...
sub_5D9A8:
		...
		trap    #TEXTBOX
		dc.w $CF6               
						; "Thank you, strangers!{N}You saved us!{W2}"
		trap    #TEXTBOX
		dc.w $CF7               
						; "But I didn't think we would{N}be saved by humans!{W1}"
		rts
...
sub_5D9B2:
		...
		trap    #TEXTBOX
		dc.w $CF8               
						; "The King is a little upset.{W2}"
		trap    #TEXTBOX
		dc.w $CF9               
						; "We've always believed that{N}centaurs were the best{N}warriors.{W2}"
		trap    #TEXTBOX
		dc.w $CFA               
						; "But we were wrong.{N}I understand now.{W1}"
		rts
