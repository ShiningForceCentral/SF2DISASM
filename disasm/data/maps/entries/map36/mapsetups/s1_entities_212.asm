...
ms_map36_flag212_Entities:
                ...
                msFixedEntity 8, 3, DOWN, MAPSPRITE_POCALON_SOLDIER, eas_Init
                msFixedEntity 5, 22, LEFT, MAPSPRITE_POCALON_SOLDIER, eas_Init
                msFixedEntity 40, 17, DOWN, MAPSPRITE_POCALON_SOLDIER, eas_Init
                msFixedEntity 29, 3, DOWN, MAPSPRITE_POCALON_KING, eas_Init
                msFixedEntity 31, 5, LEFT, MAPSPRITE_POCALON_SOLDIER, eas_Init
                msFixedEntity 31, 11, LEFT, MAPSPRITE_POCALON_SOLDIER, eas_Init
