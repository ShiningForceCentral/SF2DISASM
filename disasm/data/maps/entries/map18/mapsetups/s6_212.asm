...
cs_612BE:       textCursor $E61         ; Initial text line $E61 : "{LEADER} defeated Red{N}Baron too?  Is that what{N}you said, Geshp?{W1}"
		...
		setEntitySize $80,$15   ; 0050 SET ENTITY SIZE 80 15 
		...
		mapSysEvent $12090A03   ; 0007 EXECUTE MAP SYSTEM EVENT 12090A03
...
cs_6143C:       textCursor $36F         ; Initial text line $36F : "Sorry, {LEADER}.{N}I'm going back to Roft.{N}I'm worried about Petro.{W1}"
