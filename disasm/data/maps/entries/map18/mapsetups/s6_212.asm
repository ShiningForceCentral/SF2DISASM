...
cs_612BE:       textCursor $E61         ; 0004 INIT TEXT CURSOR E61 : "{LEADER} defeated Red{N}Baron too?  Is that what{N}you said, Geshp?{W1}"
		mapLoad $3B,$8,$4       ; 0048 LOAD MAP 3B 8 4
		...
		entityPosDir $1A,$3F,$3F,$3; 0019 SET ENTITY POS AND FACING 1A 3F 3F 3
		...
		setSize $80,$15         ; 0050 SET ENTITY SIZE 80 15 
		...
		setPriority $81,$0      ; 0053  81 0
		setActscript $83,$0,eas_Transparent
						; 0015 SET ACTSCRIPT 83 0 45FA8
		entityPosDir $83,$D,$C,$3; 0019 SET ENTITY POS AND FACING 83 D C 3
		csWait $32
		entityPosDir $81,$D,$C,$1; 0019 SET ENTITY POS AND FACING 81 D C 1
		...
		csWait $1E
		executeSubroutine csub_61426; 000A EXECUTE SUBROUTINE 61426
		mapSysEvent $12,$9,$A,$3; 0007 EXECUTE MAP SYSTEM EVENT 12090A03
		csc_end
...
cs_6143C:       textCursor $36F         ; 0004 INIT TEXT CURSOR 36F : "Sorry, {LEADER}.{N}I'm going back to Roft.{N}I'm worried about Petro.{W1}"
		setActscript $1A,$FF,eas_Init; 0015 SET ACTSCRIPT 1A FF 460CE
		moveEntityNextToPlayer $1A,$0; 0028 MOVE ENTITY NEXT TO PLAYER 1A 0
		...
		csWait $1E
		moveEntity $1A,$FF,$1,$4; 002D MOVE ENTITY 1A FF 1 4
		endMove $8080
		...
		moveEntity $1A,$FF,$1,$4; 002D MOVE ENTITY 1A FF 1 4
		endMove $8080
		hideEntity $1A          ; 002E HIDE ENTITY 1A
		csc_end
