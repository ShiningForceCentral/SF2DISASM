...
cs_5AC58:       textCursor $70C         ; Initial text line $70C : "You may go now.{N}I need to talk to fairy.{W1}"
...
cs_5AF36:       textCursor $72A         ; Initial text line $72A : "No, don't go in there!{N}That door is...!{W1}"
		...
		setActscript $80,$FF,eas_Jump; 0015 SET ACTSCRIPT 80 FF 45E44
		csWait $14              ; WAIT 14
		mapSysEvent $16000003   ; 0007 EXECUTE MAP SYSTEM EVENT 16000003
		csc_end                 ; END OF CUTSCENE SCRIPT
cs_5B016:       textCursor $730         ; Initial text line $730 : "Goliath...Goliath!{W1}"
		csc46 $C,$2             ; 0046 UNKNOWN
		...
		followEntity $1F,$7,$2  ; 002C FOLLOW ENTITY 1F 7 2
		csc_end                 ; END OF CUTSCENE SCRIPT
cs_5B466:       textCursor $78C         ; Initial text line $78C : "Oddler?{W1}"
