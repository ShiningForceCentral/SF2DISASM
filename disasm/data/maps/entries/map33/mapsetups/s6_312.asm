...
cs_5AC58:       textCursor $70C         ; 0004 INIT TEXT CURSOR 70C : "You may go now.{N}I need to talk to fairy.{W1}"
		...
		csWait $1E
		stepEvent $11,$B        ; 0047  11 B
		entityPosDir $80,$11,$B,$3; 0019 SET ENTITY POS AND FACING 80 11 B 3
		moveEntity $80,$FF,$3,$3; 002D MOVE ENTITY 80 FF 3 3
		endMove $8080
		csWait $5
		...
		entityPosDir $7,$F,$15,$1; 0019 SET ENTITY POS AND FACING 7 F 15 1
		entityPosDir $0,$F,$16,$1; 0019 SET ENTITY POS AND FACING 0 F 16 1
		entityPosDir $1F,$F,$17,$1; 0019 SET ENTITY POS AND FACING 1F F 17 1
		stepEvent $F,$14        ; 0047  F 14
		setCamDest $8,$C        ; 0032 SET CAMERA DEST 8 C
		csWait $1E
		...
		moreMove $2,$3
		endMove $8080
		moveEntity $1F,$FF,$1,$6; 002D MOVE ENTITY 1F FF 1 6
		moreMove $2,$2
		endMove $8080
		...
		dc.l eas_Idle           
		dc.w $8080              ; 0014 END OF CUSTOM ACTSCRIPT
		moveEntity $7,$0,$0,$5  ; 002D MOVE ENTITY 7 0 0 5
		moreMove $1,$3
		endMove $8080
		moveEntity $1F,$0,$0,$5 ; 002D MOVE ENTITY 1F 0 0 5
		moreMove $1,$3
		endMove $8080
		moveEntity $0,$0,$0,$5  ; 002D MOVE ENTITY 0 0 0 5
		moreMove $1,$3
		endMove $8080
		csWait $A
		animEntityFadeInOut $80,$2; 0022 ANIMATE ENTITY FADE INOUT 80
		entityPosDir $80,$11,$C,$3; 0019 SET ENTITY POS AND FACING 80 11 C 3
		animEntityFadeInOut $80,$3; 0022 ANIMATE ENTITY FADE INOUT 80
		waitIdle $0             ; 0016 WAIT UNTIL IDLE ENTITY 0
		setActscript $7,$0,eas_BumpUp; 0015 SET ACTSCRIPT 7 0 45F0C
		setActscript $1F,$0,eas_BumpUp; 0015 SET ACTSCRIPT 1F 0 45F0C
		...
		csc_end
cs_5AF36:       textCursor $72A         ; 0004 INIT TEXT CURSOR 72A : "No, don't go in there!{N}That door is...!{W1}"
		...
		setActscript $0,$0,eas_463AE; 0015 SET ACTSCRIPT 0 0 463AE
		setActscript $7,$0,eas_463AE; 0015 SET ACTSCRIPT 7 0 463AE
		setActscript $1F,$0,eas_463AE; 0015 SET ACTSCRIPT 1F 0 463AE
		csWait $3C
		...
		setActscript $80,$FF,eas_Jump; 0015 SET ACTSCRIPT 80 FF 45E44
		csWait $14
		mapSysEvent $16,$0,$0,$3; 0007 EXECUTE MAP SYSTEM EVENT 16000003
		csc_end
cs_5B016:       textCursor $730         ; 0004 INIT TEXT CURSOR 730 : "Goliath...Goliath!{W1}"
		reloadMap $C,$2         ; 0046  C 2
		...
		entityPosDir $80,$11,$E,$1; 0019 SET ENTITY POS AND FACING 80 11 E 1
		setCamDest $C,$4        ; 0032 SET CAMERA DEST C 4
		moveEntity $80,$FF,$1,$2; 002D MOVE ENTITY 80 FF 1 2
		endMove $8080
		stepEvent $11,$B        ; 0047  11 B
		...
		dc.l eas_Idle           
		dc.w $8080              ; 0014 END OF CUSTOM ACTSCRIPT
		moveEntity $80,$FF,$3,$5; 002D MOVE ENTITY 80 FF 3 5
		endMove $8080
		setFacing $81,$1        ; 0023 SET ENTITY FACING 81 1
		csWait $78
		setFacing $81,$3        ; 0023 SET ENTITY FACING 81 3
		...
		csWait $A
		flashScreenWhite $1E    ; 0041 FLASH SCREEN WHITE 1E
		entityPosDir $0,$10,$9,$3; 0019 SET ENTITY POS AND FACING 0 10 9 3
		setActscript $0,$0,eas_46310; 0015 SET ACTSCRIPT 0 0 46310
		entityPosDir $7,$F,$9,$3; 0019 SET ENTITY POS AND FACING 7 F 9 3
		setActscript $7,$0,eas_46310; 0015 SET ACTSCRIPT 7 0 46310
		entityPosDir $1F,$11,$9,$3; 0019 SET ENTITY POS AND FACING 1F 11 9 3
		setActscript $1F,$0,eas_46310; 0015 SET ACTSCRIPT 1F 0 46310
		csWait $3C
		csWait $5
		setActscript $0,$0,eas_461B6; 0015 SET ACTSCRIPT 0 0 461B6
		csWait $5
		...
		entityPosDir $82,$10,$0,$3; 0019 SET ENTITY POS AND FACING 82 10 0 3
		moveEntity $82,$FF,$3,$7; 002D MOVE ENTITY 82 FF 3 7
		endMove $8080
		...
		setFacing $81,$3        ; 0023 SET ENTITY FACING 81 3
		moveEntity $80,$FF,$1,$4; 002D MOVE ENTITY 80 FF 1 4
		moreMove $0,$1
		moreMove $1,$3
		endMove $8080
		...
		setActscript $81,$FF,eas_Init; 0015 SET ACTSCRIPT 81 FF 460CE
		moveEntity $81,$FF,$2,$3; 002D MOVE ENTITY 81 FF 2 3
		moreMove $1,$2
		moreMove $2,$4
		endMove $8080
		...
		followEntity $1F,$7,$2  ; 002C FOLLOW ENTITY 1F 7 2
		csc_end
cs_5B466:       textCursor $78C         ; 0004 INIT TEXT CURSOR 78C : "Oddler?{W1}"
		setCamDest $C,$F        ; 0032 SET CAMERA DEST C F
		csWait $14
		setFacing $7,$1         ; 0023 SET ENTITY FACING 7 1
		setFacing $0,$1         ; 0023 SET ENTITY FACING 0 1
		...
		setFacing $1F,$1        ; 0023 SET ENTITY FACING 1F 1
		setFacing $82,$1        ; 0023 SET ENTITY FACING 82 1
		entityPosDir $81,$11,$F,$3; 0019 SET ENTITY POS AND FACING 81 11 F 3
		setCamDest $C,$7        ; 0032 SET CAMERA DEST C 7
		setActscript $7,$FF,eas_Init; 0015 SET ACTSCRIPT 7 FF 460CE
		setActscript $1F,$FF,eas_Init; 0015 SET ACTSCRIPT 1F FF 460CE
		setActscript $82,$FF,eas_Init; 0015 SET ACTSCRIPT 82 FF 460CE
		entityPosDir $0,$F,$17,$1; 0019 SET ENTITY POS AND FACING 0 F 17 1
		entityPosDir $7,$F,$16,$1; 0019 SET ENTITY POS AND FACING 7 F 16 1
		entityPosDir $1F,$10,$16,$1; 0019 SET ENTITY POS AND FACING 1F 10 16 1
		entityPosDir $82,$10,$17,$1; 0019 SET ENTITY POS AND FACING 82 10 17 1
		hideEntity $E           ; 002E HIDE ENTITY E
		hideEntity $10          ; 002E HIDE ENTITY 10
		hideEntity $11          ; 002E HIDE ENTITY 11
		hideEntity $F           ; 002E HIDE ENTITY F
		...
		setFacing $1F,$1        ; 0023 SET ENTITY FACING 1F 1
		csWait $1E
		moveEntity $1F,$FF,$1,$3; 002D MOVE ENTITY 1F FF 1 3
		endMove $8080
		hideEntity $1F          ; 002E HIDE ENTITY 1F
		moveEntity $81,$FF,$0,$1; 002D MOVE ENTITY 81 FF 0 1
		moreMove $B,$1
		endMove $8080
		...
		followEntity $7,$0,$2   ; 002C FOLLOW ENTITY 7 0 2
		followEntity $82,$7,$2  ; 002C FOLLOW ENTITY 82 7 2
		csc_end
