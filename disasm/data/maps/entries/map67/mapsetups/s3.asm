...
cs_4FB64:
		...
		nextSingleText $0,$1F   
						; "{LEADER}...{NAME;7}...can{N}you hear that?{W1}"
		nextSingleText $C0,$7   
						; "Hear what?{W1}"
		csWait $5               
						; WAIT 5
		...
		csWait $78              
						; WAIT 78
		nextText $0,$1F         
						; "Somebody is crying for help...{W2}"
		nextSingleText $0,$1F   
						; "from...over here.{W1}"
		...
		mapSysEvent $330B1601   
						; 0007 EXECUTE MAP SYSTEM EVENT 330B1601
		csc_end                 
						; END OF CUTSCENE SCRIPT
cs_4FC32:
		textCursor $A21         
						; Initial text line $A21 : "Fairy said, move this rock{N}in this manner, and...{W1}"
		csc2B $D,$39,$19,$1,$FF 
						; 002B  D 39 19 1 FF
		...
		setEntityDir $1F,$1     
						; 0023 SET ENTITY FACING 1F 1
		nextSingleText $0,$D    
						; "Fairy said, move this rock{N}in this manner, and...{W1}"
		csWait $1E              
						; WAIT 1E
