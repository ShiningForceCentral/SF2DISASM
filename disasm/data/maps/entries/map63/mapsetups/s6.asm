...
cs_5CA5E:       entitySprite $1D,$B0    ; 001A SET ENTITY SPRITE 1D B0
		setEntityDir $1D,$3     ; 0023 SET ENTITY FACING 1D 3
		stopEntity $1D          ; 001C STOP ENTITY ANIM 1D
		csc_end                 ; END OF CUTSCENE SCRIPT
cs_5CA6E:       setBlocks $1036,$101,$D2B; 0034 SET BLOCKS 1036 101 D2B
		playSound SFX_DOOR_OPEN_HIGH_PITCH
						; 0005 PLAY SOUND SFX_DOOR_OPEN_HIGH_PITCH
		csWait $14              ; WAIT 14
		setBlocks $1036,$101,$D2C; 0034 SET BLOCKS 1036 101 D2C
		playSound SFX_DOOR_OPEN_HIGH_PITCH
						; 0005 PLAY SOUND SFX_DOOR_OPEN_HIGH_PITCH
		csWait $12              ; WAIT 12
		setBlocks $1036,$101,$D2D; 0034 SET BLOCKS 1036 101 D2D
		playSound SFX_DOOR_OPEN_HIGH_PITCH
						; 0005 PLAY SOUND SFX_DOOR_OPEN_HIGH_PITCH
		csWait $10              ; WAIT 10
		setBlocks $1036,$101,$D2E; 0034 SET BLOCKS 1036 101 D2E
		playSound SFX_DOOR_OPEN_HIGH_PITCH
						; 0005 PLAY SOUND SFX_DOOR_OPEN_HIGH_PITCH
		csWait $E               ; WAIT E
		setBlocks $1036,$101,$D2F; 0034 SET BLOCKS 1036 101 D2F
		playSound SFX_DOOR_OPEN_HIGH_PITCH
						; 0005 PLAY SOUND SFX_DOOR_OPEN_HIGH_PITCH
		csWait $C               ; WAIT C
		setBlocks $1036,$101,$D30; 0034 SET BLOCKS 1036 101 D30
		playSound SFX_DOOR_OPEN_HIGH_PITCH
						; 0005 PLAY SOUND SFX_DOOR_OPEN_HIGH_PITCH
		csWait $A               ; WAIT A
		setBlocks $1036,$101,$E30; 0034 SET BLOCKS 1036 101 E30
		playSound SFX_DOOR_OPEN_HIGH_PITCH
						; 0005 PLAY SOUND SFX_DOOR_OPEN_HIGH_PITCH
		csWait $8               ; WAIT 8
		setBlocks $1036,$101,$F30; 0034 SET BLOCKS 1036 101 F30
		playSound SFX_DOOR_OPEN_HIGH_PITCH
						; 0005 PLAY SOUND SFX_DOOR_OPEN_HIGH_PITCH
		csWait $6               ; WAIT 6
		setBlocks $1036,$101,$F31; 0034 SET BLOCKS 1036 101 F31
		playSound SFX_DOOR_OPEN_HIGH_PITCH
						; 0005 PLAY SOUND SFX_DOOR_OPEN_HIGH_PITCH
		csWait $5               ; WAIT 5
		setBlocks $1036,$101,$F32; 0034 SET BLOCKS 1036 101 F32
		playSound SFX_DOOR_OPEN_HIGH_PITCH
						; 0005 PLAY SOUND SFX_DOOR_OPEN_HIGH_PITCH
		csWait $4               ; WAIT 4
		setBlocks $1036,$101,$F33; 0034 SET BLOCKS 1036 101 F33
		playSound SFX_DOOR_OPEN_HIGH_PITCH
						; 0005 PLAY SOUND SFX_DOOR_OPEN_HIGH_PITCH
		csWait $3               ; WAIT 3
		setBlocks $1036,$101,$F34; 0034 SET BLOCKS 1036 101 F34
		playSound SFX_DOOR_OPEN_HIGH_PITCH
						; 0005 PLAY SOUND SFX_DOOR_OPEN_HIGH_PITCH
		csWait $2               ; WAIT 2
		setBlocks $1036,$101,$F35; 0034 SET BLOCKS 1036 101 F35
		playSound SFX_DOOR_OPEN_HIGH_PITCH
						; 0005 PLAY SOUND SFX_DOOR_OPEN_HIGH_PITCH
		csWait $1               ; WAIT 1
		setBlocks $1036,$101,$F36; 0034 SET BLOCKS 1036 101 F36
		playSound SFX_DOOR_OPEN_HIGH_PITCH
						; 0005 PLAY SOUND SFX_DOOR_OPEN_HIGH_PITCH
		csWait $1               ; WAIT 1
		csc_end                 ; END OF CUTSCENE SCRIPT
cs_5CB34:       csc35 $1035,$101,$F36   ; 0035 UNKNOWN, SIMILAR TO SET BLOCKS, TO FIGURE OUT
		setBlocks $C2B,$101,$D2B; 0034 SET BLOCKS C2B 101 D2B
		csWait $1E              ; WAIT 1E
		csc35 $1035,$101,$F35   ; 0035 UNKNOWN, SIMILAR TO SET BLOCKS, TO FIGURE OUT
		setBlocks $1035,$101,$D2C; 0034 SET BLOCKS 1035 101 D2C
		csWait $19              ; WAIT 19
		csc35 $1035,$101,$F34   ; 0035 UNKNOWN, SIMILAR TO SET BLOCKS, TO FIGURE OUT
		setBlocks $1035,$101,$D2D; 0034 SET BLOCKS 1035 101 D2D
		csWait $14              ; WAIT 14
		csc35 $1035,$101,$F33   ; 0035 UNKNOWN, SIMILAR TO SET BLOCKS, TO FIGURE OUT
		setBlocks $1035,$101,$D2E; 0034 SET BLOCKS 1035 101 D2E
		csWait $F               ; WAIT F
		csc35 $1035,$101,$F32   ; 0035 UNKNOWN, SIMILAR TO SET BLOCKS, TO FIGURE OUT
		setBlocks $1035,$101,$D2F; 0034 SET BLOCKS 1035 101 D2F
		csWait $A               ; WAIT A
		csc35 $1035,$101,$F31   ; 0035 UNKNOWN, SIMILAR TO SET BLOCKS, TO FIGURE OUT
		setBlocks $1035,$101,$D30; 0034 SET BLOCKS 1035 101 D30
		csWait $5               ; WAIT 5
		csc35 $1035,$101,$F30   ; 0035 UNKNOWN, SIMILAR TO SET BLOCKS, TO FIGURE OUT
		setBlocks $1035,$101,$E30; 0034 SET BLOCKS 1035 101 E30
		csWait $1               ; WAIT 1
		csc_end                 ; END OF CUTSCENE SCRIPT
cs_5CBB4:       textCursor $1053        ; Initial text line $1053 : "{LEADER} put the Arm of{N}Golem on the golem.{W1}"
		...
		csWait $28              ; WAIT 28
		setEntityDir $1D,$2     ; 0023 SET ENTITY FACING 1D 2
		csWait $14              ; WAIT 14
		setEntityDir $1D,$1     ; 0023 SET ENTITY FACING 1D 1
		csWait $14              ; WAIT 14
		setEntityDir $1D,$0     ; 0023 SET ENTITY FACING 1D 0
		csWait $14              ; WAIT 14
		setEntityDir $1D,$3     ; 0023 SET ENTITY FACING 1D 3
		setActscript $1D,$FF,eas_Jump; 0015 SET ACTSCRIPT 1D FF 45E44
		setQuakeAmount $2       ; 0033 SET QUAKE AMOUNT 2
		...
		csc56 $1D               ; 0056 UNKNOWN, SOMETHING WITH AN ENTITY
		csc_end                 ; END OF CUTSCENE SCRIPT
...
cs_5CCF6:       entityFlashWhite $0,$32 ; 0018 FLASH ENTITY WHITE 0 32
		...
		setEntityDir $1D,$3     ; 0023 SET ENTITY FACING 1D 3
		stopEntity $1D          ; 001C STOP ENTITY ANIM 1D
cs_5CDDA:       csc_end                 ; END OF CUTSCENE SCRIPT
