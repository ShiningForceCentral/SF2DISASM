...
cs_5CBB4:
		dc.w 4                  
						; 0004 INIT TEXT CURSOR 1053 : "{LEADER} put the Arm of{N}Golem on the golem.{W1}"
		dc.w $1053
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX FFFF : "{LEADER} put the Arm of{N}Golem on the golem.{W1}"
		dc.w $FFFF
		dc.w $1A                
		...
		dc.w $1D
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 1D : "O...ooo...wow!{W1}"
		dc.w $1D
		dc.w $15                
		...
		dc.b $1E
		dc.w 2                  
						; 0002 DISPLAY TEXT BOX 1D : "That feels good....{N}My power is back!{W1}"
		dc.w $1D
		dc.w 2                  
						; 0002 DISPLAY TEXT BOX 1D : "Thank you.{N}I can move again!{N}How can I express...{W1}"
		dc.w $1D
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 1D : "Oh, yes!  I'll join you!{N}I'll protect you!{W1}"
		dc.w $1D
		dc.w 8                  
						; 0008 JOIN FORCE 1D
		dc.w $1D
		dc.w $56                
						; 0056 SOMETHING WITH AN ENTITY 1D
		dc.w $1D
		dc.w $FFFF              
						; END OF CUTSCENE SCRIPT
cs_5CC26:
...
cs_5CCF6:
		...
		dc.w 0
		dc.w $C                 
						; 000C JUMP IF SET FLAG 1D 5CDDA : Claude joined
		dc.w $1D
		dc.l word_5CDDA         
		dc.w $1A                
						; 001A SET ENTITY SPRITE 1D B0
