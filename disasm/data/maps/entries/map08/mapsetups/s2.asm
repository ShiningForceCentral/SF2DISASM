...
cs_56146:       setActscript $8,$FF,eas_Init; 0015 SET ACTSCRIPT 8 FF 460CE
		...
		csc52 $8,$0             ; 0052 UNKNOWN, RELATED TO TWO ENTITIES
		textCursor $543         ; Initial text line $543 : "The people in this village{N}are cowards!{W2}{N}When do they ever go{N}adventuring?{N}I can't take it anymore!{W2}{N}Hey, would you mind if I{N}joined you?{W1}"
		...
		csc56 $8                ; 0056 UNKNOWN, SOMETHING WITH AN ENTITY
		csc_end                 ; END OF CUTSCENE SCRIPT
cs_56172:       textCursor $534         ; Initial text line $534 : "To Mt. Volcano?{W1}"
