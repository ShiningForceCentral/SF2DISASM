...
sub_56090:
		...
		trap    #TEXTBOX
		dc.w $529               
						; "Our ancestors came from{N}Rune, a southern island,{N}long ago.{W2}"
		trap    #TEXTBOX
		dc.w $52A               
						; "Since then, we've travelled{N}up here.{W2}"
		trap    #TEXTBOX
		dc.w $52B               
						; "The mountains to the north{N}block our journey.{W2}"
loc_560A6:
		
		trap    #TEXTBOX
		dc.w $52C               
						; "Are you going to{N}Mt. Volcano?{N}That's {NAME;7}'s hometown?{W1}"
		rts
...
sub_560AC:
		...
		trap    #TEXTBOX
		dc.w $52D               
						; "We won't hide from you{N}anymore.  Ribble has many{N}ancient ruins.{W1}"
		rts
...
sub_560B2:
		...
		trap    #TEXTBOX
		dc.w $52E               
						; "Men are so selfish.{N}My husband has gone to the{N}east to work.  What about me?{W1}"
		rts
...
sub_560BE:
		...
		trap    #TEXTBOX
		dc.w $52F               
						; "Keseran is a historian.{N}But Mr. {NAME;11} is smarter{N}than him!{W2}"
		trap    #TEXTBOX
		dc.w $530               
						; "I saw a strange hollow in a{N}tree.  Does something go{N}there?{W2}"
		trap    #TEXTBOX
		dc.w $531               
						; "Is what you're looking for in{N}Ribble?{W1}"
		rts
...
sub_560CC:
		...
		trap    #TEXTBOX
		dc.w $533               
						; "The hidden door to the{N}ancient ruins must be near{N}this tree!{W1}"
		bra.s   return_560E0
loc_560DC:
		
		trap    #TEXTBOX
		dc.w $545               
						; "Wow, the ancient door!{N}I knew it was there!  I did!{W1}"
return_560E0:
...
sub_560F6:
		...
		trap    #TEXTBOX
		dc.w $539               
						; "Paseran and I are pupils{N}of Mr. {NAME;11} of Hassan.{W2}"
		trap    #TEXTBOX
		dc.w $53A               
						; "The ancient ruins around here{N}are very interesting to us!{W2}"
		trap    #TEXTBOX
		dc.w $53B               
						; "We're sure there are ruins{N}under Ribble, but we can't{N}find the door?{W2}"
		trap    #TEXTBOX
		dc.w $53C               
						; "I'll find it before Paseran!{N}I think that tree has{N}something to do with it.{W1}"
		rts
...
sub_56108:
		...
		trap    #TEXTBOX
		dc.w $53D               
						; "We recently came from Hassan.{N}Hassan is a port in the south.{W2}"
		trap    #TEXTBOX
		dc.w $53E               
						; "It was once very prosperous,{N}but now it's desolate.{W1}"
		rts
...
sub_56112:
		...
		trap    #TEXTBOX
		dc.w $53F               
						; "My dad went to the cave in{N}the north.{W2}"
		trap    #TEXTBOX
		dc.w $540               
						; "But, I'm not worried!{N}He's very strong.{W1}"
		rts
...
sub_5611C:
		...
		trap    #TEXTBOX
		dc.w $541               
						; "My dear husband never{N}returned from the cave.{W2}"
		trap    #TEXTBOX
		dc.w $542               
						; "The cave was somehow{N}blocked.  How can I explain{N}this to my son?{W1}"
		rts
