...
cs_56314:       hideText                ; 0009 HIDE TEXTBOX AND PORTRAIT
		...
		setBlocks $2011,$202,$F13; 0034 SET BLOCKS 2011 202 F13
		csWait $1E              ; WAIT 1E
		setQuakeAmount $0       ; 0033 SET QUAKE AMOUNT 0
		csWait $1E              ; WAIT 1E
		setQuakeAmount $2       ; 0033 SET QUAKE AMOUNT 2
		playSound SFX_BATTLEFIELD_DEATH; 0005 PLAY SOUND SFX_BATTLEFIELD_DEATH
		setBlocks $2211,$202,$F13; 0034 SET BLOCKS 2211 202 F13
		csWait $1E              ; WAIT 1E
		setQuakeAmount $0       ; 0033 SET QUAKE AMOUNT 0
		csWait $1E              ; WAIT 1E
		setQuakeAmount $2       ; 0033 SET QUAKE AMOUNT 2
		playSound SFX_BATTLEFIELD_DEATH; 0005 PLAY SOUND SFX_BATTLEFIELD_DEATH
		setBlocks $200E,$202,$F13; 0034 SET BLOCKS 200E 202 F13
		csWait $1E              ; WAIT 1E
		setQuakeAmount $0       ; 0033 SET QUAKE AMOUNT 0
		csWait $1E              ; WAIT 1E
