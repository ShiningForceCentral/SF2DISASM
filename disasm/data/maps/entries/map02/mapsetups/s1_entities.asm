...
; 0x5E89C..0x5E8EE : 
ms_map2_Entities:
                msWalkingEntity 21, 22, DOWN, MAPSPRITE_CENTAUR_MALE, 21, 22, 1
                msFixedEntity 34, 26, DOWN, MAPSPRITE_CENTAUR_MALE, eas_Init
                msFixedEntity 8, 21, RIGHT, MAPSPRITE_CENTAUR_FEMALE, eas_Init
                msFixedEntity 23, 4, UP, MAPSPRITE_CENTAUR_MALE, eas_Init
