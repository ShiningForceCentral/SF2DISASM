...
sub_5E966:
		...
		trap    #TEXTBOX
		dc.w $DFF               
						; "You're not devils, are you?{W2}"
		trap    #TEXTBOX
		dc.w $E00               
						; "How did you get here safely?{W1}"
		rts
...
sub_5E976:
		...
		trap    #TEXTBOX
		dc.w $E02               
						; "Are you strong?  Will you{N}please kill the devils?{W1}"
		rts
...
sub_5E97C:
		...
		trap    #TEXTBOX
		dc.w $E03               
						; "Pacalon soldiers are so{N}proud!{W2}"
		trap    #TEXTBOX
		dc.w $E04               
						; "But, they're just cowards{N}that hide in the castle.{W1}"
		rts
...
sub_5E986:
		...
		trap    #TEXTBOX
		dc.w $E05               
						; "What will we do when we{N}lose?{W1}"
		rts
...
sub_5E98C:
		...
		trap    #TEXTBOX
		dc.w $E06               
						; "Do you know Geshp?{W2}"
		trap    #TEXTBOX
		dc.w $E07               
						; "He sometimes comes here.{N}He seems so friendly.{W2}"
		trap    #TEXTBOX
		dc.w $E08               
						; "Are all devils like him?{N}If so, I like them.{W1}"
		rts
...
sub_5E99A:
		...
		trap    #TEXTBOX
		dc.w $E09               
						; "Do you think Pacalon can{N}beat the devils?{W2}"
		trap    #TEXTBOX
		dc.w $E0A               
						; "Say yes!  Pacalon has the{N}best fighters in the world!{W1}"
		rts
