...
cs_62D06:       entitySprite $B,$AA     ; 001A SET ENTITY SPRITE B AA
		csc_end
cs_62D0E:       textCursor $F7F         ; 0004 INIT TEXT CURSOR F7F : "King Granseal, {LEADER}{N}is here!{W1}"
		setCameraEntity $81     ; 0024 SET ENTITY FOLLOWED BY CAMERA 81
		entityPosDir $81,$1A,$1D,$1; 0019 SET ENTITY POS AND FACING 81 1A 1D 1
		entityPosDir $4,$1A,$1E,$1; 0019 SET ENTITY POS AND FACING 4 1A 1E 1
		entityPosDir $1,$1A,$1E,$1; 0019 SET ENTITY POS AND FACING 1 1A 1E 1
		entityPosDir $3,$1A,$1E,$1; 0019 SET ENTITY POS AND FACING 3 1A 1E 1
		entityPosDir $2,$1A,$1E,$1; 0019 SET ENTITY POS AND FACING 2 1A 1E 1
		followEntity $0,$81,$2  ; 002C FOLLOW ENTITY 0 81 2
		followEntity $4,$81,$5  ; 002C FOLLOW ENTITY 4 81 5
		followEntity $1,$81,$6  ; 002C FOLLOW ENTITY 1 81 6
		followEntity $3,$4,$2   ; 002C FOLLOW ENTITY 3 4 2
		followEntity $2,$1,$2   ; 002C FOLLOW ENTITY 2 1 2
		csWait $A
		fadeInB                 ; 0039 FADE IN FROM BLACK
		moveEntity $81,$FF,$1,$4; 002D MOVE ENTITY 81 FF 1 4
		moreMove $0,$3
		moreMove $1,$2
		endMove $8080
		roofEvent $1D,$17       ; 0043 RELATED TO BLOCK COPY 1D 17
		moveEntity $81,$FF,$1,$E; 002D MOVE ENTITY 81 FF 1 E
		endMove $8080
		...
		setFacing $3,$1         ; 0023 SET ENTITY FACING 3 1
		setFacing $2,$1         ; 0023 SET ENTITY FACING 2 1
		...
		setFacing $8,$1         ; 0023 SET ENTITY FACING 8 1
		setFacing $13,$1        ; 0023 SET ENTITY FACING 13 1
		setFacing $B,$1         ; 0023 SET ENTITY FACING B 1
		setFacing $1A,$1        ; 0023 SET ENTITY FACING 1A 1
		setFacing $1B,$1        ; 0023 SET ENTITY FACING 1B 1
		csWait $A
		...
		csWait $A
		entityShiver $1         ; 002A MAKE ENTITY SHIVER 1
		csWait $A
		...
		csWait $14
		entityShiver $A         ; 002A MAKE ENTITY SHIVER A
		csWait $14
		...
		setFacing $7,$3         ; 0023 SET ENTITY FACING 7 3
		csWait $3C
		moveEntity $81,$FF,$2,$2; 002D MOVE ENTITY 81 FF 2 2
		moreMove $B,$1
		endMove $8080
		setFacing $7,$1         ; 0023 SET ENTITY FACING 7 1
		...
		setFacing $8,$3         ; 0023 SET ENTITY FACING 8 3
		setFacing $13,$3        ; 0023 SET ENTITY FACING 13 3
		setFacing $B,$1         ; 0023 SET ENTITY FACING B 1
		setFacing $0,$3         ; 0023 SET ENTITY FACING 0 3
		csWait $28
		setCamDest $18,$7       ; 0032 SET CAMERA DEST 18 7
		csWait $5
		setActscript $3,$0,eas_461B6; 0015 SET ACTSCRIPT 3 0 461B6
		csWait $64
		moveEntity $3,$FF,$3,$1 ; 002D MOVE ENTITY 3 FF 3 1
		endMove $8080
		setFacing $3,$0         ; 0023 SET ENTITY FACING 3 0
		entityShiver $3         ; 002A MAKE ENTITY SHIVER 3
		setFacing $1,$3         ; 0023 SET ENTITY FACING 1 3
		setFacing $2,$3         ; 0023 SET ENTITY FACING 2 3
		setFacing $4,$3         ; 0023 SET ENTITY FACING 4 3
		setFacing $5,$0         ; 0023 SET ENTITY FACING 5 0
		setFacing $A,$2         ; 0023 SET ENTITY FACING A 2
		setFacing $19,$0        ; 0023 SET ENTITY FACING 19 0
		setFacing $8,$0         ; 0023 SET ENTITY FACING 8 0
		setFacing $13,$2        ; 0023 SET ENTITY FACING 13 2
		setFacing $B,$0         ; 0023 SET ENTITY FACING B 0
		setFacing $1A,$0        ; 0023 SET ENTITY FACING 1A 0
		setFacing $1B,$2        ; 0023 SET ENTITY FACING 1B 2
		setFacing $0,$3         ; 0023 SET ENTITY FACING 0 3
		...
		setFacing $A,$1         ; 0023 SET ENTITY FACING A 1
		csWait $14
		entityShakeHead $A      ; 0027 MAKE ENTITY SHAKE HEAD A
		csWait $14
		...
		moveEntity $8,$FF,$3,$1 ; 002D MOVE ENTITY 8 FF 3 1
		moreMove $8,$1
		endMove $8080
		nextSingleText $0,$8    ; "{LEADER} is a human!{N}They will make a cute couple!{W1}"
		entityShiver $3         ; 002A MAKE ENTITY SHIVER 3
cs_62FB0:       textCursor $F93         ; 0004 INIT TEXT CURSOR F93 : "{LEADER} is a good lad{N}with the manner of a{N}knight!{W2}"
		moveEntity $7,$FF,$1,$1 ; 002D MOVE ENTITY 7 FF 1 1
		moreMove $B,$1
		endMove $8080
		moveEntity $13,$FF,$2,$1; 002D MOVE ENTITY 13 FF 2 1
		endMove $8080
		setFacing $3,$0         ; 0023 SET ENTITY FACING 3 0
		...
		dc.l eas_Idle           
		dc.w $8080              ; 0014 END OF CUSTOM ACTSCRIPT
		customActscript $2,$FF  ; 0014 SET MANUAL ACTSCRIPT 2
		dc.w $10                ;   0010 SET SPEED X=$30 Y=$30
		dc.b $30
		dc.b $30
		dc.w $34                ;   0034 JUMP TO ABSOLUTE ADDR. 0x451FC
		dc.l eas_Idle           
		dc.w $8080              ; 0014 END OF CUSTOM ACTSCRIPT
		moveEntity $1,$0,$3,$1  ; 002D MOVE ENTITY 1 0 3 1
		endMove $8080
		...
		setFacing $7,$3         ; 0023 SET ENTITY FACING 7 3
		setFacing $13,$3        ; 0023 SET ENTITY FACING 13 3
		moveEntity $1,$FF,$3,$8 ; 002D MOVE ENTITY 1 FF 3 8
		endMove $8080
		hideEntity $1           ; 002E HIDE ENTITY 1
		setActscript $2,$FF,eas_Init; 0015 SET ACTSCRIPT 2 FF 460CE
		startEntity $2          ; 001B START ENTITY ANIM 2
		setFacing $2,$3         ; 0023 SET ENTITY FACING 2 3
		entityShakeHead $2      ; 0027 MAKE ENTITY SHAKE HEAD 2
		csWait $1E
		setCamDest $18,$9       ; 0032 SET CAMERA DEST 18 9
		moveEntity $2,$FF,$3,$2 ; 002D MOVE ENTITY 2 FF 3 2
		endMove $8080
		csWait $32
		nextSingleText $0,$2    ; "Does she love {LEADER}?{N}I didn't know that.{W1}"
		setActscript $4,$FF,eas_Jump; 0015 SET ACTSCRIPT 4 FF 45E44
		setActscript $4,$FF,eas_Jump; 0015 SET ACTSCRIPT 4 FF 45E44
		moveEntity $4,$FF,$3,$1 ; 002D MOVE ENTITY 4 FF 3 1
		moreMove $0,$2
		moreMove $3,$2
		moreMove $A,$1
		endMove $8080
		...
		setFacing $2,$3         ; 0023 SET ENTITY FACING 2 3
		moveEntity $4,$0,$3,$2  ; 002D MOVE ENTITY 4 0 3 2
		endMove $8080
		csWait $8
		...
		entityShiver $81        ; 002A MAKE ENTITY SHIVER 81
