...
sub_52FC8:
		...
		trap    #TEXTBOX
		dc.w $261               
						; "Very few people know{N}about the sickness, even{N}in the castle.{W2}{N}Know what I mean?{W1}"
		rts
...
sub_52FCE:
		...
		trap    #TEXTBOX
		dc.w $262               
						; "Sir Astral is sleeping in{N}the King's bedroom.{W2}{N}He needs some more rest{N}because he is so old.{W2}"
		trap    #SET_FLAG
		dc.w $101
loc_52FDC:
		...
		trap    #TEXTBOX
		dc.w $263               
						; "Why don't you see him{N}before you leave?{N}He would be pleased.{W1}"
		rts
...
sub_52FE2:
		...
		trap    #TEXTBOX
		dc.w $264               
						; "I have not seen{N}Princess Elis today.{N}Is she OK?{W1}"
		rts
...
sub_52FE8:
		...
		trap    #TEXTBOX
		dc.w $265               
						; "Darn!{N}I can't sleep!{N}He keeps snoring!{W1}"
		rts
...
sub_52FEE:
		...
		trap    #TEXTBOX
		dc.w $266               
						; "The Galam messenger just{N}went back to his country.{N}He looked so pale.{W2}{N}I hope he gets to Galam{N}safely?{W1}"
		rts
...
sub_52FF4:
		...
		trap    #TEXTBOX
		dc.w $267               
						; "Breakfast is over and now{N}I have to make lunch!{N}Busy, busy!{W1}"
		rts
...
sub_52FFA:
		...
		trap    #TEXTBOX
		dc.w $268               
						; "The messenger from Galam{N}has left.{W2}{N}He was in such hurry.{W1}"
		rts
...
sub_53000:
		...
		trap    #TEXTBOX
		dc.w $269               
						; "Yeel?  Yes, it's a small{N}village near the mountains.{N}Travel northwest to get there.{W1}"
		rts
...
sub_53006:
		...
		trap    #TEXTBOX
		dc.w $2F7               
						; "You are the pupils of{N}Sir Astral.  We are counting{N}on you.{W2}{N}Good luck.{W1}"
		rts
...
sub_5300C:
		...
		trap    #TEXTBOX
		dc.w $257               
						; "The Ancient Tower was{N}originally called{N}Ground Seal.{W2}{N}Our kingdom seems to have{N}been named after it.{W2}"
		trap    #TEXTBOX
		dc.w $258               
						; "Why?  I don't know why.{N}It was already there when{N}our ancestors settled here.{W1}"
		rts
