...
cs_53176:       setCameraEntity $FFFF   ; 0024 SET ENTITY FOLLOWED BY CAMERA FFFF
		textCursor $2D1         ; Initial text line $2D1 : "That's all the info I can{N}give you about the mission.{W1}"
		csc2B $90,$1D,$9,$1,$CF ; 002B  90 1D 9 1 CF
		csc2B $91,$1C,$9,$1,$CE ; 002B  91 1C 9 1 CE
		csc2B $92,$1C,$A,$1,$CA ; 002B  92 1C A 1 CA
		csc2B $93,$1C,$B,$1,$CA ; 002B  93 1C B 1 CA
		csWait $1               ; WAIT 1
		csc2B $94,$1E,$9,$1,$CE ; 002B  94 1E 9 1 CE
		csc2B $95,$1E,$A,$1,$CA ; 002B  95 1E A 1 CA
		csc2B $96,$1E,$B,$1,$CA ; 002B  96 1E B 1 CA
		csWait $1               ; WAIT 1
		...
		endMove $8080
		setEntityDir $91,$3     ; 0023 SET ENTITY FACING 91 3
		setEntityDir $92,$3     ; 0023 SET ENTITY FACING 92 3
		setEntityDir $93,$3     ; 0023 SET ENTITY FACING 93 3
		setEntityDir $94,$3     ; 0023 SET ENTITY FACING 94 3
		setEntityDir $95,$3     ; 0023 SET ENTITY FACING 95 3
		setEntityDir $96,$3     ; 0023 SET ENTITY FACING 96 3
		csWait $14              ; WAIT 14
		setEntityDir $90,$1     ; 0023 SET ENTITY FACING 90 1
		...
		moreMove $1,$2
		endMove $8080
		setEntityDir $8A,$0     ; 0023 SET ENTITY FACING 8A 0
		nextSingleText $80,$8A  ; "Here I am.{W1}"
		csWait $5               ; WAIT 5
		setActscript $8C,$0,eas_461E4; 0015 SET ACTSCRIPT 8C 0 461E4
		csWait $78              ; WAIT 78
		setEntityDir $8C,$2     ; 0023 SET ENTITY FACING 8C 2
		...
		moreMove $1,$1
		endMove $8080
		setEntityDir $8A,$1     ; 0023 SET ENTITY FACING 8A 1
		csWait $14              ; WAIT 14
...
cs_53482:       yesNo                   ; 0011 STORY YESNO PROMPT
		...
		textCursor $2F5         ; Initial text line $2F5 : "You refuse the King's{N}wish?!{N}Answer again!{W1}"
		setActscript $8A,$FF,eas_Jump; 0015 SET ACTSCRIPT 8A FF 45E44
		setActscript $8A,$FF,eas_Jump; 0015 SET ACTSCRIPT 8A FF 45E44
...
cs_534AC:       moveEntity $8C,$FF,$3,$1; 002D MOVE ENTITY 8C FF 3 1
		endMove $8080
		setEntityDir $8C,$2     ; 0023 SET ENTITY FACING 8C 2
		textCursor $2F6         ; Initial text line $2F6 : "Thank you.{N}Depart to fetch Hawel{N}immediately.{W1}"
...
cs_534D2:       textCursor $2B6         ; Initial text line $2B6 : "Stop, please stop!{N}Don't make me use my{N}sword any more!{W1}"
		...
		csc_end                 ; END OF CUTSCENE SCRIPT
cs_535FA:       textCursor $2B2         ; Initial text line $2B2 : "Oh, it's you, {LEADER}!{W2}"
		...
		csc_end                 ; END OF CUTSCENE SCRIPT
cs_53620:       textCursor $2C9         ; Initial text line $2C9 : "Strange earthquake....{N}{LEADER}, you must{N}escape!{W1}"
		nextSingleText $0,$80   ; "Strange earthquake....{N}{LEADER}, you must{N}escape!{W1}"
		csc_end                 ; END OF CUTSCENE SCRIPT
cs_5362A:       textCursor $2CA         ; Initial text line $2CA : "OK, everybody is safe.{W1}"
