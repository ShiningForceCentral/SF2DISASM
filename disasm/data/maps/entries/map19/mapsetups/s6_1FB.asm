...
cs_53176:       setCameraEntity $FFFF
		textCursor $2D1
		newEntity $90,$1D,$9,$1,$CF
		newEntity $91,$1C,$9,$1,$CE
		newEntity $92,$1C,$A,$1,$CA
		newEntity $93,$1C,$B,$1,$CA
		csWait $1
		newEntity $94,$1E,$9,$1,$CE
		newEntity $95,$1E,$A,$1,$CA
		newEntity $96,$1E,$B,$1,$CA
		csWait $1
