...
cs_53176:
		...
		textCursor $2D1         
						; Initial text line $2D1 : "That's all the info I can{N}give you about the mission.{W1}"
		csc2B $90,$1D,$9,$1,$CF 
						; 002B  90 1D 9 1 CF
		csc2B $91,$1C,$9,$1,$CE 
						; 002B  91 1C 9 1 CE
		...
		csWait $28              
						; WAIT 28
		nextSingleText $80,$8A  
						; "That's all the info I can{N}give you about the mission.{W1}"
		moveEntity $90,$FF,$1,$1
						; 002D MOVE ENTITY 90 FF 1 1
		endMove $8080
		nextSingleText $80,$8A  
						; "So, all we have to do is{N}find the evil Gizmo and{N}kill him.{W1}"
		entityNod $8A           
						; 0026 MAKE ENTITY NOD 8A
		nextSingleText $80,$8A  
						; "That's right.  Kill him{N}before he possesses{N}somebody else.{W2}"
		nextSingleText $80,$8A  
						; "You may go.{W1}"
		nextSingleText $0,$90   
						; "Yes, sir.{W1}"
		...
		nextSingleText $0,$90   
						; "Let's go and defeat the{N}evil Gizmo.{W1}"
		...
		csWait $46              
						; WAIT 46
		nextText $80,$8A        
						; "Sir Astral is still{N}sleeping...{N}Is he alright?{W2}"
		nextSingleText $80,$8A  
						; "The King is upstairs looking{N}in on Sir Astral.{N}I'm worried.{W1}"
		setEntityDir $8A,$2     
		...
		endMove $8080
		nextText $80,$8A        
						; "He just fainted because{N}he was exhausted by the{N}two battles.{W2}"
		nextSingleText $80,$8A  
						; "Don't worry about him.{N}If he dies, it doesn't matter.{N}He's old anyway.{W1}"
		csWait $28              
						; WAIT 28
		nextSingleText $0,$8C   
						; "Minister!{N}Is the Minister there?{W1}"
		setEntityDir $8A,$3     
						; 0023 SET ENTITY FACING 8A 3
		csWait $1E              
						; WAIT 1E
		entityPosDir $8C,$17,$D,$1
		...
		nextSingleText $0,$8C   
						; "Did our soldiers leave{N}for the subjugation?{W1}"
		entityNod $8A           
						; 0026 MAKE ENTITY NOD 8A
		nextSingleText $80,$8A  
						; "Yes, just a few minutes{N}ago.{W1}"
		csWait $1E              
						; WAIT 1E
		setCamDest $17,$5       
		...
		nextText $0,$8C         
						; "Oh, I'm too late.{W2}"
		nextSingleText $0,$8C   
						; "Astral came back to his{N}senses just now.{W1}"
		customActscript $8A,$FF 
						; 0014 SET MANUAL ACTSCRIPT 8A
		dc.w $10                
		...
		endMove $8080
		nextSingleText $80,$8A  
						; "That's great!{N}Did you talk to him?{W1}"
		nextText $0,$8C         
						; "Astral said, he feels an ill{N}omen behind the opening of{N}the tower and Gizmo appearing.{W2}"
		nextSingleText $0,$8C   
						; "We must study the ancient{N}history of Grans Island.{W1}"
		nextSingleText $80,$8A  
						; "How?{W1}"
		nextText $0,$8C         
						; "A historian named Hawel{N}lives northwest of Yeel.{W2}"
		nextSingleText $0,$8C   
						; "Astral asked me to send{N}soldiers for him, but....{W1}"
		nextSingleText $80,$8A  
						; "Ah, I understand.{W1}"
		nextSingleText $0,$8C   
		...
		nextSingleText $80,$8A  
						; "Ah, yes!{W1}"
		nextSingleText $0,$8C   
						; "Minister, I have a good{N}idea.{W1}"
		setEntityDir $8A,$1     
						; 0023 SET ENTITY FACING 8A 1
		nextSingleText $80,$8A  
						; "As do I.{W1}"
		...
		setEntityDir $8A,$2     
						; 0023 SET ENTITY FACING 8A 2
		nextText $80,$8A        
						; "You're the pupils of Astral.{N}I know of you, {LEADER}.{W2}"
		moveEntity $0,$FF,$0,$1 
		...
		csWait $14              
						; WAIT 14
		nextSingleText $80,$8A  
						; "I heard that you did a very{N}good job in the Ancient{N}Tower.{W1}"
		moveEntity $8C,$FF,$3,$1
						; 002D MOVE ENTITY 8C FF 3 1
		endMove $8080
		nextText $0,$8C         
						; "Why don't you go to Yeel{N}and bring Hawel back here?{W2}"
		nextText $0,$8C         
						; "I don't think this is a{N}difficult job.{N}Will you go?{W1}"
cs_53482:
		yesNo                   
						; 0011 STORY YESNO PROMPT
		jumpIfFlagSet $59,cs_534AC
						; YES/NO prompt answer
		hideText                
						; 0009 HIDE TEXTBOX AND PORTRAIT
		textCursor $2F5         
						; Initial text line $2F5 : "You refuse the King's{N}wish?!{N}Answer again!{W1}"
		setActscript $8A,$FF,eas_Jump
						; 0015 SET ACTSCRIPT 8A FF 45E44
		setActscript $8A,$FF,eas_Jump
						; 0015 SET ACTSCRIPT 8A FF 45E44
		nextText $80,$8A        
						; "You refuse the King's{N}wish?!{N}Answer again!{W1}"
		jump cs_53482           
						; 000B JUMP 53482
cs_534AC:
		moveEntity $8C,$FF,$3,$1
		...
		setEntityDir $8C,$2     
						; 0023 SET ENTITY FACING 8C 2
		textCursor $2F6         
						; Initial text line $2F6 : "Thank you.{N}Depart to fetch Hawel{N}immediately.{W1}"
		nextSingleText $0,$8C   
						; "Thank you.{N}Depart to fetch Hawel{N}immediately.{W1}"
		followEntity $1,$0,$2   
...
cs_534D2:
		textCursor $2B6         
						; Initial text line $2B6 : "Stop, please stop!{N}Don't make me use my{N}sword any more!{W1}"
		nextSingleText $0,$1C   
						; "Stop, please stop!{N}Don't make me use my{N}sword any more!{W1}"
		setCamDest $11,$6       
						; 0032 SET CAMERA DEST 11 6
		nextText $80,$80        
						; "Where is King Galam?{N}He went into the tower,{N}Ground Seal, right?{W2}"
		nextSingleText $80,$80  
						; "Then, I must go there!{W1}"
		moveEntity $80,$FF,$2,$1
						; 002D MOVE ENTITY 80 FF 2 1
		endMove $8080
		setEntityDest $80,$17,$C
						; 0029 SET ENTITY DEST 80 17 C
		setEntityDest $1C,$14,$A
						; 0029 SET ENTITY DEST 1C 14 A
		nextSingleText $0,$1C   
						; "Please don't move, or I'll{N}have to kill you!  Please!{W1}"
		moveEntity $80,$FF,$5,$1
						; 002D MOVE ENTITY 80 FF 5 1
		endMove $8080
		nextText $80,$80        
						; "{NAME;28}, calm down!{N}You already figured it out,{N}didn't you?{W2}"
		nextText $80,$80        
						; "We didn't attack Galam.{N}Your King lied!{N}We are allies.{W2}"
		nextSingleText $80,$80  
						; "Do you believe me?{N}We would never....{W1}"
		setEntityDir $1C,$0     
		...
		nextSingleText $0,$1C   
						; "Stop!  NO!{N}King Galam is my...{W1}"
		nextText $80,$80        
						; "You have to believe me.{W2}"
		nextSingleText $80,$80  
						; "Your King is possessed{N}by a devil.{N}He is not King Galam!{W1}"
		setEntityDir $1C,$0     
						; 0023 SET ENTITY FACING 1C 0
		nextSingleText $0,$1C   
						; "No!....{W1}"
		...
		nextSingleText $FF,$FF  
						; "Princess Elis screams{N}for help.{W1}"
		setEntityDir $1C,$1     
						; 0023 SET ENTITY FACING 1C 1
		nextSingleText $0,$98   
						; "No, no!{N}Father!  Astral!{N}Somebody please...!{W1}"
		...
		nextText $80,$80        
						; "He is taking her away!{W2}"
		nextSingleText $80,$80  
						; "We have no time.{W1}"
		setEntityDest $80,$15,$A
						; 0029 SET ENTITY DEST 80 15 A
		nextSingleText $0,$1C   
						; "Stop, sir!{N}I can't let you pass!{W1}"
		nextSingleText $80,$80  
						; "Then you come with me!{N}Yes, a good idea.{W1}"
		csWait $1E              
						; WAIT 1E
		setEntityDir $1C,$3     
...
cs_535FA:
		textCursor $2B2         
						; Initial text line $2B2 : "Oh, it's you, {LEADER}!{W2}"
		nextText $0,$81         
						; "Oh, it's you, {LEADER}!{W2}"
		nextSingleText $0,$81   
						; "King Galam took{N}Princess Elis to the{N}Ancient Tower!{W1}"
		nextSingleText $0,$82   
						; "Elis is in the tower.{N}I shall go with you and{N}save my daughter.{W1}"
		nextSingleText $FF,$FF  
						; "King Granseal and the{N}Minister go with {LEADER}.{W1}"
		followEntity $82,$0,$2  
...
cs_53620:
		textCursor $2C9         
						; Initial text line $2C9 : "Strange earthquake....{N}{LEADER}, you must{N}escape!{W1}"
		nextSingleText $0,$80   
						; "Strange earthquake....{N}{LEADER}, you must{N}escape!{W1}"
		csc_end                 
						; END OF CUTSCENE SCRIPT
cs_5362A:
		textCursor $2CA         
						; Initial text line $2CA : "OK, everybody is safe.{W1}"
		nextSingleText $0,$80   
						; "OK, everybody is safe.{W1}"
		csc_end                 
						; END OF CUTSCENE SCRIPT
