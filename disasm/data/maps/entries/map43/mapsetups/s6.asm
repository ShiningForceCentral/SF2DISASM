...
cs_540C0:       textCursor $32B         ; 0004 INIT TEXT CURSOR 32B : "This is Hawel's house.{W1}"
		...
		entityPosDir $0,$6,$B,$1; 0019 SET ENTITY POS AND FACING 0 6 B 1
		entityPosDir $4,$5,$B,$1; 0019 SET ENTITY POS AND FACING 4 5 B 1
		...
		moreMove $3,$5
		endMove $8080
		moveEntity $4,$FF,$C,$14; 002D MOVE ENTITY 4 FF C 14
		moreMove $8,$14
		moreMove $D,$0
		moreMove $3,$1
		moreMove $0,$3
		endMove $8080
		playSound SFX_BLO       ; 0005 PLAY SOUND SFX_BLO
		customActscript $4,$FF  ; 0014 SET MANUAL ACTSCRIPT 4
		dc.w $14                ;   0014 SET ANIM COUNTER $0
		dc.w 0
		dc.w $1B                ;   001B SET FLIPPING $1
		...
		entityShiver $80        ; 002A MAKE ENTITY SHIVER 80
		stopEntity $80          ; 001C STOP ENTITY ANIM 80
		entityPosDirFlash $80,$3F,$3F,$3; 0017 SET ENTITY POS AND FACING WITH FLASH 80 3F 3F 3
		moveEntity $4,$FF,$1,$1 ; 002D MOVE ENTITY 4 FF 1 1
		endMove $8080
