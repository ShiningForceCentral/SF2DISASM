...
cs_5F4AE:       setBlocks $D,$0,$3,$5,$5,$4; 0034 SET BLOCKS D00 305 504
		csc_end
cs_5F4B8:       setActscript $0,$FF,eas_Init; 0015 SET ACTSCRIPT 0 FF 460CE
		...
		csWait $28
		playSound SFX_BIG_DOOR_RUMBLE; 0005 PLAY SOUND SFX_BIG_DOOR_RUMBLE
		setBlocks $D,$6,$3,$5,$5,$4; 0034 SET BLOCKS D06 305 504
		...
		csWait $3C
		setBlocks $D,$0,$3,$5,$5,$4; 0034 SET BLOCKS D00 305 504
		playSound SFX_BLAST_SPELL; 0005 PLAY SOUND SFX_BLAST_SPELL
		flashScreenWhite $4     ; 0041 FLASH SCREEN WHITE 4
		playSound SFX_BIG_DOOR_RUMBLE; 0005 PLAY SOUND SFX_BIG_DOOR_RUMBLE
		setQuake $4003          ; 0033 SET QUAKE AMOUNT 4003
		csWait $28
		...
		csc_end
cs_5F594:       newEntity $1C,$6,$F,$1,$FF; 002B  1C 6 F 1 FF
		textCursor $DB9         ; 0004 INIT TEXT CURSOR DB9 : "Sir Astral!  {LEADER}!{W1}"
