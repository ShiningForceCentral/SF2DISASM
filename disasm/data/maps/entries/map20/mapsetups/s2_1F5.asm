...
sub_53856:
		...
		trap    #TEXTBOX
		dc.w $250               
						; "Let me pass!{N}I must see my father!{W1}"
		rts
...
sub_53864:
		...
		trap    #TEXTBOX
		dc.w $251               
						; "I saw a devil enter the{N}King's body...{W2}"
		trap    #SET_FLAG
		dc.w $103
loc_53872:
		...
		trap    #TEXTBOX
		dc.w $252               
						; "and the King became{N}violent!{W1}"
		rts
...
sub_53878:
		...
		trap    #TEXTBOX
		dc.w $253               
						; "Hurry to the Princess's{N}bedroom!  Hold the King{N}down!{W1}"
		trap    #SET_FLAG
		dc.w $104
loc_53886:
		...
		trap    #TEXTBOX
		dc.w $254               
						; "The King knocked down{N}the Princess....{W1}"
		rts
...
sub_5388C:
		...
		trap    #TEXTBOX
		dc.w $24C               
						; "Ooo, ouch!{N}I didn't think he could{N}be so strong!{W2}"
		trap    #SET_FLAG
		dc.w $105
loc_5389A:
...
sub_538A0:
		...
		trap    #TEXTBOX
		dc.w $24E               
						; "Princess Elis!{N}I can't let you up there.{W2}"
		trap    #SET_FLAG
		dc.w $106
loc_538AE:
		...
		trap    #TEXTBOX
		dc.w $24F               
						; "Trust Sir Astral!{N}He knows how to cure{N}the King!{W1}"
		rts
