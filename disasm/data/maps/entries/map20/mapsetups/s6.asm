...
cs_53996:       textCursor $880         ; Initial text line $880 : "Mmmm....{N}Hmmm...mmmm....{W1}"
...
cs_53B66:       playSound $FD           ; 0005 PLAY SOUND 
		textCursor $895         ; Initial text line $895 : "King Granseal!{N}Calm down!{W1}"
...
cs_53C42:       setCamDest $13,$30      ; 0032 SET CAMERA DEST 13 30
		textCursor $898         ; Initial text line $898 : "Yeow!  My head!{N}No, I'm OK, {LEADER}.{W2}"
		setActscript $82,$FF,eas_Init; 0015 SET ACTSCRIPT 82 FF 460CE
		setEntityDir $82,$3     ; 0023 SET ENTITY FACING 82 3
		csWait $A               ; WAIT A
		...
		mapSysEvent $131D0801   ; 0007 EXECUTE MAP SYSTEM EVENT 131D0801
