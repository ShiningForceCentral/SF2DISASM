...
sub_538D4:
		...
		trap    #TEXTBOX
		dc.w $256               
						; "Sir Astral is sleeping{N}in the King's bedroom.{N}Don't worry!{W1}"
		rts
...
sub_538DA:
		...
		trap    #TEXTBOX
		dc.w $259               
						; "Thank you, {LEADER}.{N}You've saved the King's{N}life.{W2}{N}I heard that you are going{N}to Yeel.{W2}{N}I'll take care of Sir Astral{N}for you.{W2}"
		trap    #SET_FLAG
		dc.w $101
loc_538E8:
...
sub_538EE:
		...
		trap    #TEXTBOX
		dc.w $25B               
						; "Are you going to see{N}Mr. Hawel?{W2}"
		trap    #SET_FLAG
		dc.w $102
loc_538FC:
		...
		trap    #TEXTBOX
		dc.w $25C               
						; "I wouldn't let you go alone{N}if I weren't...{W2}{N}I trust you, son.{W1}"
		rts
...
sub_53902:
		...
		trap    #TEXTBOX
		dc.w $25D               
						; "Princess Elis has not rested{N}since the King collapsed.{W2}"
		trap    #SET_FLAG
		dc.w $104
loc_53910:
		...
		trap    #TEXTBOX
		dc.w $25E               
						; "I understand her reasoning,{N}but she might get sick, too.{W1}"
		rts
...
sub_5391C:
		...
		trap    #TEXTBOX
		dc.w $25F               
						; "She has been shrivering like{N}this since she came back{N}from the King's room.{W2}{N}She won't work.{W1}"
		rts
...
sub_53922:
		...
		trap    #TEXTBOX
		dc.w $260               
						; "I...I've never seen such a{N}horrible face....{W2}{N}I can't tell anybody.{N}They wouldn't believe me.{W1}"
		rts
