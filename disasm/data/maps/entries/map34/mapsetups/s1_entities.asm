...
; ASM FILE data\maps\entries\map34\mapsetups\s1_entities.asm :
; 0x5B5E6..0x5B68E : 
ms_map34_Entities:
                msFixedEntity 7, 10, UP, MAPSPRITE_CREED, eas_Init
                msFixedEntity 6, 10, UP, MAPSPRITE_FAIRY, eas_Init
