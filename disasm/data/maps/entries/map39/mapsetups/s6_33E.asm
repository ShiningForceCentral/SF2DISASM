...
cs_5E0EE:       csc2B $1A,$4,$C,$1,$FF  ; 002B  1A 4 C 1 FF
		csc_end                 ; END OF CUTSCENE SCRIPT
cs_5E0F8:       textCursor $805         ; Initial text line $805 : "Well, you're not from{N}Pacalon, are you?{W1}"
		...
		setEntityDir $18,$2     ; 0023 SET ENTITY FACING 18 2
		...
		setEntityDir $18,$1     ; 0023 SET ENTITY FACING 18 1
		...
		csc_end                 ; END OF CUTSCENE SCRIPT
cs_5E20A:       textCursor $819         ; Initial text line $819 : "I happened to overhear your{N}conversation with {NAME;24}.{W2}"
