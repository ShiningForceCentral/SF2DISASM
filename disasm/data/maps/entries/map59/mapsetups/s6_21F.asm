...
cs_615E6:       textCursor $EB0         ; Initial text line $EB0 : "Where am I?{N}What's going on?{W2}"
		...
		setEntityDir $86,$2     ; 0023 SET ENTITY FACING 86 2
		...
		csWait $14              ; WAIT 14
		setEntityDir $86,$0     ; 0023 SET ENTITY FACING 86 0
		...
		playSound SFX_BLAST_SPELL; 0005 PLAY SOUND SFX_BLAST_SPELL
		flashScreenWhite $14    ; 0041 FLASH SCREEN WHITE 14
		setBlocks $1427,$704,$A03; 0034 SET BLOCKS 1427 704 A03
		playSound SFX_BLAST_SPELL; 0005 PLAY SOUND SFX_BLAST_SPELL
		flashScreenWhite $14    ; 0041 FLASH SCREEN WHITE 14
		playSound SFX_BLAST_SPELL; 0005 PLAY SOUND SFX_BLAST_SPELL
		flashScreenWhite $14    ; 0041 FLASH SCREEN WHITE 14
		...
		endMove $8080
		csWait $14              ; WAIT 14
		csc53 $7,$FFFF          ; 0053 UNKNOWN
		csc53 $84,$0            ; 0053 UNKNOWN
		...
		setQuakeAmount $8003    ; 0033 SET QUAKE AMOUNT 8003
		...
		endMove $8080
		csWait $3C              ; WAIT 3C
cs_62658:       setQuakeAmount $5       ; 0033 SET QUAKE AMOUNT 5
		csWait $32              ; WAIT 32
		playSound $FD           ; 0005 PLAY SOUND 
		...
		textCursor $F44         ; Initial text line $F44 : "Two years have passed{N}since Mitula resealed Zeon.{W1}"
		...
		mapSysEvent $3380303    ; 0007 EXECUTE MAP SYSTEM EVENT 3380303
