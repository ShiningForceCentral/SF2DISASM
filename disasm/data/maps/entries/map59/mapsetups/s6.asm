...
cs_5EB44:
		dc.w 4                  
						; 0004 INIT TEXT CURSOR E73 : "{LEADER} is almost here{N}already?{W1}"
		dc.w $E73
		dc.w $24                
		...
		dc.w 2
		dc.w $42                
						; 0042 RELATED TO LOADING MAP ENTITIES 5F19E
		dc.l word_5F19E
		dc.w $15                
		...
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 80 : "{LEADER} is almost here{N}already?{W1}"
		dc.w $80
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 8081 : "Yes, sir.  With an ancient{N}aircraft.  He'll be passing{N}over the cape soon.{W1}"
		dc.w $8081
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 80 : "Good.  I'll do anything to{N}get my powers back.{W1}"
		dc.w $80
		dc.w 2                  
						; 0002 DISPLAY TEXT BOX 8081 : "They're stronger than we{N}thought.{W2}"
		dc.w $8081
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 8081 : "But, I have an idea.  Please{N}let me try it.{W1}"
		dc.w $8081
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 80 : "Well?{W1}"
		dc.w $80
		dc.w 2                  
						; 0002 DISPLAY TEXT BOX 8081 : "I think it's better for us{N}to shoot them down over the{N}"
		dc.w $8081
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 8081 : "cape.{W1}"
		dc.w $8081
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 80 : "I agree.{W1}"
		dc.w $80
		dc.w 2                  
						; 0002 DISPLAY TEXT BOX 8081 : "Thank you.  Then... may I{W2}"
		dc.w $8081
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 8081 : "borrow Odd Eye?{W1}"
		dc.w $8081
		dc.w 2                  
						; 0002 DISPLAY TEXT BOX 80 : "He's still damaged from his{N}battle against Volcanon.{W2}"
		dc.w $80
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 80 : "Take Red Baron instead.{W1}"
		dc.w $80
		dc.w $2A                
		...
		dc.w $81
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 8081 : "Thank you, sir.{W1}"
		dc.w $8081
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 80 : "They'll be passing over the{N}cape soon.  Go!{W1}"
		dc.w $80
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 8081 : "Yes, sir!{W1}"
		dc.w $8081
		dc.w $22                
		...
		dc.w 6
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 82 : "That Geshp!  He wants{N}everything.{W1}"
		dc.w $82
		dc.w $19                
		...
		dc.w $8080
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 80 : "You noticed that too?{W1}"
		dc.w $80
		dc.w $26                
						; 0026 MAKE ENTITY NOD 82
		dc.w $82
		dc.w 2                  
						; 0002 DISPLAY TEXT BOX 82 : "Yes, King Zeon.{W2}"
		dc.w $82
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 82 : "I'm afraid Geshp can't stop{N}{LEADER}'s advance.{W1}"
		dc.w $82
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 80 : "You really think so?{W1}"
		dc.w $80
		dc.w 2                  
						; 0002 DISPLAY TEXT BOX 82 : "I was just thinking of{N}{LEADER}'s hidden powers.{W2}"
		dc.w $82
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 82 : "We must never underestimate{N}him.{W1}"
		dc.w $82
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 80 : "Anyway, it will be a{N}fantastic show!  Ha, ha!{W1}"
		dc.w $80
		dc.w $FFFF              
						; END OF CUTSCENE SCRIPT
cs_5EBFC:
		...
		dc.w $E
		dc.w 4                  
						; 0004 INIT TEXT CURSOR E8B : "Finish the preparations{N}before the Nazca Ship flies{N}over the cape!{W1}"
		dc.w $E8B
		dc.w $42                
						; 0042 RELATED TO LOADING MAP ENTITIES 5F1DE
		dc.l word_5F1DE
		dc.w $15                
						; 0015 SET ACTSCRIPT 0 FF 460CE
		dc.b 0
		...
		dc.w $80
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 80 : "Finish the preparations{N}before the Nazca Ship flies{N}over the cape!{W1}"
		dc.w $80
		dc.w $32                
		...
		dc.w 7
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 8081 : "How are the Prism Flowers?{W1}"
		dc.w $8081
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 80 : "They're ready!{W1}"
		dc.w $80
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 8081 : "Excellent!{W1}"
		dc.w $8081
		dc.w $26                
		...
		dc.b 0
		dc.w 2                  
						; 0002 DISPLAY TEXT BOX 8081 : "Now, c'mon Granseal losers!{W2}"
		dc.w $8081
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 8081 : "The Prism Flowers are waiting{N}for you!  Hee, heee!{W1}"
		dc.w $8081
		dc.w $26                
						; 0026 MAKE ENTITY NOD 81
		dc.w $81
...
cs_5ED06:
		dc.w 4                  
						; 0004 INIT TEXT CURSOR E91 : "There's Grans Island!{W1}"
		dc.w $E91
		dc.w $37                
		...
		dc.w 0
		dc.w $42                
						; 0042 RELATED TO LOADING MAP ENTITIES 5F1BE
		dc.l word_5F1BE
		dc.w $15                
						; 0015 SET ACTSCRIPT 0 FF 460CE
		dc.b 0
		...
		dc.l sub_5FD92
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 801A : "There's Grans Island!{W1}"
		dc.w $801A
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 8007 : "Alright!{W1}"
		dc.w $8007
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 1F : "We've finally come home.{W1}"
		dc.w $1F
		dc.w $37                
		...
		dc.w $D
		dc.w $42                
						; 0042 RELATED TO LOADING MAP ENTITIES 5F23E
		dc.l word_5F23E
		dc.w $15                
						; 0015 SET ACTSCRIPT 0 FF 460CE
		dc.b 0
		...
		dc.w $39                
						; 0039 FADE IN FROM BLACK
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 8081 : "I see the Nazca Ship!{N}Everybody, get ready!{W1}"
		dc.w $8081
		dc.w $37                
						; 0037 LOAD MAP AND FADE IN 49 0 0
		dc.w $49
		...
		dc.l sub_5FD92
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 1F : "What's that?  I saw a flash{N}of light over there.{W1}"
		dc.w $1F
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 8007 : "I didn't see it.  You must be{N}seeing things because you're{N}so old!  Ha, ha!{W1}"
		dc.w $8007
		dc.w 2                  
						; 0002 DISPLAY TEXT BOX 1F : "(Grumble)....{W2}"
		dc.w $1F
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 1F : "Someday, {NAME;7}....{W1}"
		dc.w $1F
		dc.w $FFFF              
						; END OF CUTSCENE SCRIPT
cs_5EDB8:
		dc.w 4                  
						; 0004 INIT TEXT CURSOR E99 : "NOW!{W1}"
		dc.w $E99
		dc.w $37                
						; 0037 LOAD MAP AND FADE IN 35 A D
		dc.w $35
		...
		dc.w $D
		dc.w $42                
						; 0042 RELATED TO LOADING MAP ENTITIES 5F28E
		dc.l word_5F28E
		dc.w $15                
						; 0015 SET ACTSCRIPT 0 FF 460CE
		dc.b 0
		...
		dc.b 2
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 8081 : "NOW!{W1}"
		dc.w $8081
		dc.w $2D                
		...
		dc.w $8080
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 8081 : "Shoot them!  Shoot them!{W1}"
		dc.w $8081
		dc.w 5                  
...
cs_5EF60:
		dc.w 4                  
						; 0004 INIT TEXT CURSOR E9B : "I did see something!{W1}"
		dc.w $E9B
		dc.w $37                
		...
		dc.w $80
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 80 : "I did see something!{W1}"
		dc.w $80
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 8007 : "Well, I didn't.{W1}"
		dc.w $8007
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 80 : "This could be bad.{W1}"
		dc.w $80
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 801A : "Sir Astral!  {LEADER}!{N}Something is coming straight{N}towards us!{W1}"
		dc.w $801A
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 80 : "What is it?{W1}"
		dc.w $80
		dc.w 5                  
						; 0005 PLAY SOUND SFX_BATTLEFIELD_DEATH
		dc.w $74
		...
		dc.b 2
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 8007 : "Oooouu!!  What was that?!{N}Lightning?{W1}"
		dc.w $8007
		dc.w $23                
		...
		dc.b 3
		dc.w 2                  
						; 0002 DISPLAY TEXT BOX 801A : "An attack from the ground.{W2}"
		dc.w $801A
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 801A : "I can't control the ship!{W1}"
		dc.w $801A
		dc.w 5                  
						; 0005 PLAY SOUND SFX_BATTLEFIELD_DEATH
		dc.w $74
		...
		dc.b $A
		dc.w 2                  
						; 0002 DISPLAY TEXT BOX 801A : "We've sustained damage to{N}the engine!{W2}"
		dc.w $801A
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 801A : "We might crash!{W1}"
		dc.w $801A
		dc.w $2D                
		...
		dc.w $80
		dc.w 2                  
						; 0002 DISPLAY TEXT BOX 80 : "Crash?!{W2}"
		dc.w $80
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 801A : "Geshp's trap!  Darn!{W1}"
		dc.w $801A
		dc.w 5                  
						; 0005 PLAY SOUND SFX_BATTLEFIELD_DEATH
		dc.w $74
		...
		dc.l eas_Jump           
		dc.w 2                  
						; 0002 DISPLAY TEXT BOX 8007 : "I don't want to crash!{W2}"
		dc.w $8007
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 8007 : "Sir Astral, please help us!{W1}"
		dc.w $8007
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 80 : "{NAME;26}, can you land on{N}that cape before the ship{N}crashes?{W1}"
		dc.w $80
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 801A : "I'm not sure,{W2}"
		dc.w $801A
		dc.w 5                  
						; 0005 PLAY SOUND SFX_BATTLEFIELD_DEATH
		dc.w $74
		...
		dc.b $A
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 801A : "but I'll try.{W1}"
		dc.w $801A
		dc.w 5                  
						; 0005 PLAY SOUND SFX_BATTLEFIELD_DEATH
		dc.w $74
		...
		dc.w $E
		dc.w $42                
						; 0042 RELATED TO LOADING MAP ENTITIES 5F1CE
		dc.l word_5F1CE
		dc.w $15                
						; 0015 SET ACTSCRIPT 0 FF 460CE
		dc.b 0
		...
		dc.w $8080              
						; 0014 END OF MANUAL ACTSCRIPT
		dc.w $45                
						; 0045 RELATED TO CAMERA ADJUST TO PLAYER 10
		dc.w $10
		dc.w $2D                
