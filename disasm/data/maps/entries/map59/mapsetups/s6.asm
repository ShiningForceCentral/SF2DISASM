...
cs_5EB44:       textCursor $E73         ; 0004 INIT TEXT CURSOR E73 : "{LEADER} is almost here{N}already?{W1}"
		...
		animEntityFadeInOut $81,$6; 0022 ANIMATE ENTITY FADE INOUT 81
		nextSingleText $0,$82   ; "That Geshp!  He wants{N}everything.{W1}"
		entityPosDir $82,$9,$9,$3; 0019 SET ENTITY POS AND FACING 82 9 9 3
		animEntityFadeInOut $82,$7; 0022 ANIMATE ENTITY FADE INOUT 82
		moveEntity $82,$FF,$0,$4; 002D MOVE ENTITY 82 FF 0 4
		moreMove $1,$1
		endMove $8080
...
cs_5EBFC:       loadMapFadeIn $35,$8,$E ; 0037 LOAD MAP AND FADE IN 35 8 E
		...
		setActscript $87,$FF,eas_Init; 0015 SET ACTSCRIPT 87 FF 460CE
		setActscript $88,$FF,eas_Init; 0015 SET ACTSCRIPT 88 FF 460CE
		...
		endMove $8080
		moveEntity $86,$0,$0,$3 ; 002D MOVE ENTITY 86 0 0 3
		endMove $8080
		moveEntity $87,$0,$0,$3 ; 002D MOVE ENTITY 87 0 0 3
		endMove $8080
		...
		entityPosDir $81,$F,$10,$3; 0019 SET ENTITY POS AND FACING 81 F 10 3
		animEntityFadeInOut $81,$7; 0022 ANIMATE ENTITY FADE INOUT 81
...
cs_5EDB8:       textCursor $E99         ; 0004 INIT TEXT CURSOR E99 : "NOW!{W1}"
		...
		setActscript $86,$0,eas_5EF46; 0015 SET ACTSCRIPT 86 0 5EF46
		setActscript $87,$0,eas_5EF46; 0015 SET ACTSCRIPT 87 0 5EF46
		setActscript $88,$0,eas_5EF46; 0015 SET ACTSCRIPT 88 0 5EF46
		setActscript $89,$0,eas_5EF46; 0015 SET ACTSCRIPT 89 0 5EF46
		setActscript $8A,$0,eas_5EF46; 0015 SET ACTSCRIPT 8A 0 5EF46
		setActscript $8B,$0,eas_5EF46; 0015 SET ACTSCRIPT 8B 0 5EF46
		setActscript $8C,$0,eas_5EF46; 0015 SET ACTSCRIPT 8C 0 5EF46
		stopEntity $8D          ; 001C STOP ENTITY ANIM 8D
		...
		moveEntity $85,$0,$4,$A ; 002D MOVE ENTITY 85 0 4 A
		endMove $8080
		flashScreenWhite $2     ; 0041 FLASH SCREEN WHITE 2
		...
		moveEntity $87,$0,$4,$A ; 002D MOVE ENTITY 87 0 4 A
		endMove $8080
		flashScreenWhite $2     ; 0041 FLASH SCREEN WHITE 2
		entityPosDir $88,$E,$10,$1; 0019 SET ENTITY POS AND FACING 88 E 10 1
		moveEntity $88,$0,$4,$A ; 002D MOVE ENTITY 88 0 4 A
		endMove $8080
		playSound SFX_BATTLEFIELD_DEATH; 0005 PLAY SOUND SFX_BATTLEFIELD_DEATH
		...
		moveEntity $89,$0,$4,$A ; 002D MOVE ENTITY 89 0 4 A
		endMove $8080
		flashScreenWhite $2     ; 0041 FLASH SCREEN WHITE 2
		...
		moveEntity $8B,$0,$4,$A ; 002D MOVE ENTITY 8B 0 4 A
		endMove $8080
		flashScreenWhite $2     ; 0041 FLASH SCREEN WHITE 2
		entityPosDir $8C,$10,$13,$1; 0019 SET ENTITY POS AND FACING 8C 10 13 1
		moveEntity $8C,$0,$4,$A ; 002D MOVE ENTITY 8C 0 4 A
		endMove $8080
		playSound SFX_BATTLEFIELD_DEATH; 0005 PLAY SOUND SFX_BATTLEFIELD_DEATH
