...
cs_606EA:       entityPosDir $0,$B,$A,$1; 0019 SET ENTITY POS AND FACING 0 B A 1
		...
		csWait $1
		reloadMap $5,$4         ; 0046  5 4
		csWait $A
		csc_end
cs_60708:       textCursor $DB9         ; 0004 INIT TEXT CURSOR DB9 : "Sir Astral!  {LEADER}!{W1}"
		...
		csc_end
cs_607DE:       textCursor $D3C         ; 0004 INIT TEXT CURSOR D3C : "I'm guilty!{W1}"
		...
		csc_end
cs_6093A:       textCursor $D44         ; 0004 INIT TEXT CURSOR D44 : "Ah, devils finally found the{N}hidden door.{W1}"
		setPriority $1B,$0      ; 0053  1B 0
		...
		moreMove $A,$1
		endMove $8080
		setFacing $1B,$0        ; 0023 SET ENTITY FACING 1B 0
		...
		csc_end
cs_60B10:       textCursor $D62         ; 0004 INIT TEXT CURSOR D62 : "I came back to Yeel to{N}continue my father's work.{W1}"
		...
		moreMove $9,$1
		endMove $8080
		setFacing $1B,$3        ; 0023 SET ENTITY FACING 1B 3
		...
		followEntity $1F,$7,$2  ; 002C FOLLOW ENTITY 1F 7 2
		csc_end
cs_60BA6:       textCursor $D6A         ; 0004 INIT TEXT CURSOR D6A : "I heard you're going to{N}defeat the devils....{W1}"
		...
		followEntity $1C,$1F,$2 ; 002C FOLLOW ENTITY 1C 1F 2
		csc_end
cs_60C42:       textCursor $D72         ; 0004 INIT TEXT CURSOR D72 : "...and now we're here.{W1}"
		setActscript $1C,$FF,eas_Init; 0015 SET ACTSCRIPT 1C FF 460CE
		...
		csc_end
cs_60CA4:       textCursor $D76         ; 0004 INIT TEXT CURSOR D76 : "That's right.  We have to{N}find out where the Holy{N}Sword is.{W1}"
		entityNod $1F           ; 0026 MAKE ENTITY NOD 1F
		...
		endMove $8080
		csc_end
cs_60EB2:       textCursor $D8C         ; 0004 INIT TEXT CURSOR D8C : "Yes, that's the truth.{W1}"
		entityNod $1F           ; 0026 MAKE ENTITY NOD 1F
		...
		endMove $8080
		csc_end
cs_60F18:       textCursor $D8F         ; 0004 INIT TEXT CURSOR D8F : "{LEADER}, would you mind{N}if I went with you?{W1}"
		nextSingleText $0,$1B   ; "{LEADER}, would you mind{N}if I went with you?{W1}"
		faceEntity $1F,$1B      ; 0052 RELATED TO TWO ENTITIES 1F 1B
		...
		faceEntity $7,$1B       ; 0052 RELATED TO TWO ENTITIES 7 1B
		...
		csc_end
cs_60F64:       textCursor $D98         ; 0004 INIT TEXT CURSOR D98 : "It's a fine-looking piano.{N}Will you play it?{W1}"
		...
		textCursor $D99         ; 0004 INIT TEXT CURSOR D99 : "Something opened somewhere.{W1}"
		...
		setBlocks $20,$2D,$1,$1,$B,$4; 0034 SET BLOCKS 202D 101 B04
		setF $3AC               ; set after playing the piano in Yeel (during the late game)
		csc_end
cs_60FA4:       textCursor $D9A         ; 0004 INIT TEXT CURSOR D9A : "{LEADER}, can't you play?{W1}"
