...
ms_map4_InitFunction:
		...
		trap    #CHECK_FLAG
		dc.w $270               
						; set after the soldiers are swallowed up by the earthquake
		bne.s   loc_5173A
		lea     cs_51750(pc), a0
		trap    #6
		trap    #SET_FLAG
...
eas_51840:
		...
		dc.w 0
		dc.w 4                  
						; 0004 MOVE TO RELATIVE DEST X=X+$0 Y=Y+$2
		dc.w 0
		dc.w 2
		dc.w $1F                
