...
cs_600CE:
		textCursor $823         
						; Initial text line $823 : "Who's there!{W1}"
		...
		endMove $8080
		nextSingleText $80,$1F  
						; "She's too beautiful for you!{N}Back, back!{W1}"
		...
		nextSingleText $0,$19   
						; "Oh...you don't remember me?{W1}"
		setEntityDir $1F,$3     
						; 0023 SET ENTITY FACING 1F 3
		nextSingleText $80,$1F  
						; "Well...ah...sorry.{W1}"
		nextSingleText $0,$19   
						; "I'm {NAME;25}.  I was a pupil{N}of yours in Galam.  I was{N}preparing to become a priest.{W1}"
		entityShiver $1F        
						; 002A MAKE ENTITY SHIVER 1F
		setEntityDir $1F,$1     
						; 0023 SET ENTITY FACING 1F 1
		nextSingleText $80,$1F  
						; "{NAME;25}!  I can't believe it!{W1}"
		nextText $0,$19         
						; "How is that scar on your{N}chest.{W2}"
		nextSingleText $0,$19   
						; "Remember?  You snuck up{N}behind me and tapped my{N}shoulder....{W1}"
		moveEntity $1F,$FF,$1,$1
						; 002D MOVE ENTITY 1F FF 1 1
		endMove $8080
		nextText $80,$1F        
						; "And you kicked me in the{N}chest...and it left a scar.{N}How could I forget.{W2}"
		nextSingleText $80,$1F  
						; "Nobody but {NAME;25}{N}knew about that scar....{N}It still aches sometimes.{W1}"
		setActscript $1F,$FF,eas_Jump
						; 0015 SET ACTSCRIPT 1F FF 45E44
		setActscript $1F,$FF,eas_Jump
						; 0015 SET ACTSCRIPT 1F FF 45E44
		nextSingleText $0,$19   
						; "I am sorry I kicked you.{W1}"
		entityShiver $1F        
						; 002A MAKE ENTITY SHIVER 1F
		nextSingleText $80,$1F  
						; "That OK. How have...{W1}"
		...
		nextSingleText $0,$7    
						; "Hey, aren't you going to{N}introduce us?{W1}"
		moveEntity $1F,$FF,$3,$1
						; 002D MOVE ENTITY 1F FF 3 1
		endMove $8080
		nextSingleText $80,$1F  
		...
		nextText $80,$1F        
						; "All in good time.{W2}"
		nextSingleText $80,$1F  
						; "By the way, what are you{N}doing here?{W1}"
		entityShiver $19        
						; 002A MAKE ENTITY SHIVER 19
		nextSingleText $0,$19   
						; "I came to kill Red Baron.{N}He killed my fiance.{W1}"
		nextSingleText $80,$1F  
						; "Oh....{N}I'm sorry...{W1}"
		nextSingleText $0,$19   
						; "And why did you come back{N}to Grans?{W1}"
		nextSingleText $80,$1F  
						; "To reseal Zeon.{W1}"
		nextSingleText $0,$19   
						; "The King of the Devils?{W1}"
		entityNod $1F           
						; 0026 MAKE ENTITY NOD 1F
		nextText $80,$1F        
						; "Listen, {NAME;25}.{N}All the killings lately were{N}caused by him.{W2}"
		nextSingleText $80,$1F  
						; "He'll destroy the entire{N}world.  He must be stopped!{W1}"
		entityShiver $19        
						; 002A MAKE ENTITY SHIVER 19
		nextSingleText $0,$19   
						; "Is Red Baron his follower?{W1}"
		nextSingleText $80,$1F  
						; "Could be.{W1}"
		nextSingleText $0,$19   
						; "Hmmm....{W1}"
		...
		setCamDest $1,$5        
						; 0032 SET CAMERA DEST 1 5
		nextSingleText $0,$19   
						; "Sir Astral, please let me go{N}with you.{W1}"
		nextSingleText $80,$1F  
						; "We welcome you, but can you{N}fight?{W1}"
		nextSingleText $0,$19   
						; "I've made my body into a{N}weapon.{W1}"
		nextSingleText $80,$1F  
						; "Where did you learn to do{N}this?  You're a priest.{W1}"
		nextSingleText $0,$19   
						; "I was.  But now I'm a{N}master monk.{W1}"
		setActscript $1F,$FF,eas_Jump
						; 0015 SET ACTSCRIPT 1F FF 45E44
		setActscript $1F,$FF,eas_Jump
						; 0015 SET ACTSCRIPT 1F FF 45E44
		nextSingleText $80,$1F  
						; "We could always use another{N}well-trained fighter!{W1}"
		join $19                
						; 0008 JOIN FORCE 19
		nextSingleText $0,$7    
						; "We've got a strong ally!{W1}"
		setEntityDir $19,$2     
						; 0023 SET ENTITY FACING 19 2
		nextSingleText $0,$19   
						; "Many Galam soldiers are in{N}the west.{N}We must be careful.{W1}"
		followEntity $7,$0,$2   
