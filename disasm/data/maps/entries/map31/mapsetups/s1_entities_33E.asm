...
ms_map31_flag33E_Entities:
                msWalkingEntity 9, 11, DOWN, MAPSPRITE_MAN2, 9, 11, 2
                ...
                msFixedEntity 7, 27, DOWN, MAPSPRITE_WOMAN2, eas_Init
                msFixedEntity 12, 5, DOWN, MAPSPRITE_WOMAN2, eas_Init
                msFixedEntity 20, 6, DOWN, MAPSPRITE_PRIEST, eas_Init
                msFixedEntity 29, 6, UP, MAPSPRITE_WOMAN2, eas_Init
