...
cs_5247C:       setBlocks $3007,$101,$3008; 0034 SET BLOCKS 3007 101 3008
		setBlocks $3E14,$102,$3014; 0034 SET BLOCKS 3E14 102 3014
		setBlocks $3907,$101,$3908; 0034 SET BLOCKS 3907 101 3908
		setBlocks $3E14,$102,$3914; 0034 SET BLOCKS 3E14 102 3914
		csc_end                 ; END OF CUTSCENE SCRIPT
cs_5249E:       playSound $FD           ; 0005 PLAY SOUND 
		resetForceBattleStats   ; 0055 RESET FORCE BATTLE STATS
		csc36                   ; 0036 UNKNOWN, RELATED TO LOADING A MAP
		csc49 $0,$0,$0          ; 0049 UNKNOWN
		csWait $3C              ; WAIT 3C
		fadeInB                 ; 0039 FADE IN FROM BLACK
		textCursor $370         ; Initial text line $370 : "Impossible!{N}Galam and Granseal are{N}allies!{W1}"
		csc46 $34,$1            ; 0046 UNKNOWN
		entityPosDir $0,$3B,$4,$1; 0019 SET ENTITY POS AND FACING 0 3B 4 1
		...
		loadMapFadeIn $11,$34,$1; 0037 LOAD MAP AND FADE IN 11 34 1
		csWait $1               ; WAIT 1
		playSound MUSIC_CASTLE  ; 0005 PLAY SOUND MUSIC_CASTLE
		fadeInB                 ; 0039 FADE IN FROM BLACK
		csWait $1E              ; WAIT 1E
		setEntityDest $0,$3B,$5 ; 0029 SET ENTITY DEST 0 3B 5
		...
		csWait $28              ; WAIT 28
		setEntityDir $2,$0      ; 0023 SET ENTITY FACING 2 0
		textCursor $37C         ; Initial text line $37C : "{LEADER}!{N}You finally woke up!{W2}"
		nextText $0,$2          ; "{LEADER}!{N}You finally woke up!{W2}"
		nextSingleText $0,$2    ; "We're talking about{N}Ground Seal.{N}Please, join in.{W1}"
		setEntityDir $2,$2      ; 0023 SET ENTITY FACING 2 2
		csc_end                 ; END OF CUTSCENE SCRIPT
cs_52530:       textCursor $385         ; Initial text line $385 : "What's wrong with the seal?{W1}"
		setCamDest $30,$0       ; 0032 SET CAMERA DEST 30 0
		setEntityDir $0,$3      ; 0023 SET ENTITY FACING 0 3
		nextSingleText $C0,$84  ; "What's wrong with the seal?{W1}"
		moveEntity $2,$FF,$2,$1 ; 002D MOVE ENTITY 2 FF 2 1
		endMove $8080
		...
		setCamDest $2B,$0       ; 0032 SET CAMERA DEST 2B 0
		startEntity $5          ; 001B START ENTITY ANIM 5
		...
		setEntityDir $0,$2      ; 0023 SET ENTITY FACING 0 2
		setEntityDir $2,$2      ; 0023 SET ENTITY FACING 2 2
		setEntityDir $3,$2      ; 0023 SET ENTITY FACING 3 2
		setEntityDir $1,$2      ; 0023 SET ENTITY FACING 1 2
		setEntityDir $4,$2      ; 0023 SET ENTITY FACING 4 2
		setEntityDir $84,$2     ; 0023 SET ENTITY FACING 84 2
		setEntityDir $85,$2     ; 0023 SET ENTITY FACING 85 2
		moveEntity $5,$FF,$0,$1 ; 002D MOVE ENTITY 5 FF 0 1
		endMove $8080
		csWait $5               ; WAIT 5
		setActscript $5,$0,eas_461B6; 0015 SET ACTSCRIPT 5 0 461B6
		csWait $1E              ; WAIT 1E
		...
		entityShakeHead $5      ; 0027 MAKE ENTITY SHAKE HEAD 5
		csWait $1E              ; WAIT 1E
		...
		entityShiver $5         ; 002A MAKE ENTITY SHIVER 5
		nextSingleText $0,$5    ; "They...they killed my{N}friends!{W1}"
		customActscript $5,$FF  ; 0014 SET MANUAL ACTSCRIPT 5
		...
		moveEntity $5,$FF,$3,$1 ; 002D MOVE ENTITY 5 FF 3 1
		moreMove $C,$28
		moreMove $2,$1
		moreMove $C,$28
		moreMove $3,$1
		...
		dc.l eas_Idle           
		dc.w $8080              ; 0014 END OF CUSTOM ACTSCRIPT
		stopEntity $5           ; 001C STOP ENTITY ANIM 5
		setEntityDir $85,$2     ; 0023 SET ENTITY FACING 85 2
		csWait $32              ; WAIT 32
		...
		endMove $8080
		setCamDest $2F,$0       ; 0032 SET CAMERA DEST 2F 0
		setEntityDir $1,$0      ; 0023 SET ENTITY FACING 1 0
		...
		dc.l eas_Idle           
		dc.w $8080              ; 0014 END OF CUSTOM ACTSCRIPT
		entitySprite $5,$3B     ; 001A SET ENTITY SPRITE 5 3B
		csWait $14              ; WAIT 14
		...
		startEntity $5          ; 001B START ENTITY ANIM 5
		entitySprite $5,$5      ; 001A SET ENTITY SPRITE 5 5
		setActscript $5,$FF,eas_Jump; 0015 SET ACTSCRIPT 5 FF 45E44
		moveEntity $5,$FF,$0,$1 ; 002D MOVE ENTITY 5 FF 0 1
		endMove $8080
		nextSingleText $0,$5    ; "I'll open the door for you!{W1}"
		setCameraEntity $5      ; 0024 SET ENTITY FOLLOWED BY CAMERA 5
		moveEntity $85,$FF,$2,$1; 002D MOVE ENTITY 85 FF 2 1
		endMove $8080
		...
		moveEntity $5,$FF,$2,$1 ; 002D MOVE ENTITY 5 FF 2 1
		moreMove $3,$1
		endMove $8080
		setEntityDir $5,$3      ; 0023 SET ENTITY FACING 5 3
		...
		setBlocks $3007,$101,$3008; 0034 SET BLOCKS 3007 101 3008
		setBlocks $3E14,$102,$3014; 0034 SET BLOCKS 3E14 102 3014
		textCursor $3A3         ; Initial text line $3A3 : "{NAME;5} sticks a short wire{N}into the keyhole.{W1}"
		moveEntity $5,$FF,$3,$2 ; 002D MOVE ENTITY 5 FF 3 2
		moreMove $0,$9
		endMove $8080
		setEntityDir $5,$1      ; 0023 SET ENTITY FACING 5 1
		nextSingleText $FF,$FF  ; "{NAME;5} sticks a short wire{N}into the keyhole.{W1}"
		...
		setBlocks $3907,$101,$3908; 0034 SET BLOCKS 3907 101 3908
		setBlocks $3E14,$102,$3914; 0034 SET BLOCKS 3E14 102 3914
		moveEntity $5,$FF,$1,$2 ; 002D MOVE ENTITY 5 FF 1 2
		endMove $8080
		...
		setActscript $3,$0,eas_Jump; 0015 SET ACTSCRIPT 3 0 45E44
		setActscript $4,$FF,eas_Jump; 0015 SET ACTSCRIPT 4 FF 45E44
		setActscript $0,$0,eas_Jump; 0015 SET ACTSCRIPT 0 0 45E44
		setActscript $3,$0,eas_Jump; 0015 SET ACTSCRIPT 3 0 45E44
		setActscript $4,$FF,eas_Jump; 0015 SET ACTSCRIPT 4 FF 45E44
		csWait $1E              ; WAIT 1E
		...
		csWait $14              ; WAIT 14
		setEntityDir $5,$1      ; 0023 SET ENTITY FACING 5 1
		setActscript $5,$FF,eas_46172; 0015 SET ACTSCRIPT 5 FF 46172
		customActscript $5,$FF  ; 0014 SET MANUAL ACTSCRIPT 5
		...
		dc.l eas_Idle           
		dc.w $8080              ; 0014 END OF CUSTOM ACTSCRIPT
		moveEntity $5,$0,$3,$2  ; 002D MOVE ENTITY 5 0 3 2
		moreMove $2,$1
		endMove $8080
		moveEntity $1,$FF,$2,$3 ; 002D MOVE ENTITY 1 FF 2 3
		moreMove $3,$4
		moreMove $0,$4
		endMove $8080
		...
		followEntity $3,$0,$2   ; 002C FOLLOW ENTITY 3 0 2
		followEntity $4,$3,$2   ; 002C FOLLOW ENTITY 4 3 2
		followEntity $2,$4,$2   ; 002C FOLLOW ENTITY 2 4 2
		followEntity $1,$2,$2   ; 002C FOLLOW ENTITY 1 2 2
		csc_end                 ; END OF CUTSCENE SCRIPT
cs_528CA:       moveEntity $0,$FF,$0,$1 ; 002D MOVE ENTITY 0 FF 0 1
		endMove $8080
		csc_end                 ; END OF CUTSCENE SCRIPT
cs_528D4:       textCursor $3B3         ; Initial text line $3B3 : "Wait!{W1}"
		nextSingleText $0,$5    ; "Wait!{W1}"
		setCamDest $32,$3       ; 0032 SET CAMERA DEST 32 3
		csWait $1E              ; WAIT 1E
		setActscript $5,$FF,eas_Init; 0015 SET ACTSCRIPT 5 FF 460CE
		startEntity $5          ; 001B START ENTITY ANIM 5
		entitySprite $5,$5      ; 001A SET ENTITY SPRITE 5 5
		moveEntity $5,$FF,$2,$2 ; 002D MOVE ENTITY 5 FF 2 2
		endMove $8080
		...
		moveEntity $5,$FF,$1,$4 ; 002D MOVE ENTITY 5 FF 1 4
		endMove $8080
		csWait $1E              ; WAIT 1E
		...
		setBlocks $3F02,$101,$3904; 0034 SET BLOCKS 3F02 101 3904
		csWait $14              ; WAIT 14
		moveEntity $5,$FF,$0,$1 ; 002D MOVE ENTITY 5 FF 0 1
		moreMove $1,$1
		endMove $8080
		...
		csc_end                 ; END OF CUTSCENE SCRIPT
cs_52938:       textCursor $3B8         ; Initial text line $3B8 : "You're right.  I did it.{W2}"
		moveEntity $5,$FF,$3,$1 ; 002D MOVE ENTITY 5 FF 3 1
		endMove $8080
		setEntityDir $5,$2      ; 0023 SET ENTITY FACING 5 2
		...
		setActscript $5,$FF,eas_Jump; 0015 SET ACTSCRIPT 5 FF 45E44
		setActscript $5,$0,eas_Jump; 0015 SET ACTSCRIPT 5 0 45E44
		...
		csc46 $18,$E            ; 0046 UNKNOWN
		setActscript $1,$FF,eas_Init; 0015 SET ACTSCRIPT 1 FF 460CE
		setActscript $2,$FF,eas_Init; 0015 SET ACTSCRIPT 2 FF 460CE
		setActscript $3,$FF,eas_Init; 0015 SET ACTSCRIPT 3 FF 460CE
		setActscript $4,$FF,eas_Init; 0015 SET ACTSCRIPT 4 FF 460CE
		setActscript $5,$FF,eas_Init; 0015 SET ACTSCRIPT 5 FF 460CE
		hideEntity $1           ; 002E HIDE ENTITY 1
		hideEntity $2           ; 002E HIDE ENTITY 2
		hideEntity $3           ; 002E HIDE ENTITY 3
		hideEntity $4           ; 002E HIDE ENTITY 4
		entityPosDir $0,$1D,$C,$3; 0019 SET ENTITY POS AND FACING 0 1D C 3
		entityPosDir $5,$1D,$B,$3; 0019 SET ENTITY POS AND FACING 5 1D B 3
		...
		setEntityDest $8000,$1D,$12; 0029 SET ENTITY DEST 8000 1D 12
		setEntityDest $5,$1D,$11; 0029 SET ENTITY DEST 5 1D 11
		setEntityDir $0,$3      ; 0023 SET ENTITY FACING 0 3
		setEntityDir $5,$3      ; 0023 SET ENTITY FACING 5 3
		...
		setActscript $5,$FF,eas_Init; 0015 SET ACTSCRIPT 5 FF 460CE
		followEntity $5,$0,$2   ; 002C FOLLOW ENTITY 5 0 2
		csc_end                 ; END OF CUTSCENE SCRIPT
cs_52A3C:       setActscript $0,$FF,eas_Init; 0015 SET ACTSCRIPT 0 FF 460CE
		setEntityDir $83,$2     ; 0023 SET ENTITY FACING 83 2
		textCursor $3BE         ; Initial text line $3BE : "Hey, it's noisy next door.{W2}"
