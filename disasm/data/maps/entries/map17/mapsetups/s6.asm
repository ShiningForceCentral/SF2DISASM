...
cs_5247C:       setBlocks $30,$7,$1,$1,$30,$8; 0034 SET BLOCKS 3007 101 3008
		setBlocks $3E,$14,$1,$2,$30,$14; 0034 SET BLOCKS 3E14 102 3014
		setBlocks $39,$7,$1,$1,$39,$8; 0034 SET BLOCKS 3907 101 3908
		setBlocks $3E,$14,$1,$2,$39,$14; 0034 SET BLOCKS 3E14 102 3914
		csc_end
cs_5249E:       playSound $FD           ; 0005 PLAY SOUND 
		...
		textCursor $370         ; 0004 INIT TEXT CURSOR 370 : "Impossible!{N}Galam and Granseal are{N}allies!{W1}"
		reloadMap $34,$1        ; 0046  34 1
		...
		csWait $28
		setFacing $2,$0         ; 0023 SET ENTITY FACING 2 0
		textCursor $37C         ; 0004 INIT TEXT CURSOR 37C : "{LEADER}!{N}You finally woke up!{W2}"
		nextText $0,$2          ; "{LEADER}!{N}You finally woke up!{W2}"
		nextSingleText $0,$2    ; "We're talking about{N}Ground Seal.{N}Please, join in.{W1}"
		setFacing $2,$2         ; 0023 SET ENTITY FACING 2 2
		csc_end
cs_52530:       textCursor $385         ; 0004 INIT TEXT CURSOR 385 : "What's wrong with the seal?{W1}"
		...
		setFacing $0,$2         ; 0023 SET ENTITY FACING 0 2
		setFacing $2,$2         ; 0023 SET ENTITY FACING 2 2
		setFacing $3,$2         ; 0023 SET ENTITY FACING 3 2
		setFacing $1,$2         ; 0023 SET ENTITY FACING 1 2
		...
		setFacing $1,$0         ; 0023 SET ENTITY FACING 1 0
		...
		setBlocks $30,$7,$1,$1,$30,$8; 0034 SET BLOCKS 3007 101 3008
		setBlocks $3E,$14,$1,$2,$30,$14; 0034 SET BLOCKS 3E14 102 3014
		textCursor $3A3         ; 0004 INIT TEXT CURSOR 3A3 : "{NAME;5} sticks a short wire{N}into the keyhole.{W1}"
		...
		endMove $8080
		setFacing $2,$3         ; 0023 SET ENTITY FACING 2 3
...
cs_528CA:       moveEntity $0,$FF,$0,$1 ; 002D MOVE ENTITY 0 FF 0 1
		endMove $8080
		csc_end
cs_528D4:       textCursor $3B3         ; 0004 INIT TEXT CURSOR 3B3 : "Wait!{W1}"
		...
		setBlocks $3F,$2,$1,$1,$39,$4; 0034 SET BLOCKS 3F02 101 3904
		csWait $14
		moveEntity $5,$FF,$0,$1 ; 002D MOVE ENTITY 5 FF 0 1
		moreMove $1,$1
		endMove $8080
		...
		csc_end
cs_52938:       textCursor $3B8         ; 0004 INIT TEXT CURSOR 3B8 : "You're right.  I did it.{W2}"
		moveEntity $5,$FF,$3,$1 ; 002D MOVE ENTITY 5 FF 3 1
		endMove $8080
		setFacing $5,$2         ; 0023 SET ENTITY FACING 5 2
...
cs_52A3C:       setActscript $0,$FF,eas_Init; 0015 SET ACTSCRIPT 0 FF 460CE
		...
		textCursor $3BE         ; 0004 INIT TEXT CURSOR 3BE : "Hey, it's noisy next door.{W2}"
