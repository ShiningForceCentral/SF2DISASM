...
cs_59FB8:
		dc.w 4                  
						; 0004 INIT TEXT CURSOR 6C5 : "(Sniff, sniff)...{N}It smells like a ditch!{W1}"
		dc.w $6C5
		dc.w $15                
		...
		dc.b $78
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 1F : "(Sniff, sniff)...{N}It smells like a ditch!{W1}"
		dc.w $1F
		dc.w $29                
		...
		dc.w 7
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 7 : "Is this the smell of the{N}devils that they were{N}talking about?{W1}"
		dc.w 7
		dc.w $32                
		...
		dc.w $15
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX C081 : "Hee, hee!{W1}"
		dc.w $C081
		dc.w $15                
		...
		dc.w $82
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX 7 : "What huge rats!{W1}"
		dc.w 7
		dc.w 2                  
						; 0002 DISPLAY TEXT BOX C081 : "Welcome!{W2}"
		dc.w $C081
		dc.w 0                  
						; 0000 DISPLAY SINGLE TEXTBOX C081 : "It's dinner time!{W1}"
		dc.w $C081
		dc.w $15                
						; 0015 SET ACTSCRIPT 80 0 45E44
		dc.b $80
		...
		dc.l eas_Jump           
		dc.w $13                
						; 0013 SET STORY FLAG 17 : Battle 23 unlocked
		dc.w $17
		dc.w 7                  
