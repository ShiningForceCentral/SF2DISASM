...
cs_59FB8:       textCursor $6C5         ; 0004 INIT TEXT CURSOR 6C5 : "(Sniff, sniff)...{N}It smells like a ditch!{W1}"
		...
		setCamDest $16,$F       ; 0032 SET CAMERA DEST 16 F
		setEntityDest $1F,$1A,$14; 0029 SET ENTITY DEST 1F 1A 14
		csWait $5
		setActscript $1F,$0,eas_461B6; 0015 SET ACTSCRIPT 1F 0 461B6
		csWait $78
		nextSingleText $0,$1F   ; "(Sniff, sniff)...{N}It smells like a ditch!{W1}"
		setEntityDest $7,$1B,$14; 0029 SET ENTITY DEST 7 1B 14
		...
		setCamDest $24,$11      ; 0032 SET CAMERA DEST 24 11
		setEntityDest $81,$29,$15; 0029 SET ENTITY DEST 81 29 15
		...
		mapSysEvent $1B,$0,$0,$0; 0007 EXECUTE MAP SYSTEM EVENT 1B000000
		csc_end
