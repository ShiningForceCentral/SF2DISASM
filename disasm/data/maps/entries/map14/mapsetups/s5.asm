...
cs_58FA4:
		textCursor $8D6         
						; Initial text line $8D6 : "Somebody, take that plank{N}from him!{W1}"
		csc46 $8,$7             
						; 0046 UNKNOWN
		...
		nextSingleText $0,$80   
						; "Somebody, take that plank{N}from him!{W1}"
		setEntityDir $80,$0     
		...
		nextSingleText $FF,$FF  
						; "{LEADER} hands over{N}the plank.{W1}"
		csWait $1E              
						; WAIT 1E
		nextSingleText $0,$82   
						; "We need a lot of planks{N}for our new town!{W1}"
		moveEntity $82,$0,$3,$7 
		...
		endMove $8080
		nextText $0,$80         
						; "We can't go back to {N}Granseal without a ship...{W2}"
		nextSingleText $0,$80   
						; "There's no Granseal on{N}Grans Island now...{N}I know that, but...{W1}"
		csWait $3C              
						; WAIT 3C
		nextSingleText $0,$83   
						; "Somebody, help!{W1}"
		...
		nextText $0,$83         
						; "One of my friends has not{N}returned from North Cliff.{W2}"
		nextSingleText $0,$83   
						; "He may be in trouble.{W1}"
		nextSingleText $0,$80   
						; "This isn't good.{W1}"
		setEntityDir $80,$2     
						; 0023 SET ENTITY FACING 80 2
		...
		csWait $1E              
						; WAIT 1E
		nextText $0,$80         
						; "{LEADER}, did you{N}hear that?{W2}"
cs_59122:
		textCursor $8E3         
						; Initial text line $8E3 : "Would you go to North{N}Cliff and check on his{N}friend?{D1}"
		nextText $0,$80         
						; "Would you go to North{N}Cliff and check on his{N}friend?{D1}"
		yesNo                   
						; 0011 STORY YESNO PROMPT
		jumpIfFlagSet $59,cs_59142
						; YES/NO prompt answer
		nextText $0,$80         
						; "What did you say?{N}I didn't hear you.{W2}"
		nextText $0,$80         
						; "OK, once again!{W1}"
		jump cs_59122           
						; 000B JUMP 59122
cs_59142:
		textCursor $8E6         
						; Initial text line $8E6 : "Oh, you're so brave!{W2}"
		nextText $0,$80         
						; "Oh, you're so brave!{W2}"
		nextSingleText $0,$80   
						; "Hey, he's going with you!{W1}"
		...
		setEntityDir $80,$0     
						; 0023 SET ENTITY FACING 80 0
		textCursor $8E8         
						; Initial text line $8E8 : "{LEADER}, thank you!{W2}"
		...
		nextText $0,$83         
						; "{LEADER}, thank you!{W2}"
		nextSingleText $0,$83   
						; "I'll show you to North Cliff.{N}Follow me.{W1}"
		csWait $1E              
						; WAIT 1E
		moveEntity $83,$0,$3,$4 
		...
		setEntityDir $80,$3     
						; 0023 SET ENTITY FACING 80 3
		nextSingleText $0,$1    
						; "Are you leaving?{N}Say it isn't so!{W1}"
		nextSingleText $0,$4    
						; "I think it's too dangerous{N}out there alone.{W1}"
		nextText $0,$83         
						; "And...{W2}"
		nextSingleText $0,$83   
						; "It would be safer if we came{N}along.  Let's go.{W1}"
		csWait $3C              
						; WAIT 3C
