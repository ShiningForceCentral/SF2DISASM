...
cs_58FA4:       textCursor $8D6         ; 0004 INIT TEXT CURSOR 8D6 : "Somebody, take that plank{N}from him!{W1}"
		reloadMap $8,$7         ; 0046  8 7
		loadMapEntities ce_59270; 0042 RELATED TO LOADING MAP ENTITIES 59270
		setActscript $0,$FF,eas_Init; 0015 SET ACTSCRIPT 0 FF 460CE
		csWait $1
		setPriority $0,$0       ; 0053  0 0
		setPriority $82,$0      ; 0053  82 0
		setPriority $85,$FFFF   ; 0053  85 FFFF
...
cs_59122:       textCursor $8E3         ; 0004 INIT TEXT CURSOR 8E3 : "Would you go to North{N}Cliff and check on his{N}friend?{D1}"
...
cs_59142:       textCursor $8E6         ; 0004 INIT TEXT CURSOR 8E6 : "Oh, you're so brave!{W2}"
		...
		endMove $8080
		setFacing $80,$0        ; 0023 SET ENTITY FACING 80 0
		textCursor $8E8         ; 0004 INIT TEXT CURSOR 8E8 : "{LEADER}, thank you!{W2}"
		...
		setFacing $6,$3         ; 0023 SET ENTITY FACING 6 3
