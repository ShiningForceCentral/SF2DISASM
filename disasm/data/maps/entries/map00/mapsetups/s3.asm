...
cs_5E3C2:
		textCursor $AAB         
						; Initial text line $AAB : "Welcome, Granseal force!{W1}"
		setActscript $7,$FF,eas_Init
						; 0015 SET ACTSCRIPT 7 FF 460CE
		setActscript $1F,$FF,eas_Init
						; 0015 SET ACTSCRIPT 1F FF 460CE
		nextSingleText $0,$80   
						; "Welcome, Granseal force!{W1}"
		...
		nextSingleText $0,$1F   
						; "I heard a voice from the{N}other side of the door.{W1}"
		setEntityDir $0,$1      
		...
		nextSingleText $0,$80   
						; "I'm Zalbard.  I'm one of{N}the greater devils.{W1}"
		...
		endMove $8080
		nextSingleText $0,$80   
						; "Do come in.  Of course, you{N}can go back now and abandon{N}Mitula!{W1}"
		setEntityDir $7,$2      
						; 0023 SET ENTITY FACING 7 2
		nextText $0,$7          
						; "Sir Astral...{W2}"
		nextSingleText $0,$7    
						; "The greater devil that{N}attacked Bedoe was as{N}strong as Volcanon.{W1}"
		nextText $0,$80         
						; "Are you talking about{N}Sir Odd Eye?{W2}"
		nextSingleText $0,$80   
						; "Did he fight against{N}Volcanon at Bedoe?{W1}"
		setEntityDir $7,$1      
						; 0023 SET ENTITY FACING 7 1
		nextSingleText $0,$1F   
						; "Yes.  And he lost.{W1}"
		nextText $0,$80         
						; "I can't believe it!{N}Odd Eye is the strongest{N}devil among us.{W2}"
		nextText $0,$80         
						; "But, we haven't been able to{N}contact him lately.{W2}"
		nextText $0,$80         
						; "This is good news for me.{N}If I get the Jewel of Evil, I{N}can take his place.{W2}"
		nextSingleText $0,$80   
						; "Now, enter the shrine.{N}Mitula is here.{W1}"
		csWait $3C              
						; WAIT 3C
		nextSingleText $0,$7    
						; "What should we do?{N}A greater devil awaits us{N}inside.{W1}"
		setEntityDir $7,$2      
						; 0023 SET ENTITY FACING 7 2
		setActscript $1F,$FF,eas_Init
						; 0015 SET ACTSCRIPT 1F FF 460CE
		...
		endMove $8080
		nextSingleText $0,$1F   
						; "I think I've heard that{N}name before....{W1}"
		moveEntity $7,$FF,$3,$1 
		...
		endMove $8080
		nextSingleText $0,$1F   
						; "Whhhhhhat?{N}{NAME;7}, don't scare me!{W1}"
		entityShiver $1F        
		...
		endMove $8080
		nextText $0,$7          
						; "What's wrong with you?{W2}"
		nextSingleText $0,$7    
						; "Should we go into the shrine{N}now?{W1}"
		nextSingleText $0,$1F   
						; "Oh, sorry.{W1}"
		customActscript $1F,$FF 
						; 0014 SET MANUAL ACTSCRIPT 1F
		...
		setEntityDir $1F,$1     
						; 0023 SET ENTITY FACING 1F 1
		nextText $0,$1F         
						; "Zalbard...at least he's not{N}as strong as Odd Eye.{W2}"
		nextText $0,$1F         
						; "But still, he's a greater{N}devil.{W2}"
		nextSingleText $0,$1F   
						; "We had better complete our{N}preparations before we go in.{W1}"
		nextSingleText $0,$0    
						; "OK.{W1}"
		entityNod $7            
		...
		setBlocks $26,$203,$E0A 
						; 0034 SET BLOCKS 26 203 E0A
		setF $348               
						; set after the door to the Mitula Shrine is opened
		csc_end                 
