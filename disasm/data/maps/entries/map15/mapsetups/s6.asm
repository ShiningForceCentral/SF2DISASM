...
cs_5D04E:       textCursor $7D6         ; 0004 INIT TEXT CURSOR 7D6 : "Excuse me, are you{N}{LEADER} of Granseal?{W1}"
		...
		entityPosDir $7,$18,$11,$0; 0019 SET ENTITY POS AND FACING 7 18 11 0
		entityPosDir $1F,$18,$10,$0; 0019 SET ENTITY POS AND FACING 1F 18 10 0
		entityPosDir $0,$18,$12,$0; 0019 SET ENTITY POS AND FACING 0 18 12 0
		...
		endMove $8080
		setCamDest $14,$14      ; 0032 SET CAMERA DEST 14 14
		moveEntity $14,$0,$1,$A ; 002D MOVE ENTITY 14 0 1 A
		endMove $8080
		setCamDest $14,$A       ; 0032 SET CAMERA DEST 14 A
		moveEntity $14,$0,$0,$4 ; 002D MOVE ENTITY 14 0 0 4
		endMove $8080
		setCamDest $1B,$A       ; 0032 SET CAMERA DEST 1B A
		moveEntity $14,$0,$3,$5 ; 002D MOVE ENTITY 14 0 3 5
		endMove $8080
		setCamDest $1B,$F       ; 0032 SET CAMERA DEST 1B F
		moveEntity $14,$0,$2,$13; 002D MOVE ENTITY 14 0 2 13
		endMove $8080
		setCamDest $9,$F        ; 0032 SET CAMERA DEST 9 F
		moveEntity $14,$0,$1,$A ; 002D MOVE ENTITY 14 0 1 A
		endMove $8080
		setCamDest $9,$5        ; 0032 SET CAMERA DEST 9 5
		moveEntity $14,$0,$0,$D ; 002D MOVE ENTITY 14 0 0 D
		endMove $8080
		setCamDest $14,$5       ; 0032 SET CAMERA DEST 14 5
