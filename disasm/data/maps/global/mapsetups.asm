...
MapSetups:
		dc.w 3                  
						; list of map event addresses and flags to check
		dc.l ms_map3
		dc.w $261               
		...
		dc.w $2BE               
						; set after the scene with Peter at the Castle (ends with you leaving the Castle)
		...
		dc.w $30F               
						; set after the scene where Creed restores the Force and heads down the basement
		dc.l ms_map33
		dc.w $310               
						; set after the event in the basement of Creed's Mansion
		dc.l ms_map33_flag310
		dc.w $312               
						; set after Oddler elects to stay behind at Creed's Mansion
