...
; SCRIPT SECTION battles\entries\battle40\cs_regiontriggered_2 :
; Region-activated cutscene 2 for battle 40
rbcs_battle40_2:    dc.w $45                ; 0045 RELATED TO CAMERA ADJUST TO PLAYER 30
										dc.w $30
