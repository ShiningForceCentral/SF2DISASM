...
StartTitleScreen:
                ...
                ; Load title tiles
                conditionalPc lea,tiles_TitleScreen,a0
                ...
                conditionalPc lea,layout_TitleScreenA,a0
                ...
                moveq   #2,d1
                jsr     (ApplyImmediateVramDma).w
                conditionalPc lea,layout_TitleScreenB,a0
                lea     (SPRITE_05).l,a1
                moveq   #10,d7
@OuterLoop:
...
@NextVdpTile:
                ...
                conditionalPc lea,palette_TitleScreen,a0
