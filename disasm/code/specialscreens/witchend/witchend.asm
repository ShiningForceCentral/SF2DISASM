...
EndGame:
                ...
                getPointer p_WitchEndLayout, a0
                ...
                moveq   #2,d1
                jsr     (ApplyImmediateVramDma).w
                getPointer p_JewelEndScreenTiles, a0
                lea     (FF6802_LOADING_SPACE).l,a1
                move.l  a1,-(sp)
                jsr     (LoadCompressedData).w
                movea.l (sp)+,a0
                ...
                moveq   #2,d1
                jsr     (ApplyImmediateVramDma).w
                getPointer p_JewelEndScreenLayout, a0
                lea     (PLANE_B_LAYOUT).l,a1
                move.w  #$800,d7
                jsr     (CopyBytes).w   
                lea     (PLANE_B_LAYOUT).l,a0
                ...
                moveq   #2,d1
                jsr     (ApplyImmediateVramDma).w
                getPointer p_plt_JewelsEndScreen, a0
                lea     (PALETTE_1_BASE).l,a1
                moveq   #64,d7
                jsr     (CopyBytes).w   
                jsr     (EnableDisplayAndInterrupts).w
