...
loc_7476:
		...
		trap    #TEXTBOX
		dc.w $DF                
						; "{NAME;0}....{N}Nice name, huh?{W2}"
		bsr.w   CheatModeConfiguration
		trap    #TEXTBOX
		dc.w $E8                
						; "I'll let you decide the{N}difficulty level at this time."
		clr.w   d0
		moveq   #3,d1
		moveq   #$F,d2
		jsr     j_WitchMainMenu
...
loc_74A8:
		...
		addi.w  #$E9,d0 
						; difficulty choice reactions
		bsr.w   DisplayText     
		trap    #TEXTBOX
		dc.w $E0                
						; "Now, good luck!{N}You have no time to waste!{W1}"
loc_74B4:
