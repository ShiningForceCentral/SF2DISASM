...
loc_1808C:
		...
		move.w  #$8B07,d0       
						; set VScroll : each 2 cells, HScroll : each 1 line
		jsr     (SetVdpReg).w   
...
bsc01_animateAllyAction:
		...
		move.b  (a0)+,d6
		move.w  (a6)+,d5        
						; magic/item/projectile animation
		move.b  (a0)+,d0
		clr.w   d3
		bsr.s   sub_184B0
		clr.w   d4
...
plt_198A8:
		dc.w 0                  
						; used on plt 3bis at battlescene init
		dc.w $EEE
		dc.w 0
		dc.w 0
		dc.w 0
...
GetBattleBackground:
		...
		jsr     j_GetEnemyID
		cmpi.w  #$62,d1 
						; HARDCODED : if enemy is Zeon, get his own background
		bne.s   loc_19E20
		moveq   #$1B,d1
		bra.w   loc_19E58
loc_19E20:
		...
		move.b  (a0,d1.w),d1    
						; get battle's own background if it has one
		cmpi.b  #$FF,d1
		bne.w   loc_19E58
		cmpi.w  #$FFFF,d0
		bne.s   loc_19E48
...
loc_19E48:
		...
		andi.w  #$F,d0          
						; get background according to terrain type
