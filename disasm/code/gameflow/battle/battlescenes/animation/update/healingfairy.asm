...
loc_1C5B6:
                ...
                addq.w  #1,2(a5)
                move.w  (a3),d3
                addi.w  #SPELLTILE_START|VDPTILE_PALETTE3|VDPTILE_PRIORITY,d3
                btst    #2,3(a5)
                beq.s   loc_1C5D2
...
loc_1C68E:
                ...
                move.w  d0,10(a5)
                add.w   d1,(a4)
                add.w   d1,NEXTVDPSPRITE_OFFSET_Y(a4)
                addq.b  #1,$E(a5)
                cmpi.b  #4,$E(a5)
                bcs.s   loc_1C6CC
                clr.b   14(a5)
...
loc_1C6BA:
                ...
                move.w  NEXTVDPSPRITE_OFFSET_TILE(a4),d3
                andi.w  #VDPTILE_MIRROR,d3
                or.w    d3,d1
                move.w  d1,NEXTVDPSPRITE_OFFSET_TILE(a4)
loc_1C6CC:
                
                cmpi.w  #96,VDPSPRITE_OFFSET_X(a4) 
                bcs.w   loc_1C6E0
...
loc_1C6F2:
                ...
                ; alternate wing graphic frames
                bchg    #3,VDPSPRITE_OFFSET_TILE(a4)
                bchg    #3,NEXTVDPSPRITE_OFFSET_TILE(a4)
loc_1C720:
                ...
                addq.w  #3,d7
                move.w  d7,16(a5)
                move.w  VDPSPRITE_OFFSET_X(a4),12(a3)
                move.w  (a4),14(a3)
loc_1C73E:
