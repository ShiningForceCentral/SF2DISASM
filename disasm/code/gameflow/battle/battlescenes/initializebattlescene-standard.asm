...
@ClearBattlesceneData_Loop:
                ...
                move.w  d1,-(sp)
                bsr.s   GetEnemyGraphicsInformation
                move.w  (sp)+,d0
                
                ; Get ally graphics information
                bsr.s   GetAllyGraphicsInformation
...
@Continue:      bsr.w   GetBattlesceneBackground
                
                
; Alternate entry point for Battlescene Test debug action
;
; In: d1.w = background index
;
alt_InitializeBattlescene:
...
@LoadAllyVdpSprite:
                ...
                lea     ((BATTLESCENE_BATTLESPRITE_TOGGLE-$1000000)).w,a2
                moveq   #8,d0
@LoadAllyVdpSprite_Loop:
                ...
                lea     ((BATTLESCENE_GROUNDSPRITE_TOGGLE-$1000000)).w,a2
                moveq   #2,d0
...
@CheckWeaponsprite:
                ...
                cmpi.w  #-1,d0
                beq.s   @StatusAnimationTilesToVram
...
@StatusAnimationTilesToVram:
                ...
                jsr     CreateBattlesceneMiniStatusWindows
                trap    #VINT_FUNCTIONS
                dc.w VINTS_ADD
                ...
                clr.w   d1
                jsr     OpenEnemyBattlesceneMiniStatusWindow
@CheckAllyBattlesceneWindow:
                
                move.w  ((BATTLESCENE_ALLY-$1000000)).w,d0
                cmpi.w  #-1,d0
                beq.s   @StartFadeInAndPlayMusic
                
                clr.w   d1
                jsr     OpenAllyBattlesceneMiniStatusWindow
