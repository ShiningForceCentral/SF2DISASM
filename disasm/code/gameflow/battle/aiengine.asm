...
loc_F24A:
		...
		bsr.w   GetCurrentHP    
						; iterate through force or monsters
		tst.w   d1
		bne.s   loc_F256
		bra.w   loc_F276
loc_F256:
...
loc_F26E:
		...
		move.b  d0,(a0,d2.w)    
						; add to targets if alive and on map
		addi.w  #1,d2
loc_F276:
...
KrakenMoveCosts:
		dc.b $F                 
						; special move cost list for Kraken Arm, Kraken Leg, Kraken Head
		dc.b 2
		dc.b 2
		dc.b 3
		dc.b 4
