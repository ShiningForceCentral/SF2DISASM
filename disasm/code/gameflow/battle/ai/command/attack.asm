...
; ASM FILE code\gameflow\battle\ai\command\attack.asm :
; 0xE78C..0xE98C : AI command : Attack

; =============== S U B R O U T I N E =======================================

; In: d0.w = attacker index
;     d1.w = extra AI variable (values of 0-3)
...
aiCommand_Attack:
                ...
                move.w  d0,d7
                move.w  d1,d6
                bsr.w   PrioritizeTargetsForAttackAiCommand
                bsr.w   DetermineBattleactionForAttackAiCommand
...
@EndTurn:
    ...
    ; End of function aiCommand_Attack
