...
; ASM FILE code\gameflow\battle\ai\command\attack\determinebattleaction.asm :
; 0xEDD6..0xF1D4 : AI engine : Determine battleaction for Attack AI command function
...
; 
;   In: d0.b = attacker index
;   Out: d0.w = target index, d1.w = priority (max of 15), d2.b = battleaction index
; 
...
DetermineBattleactionForAttackAiCommand:
                ...
                clr.w   d3
                lea     ((FF8804_LOADING_SPACE-$1000000)).w,a0 ; # targets reachable by regular attack
                tst.w   (a0)
...
@loc_34:
                ...
                clr.l   d3
                move.b  d1,d3
                lea     (pt_AttackPriorityClassesForMovetype).l,a4
...
@loc_53:
    ...
    ; End of function DetermineBattleactionForAttackAiCommand
