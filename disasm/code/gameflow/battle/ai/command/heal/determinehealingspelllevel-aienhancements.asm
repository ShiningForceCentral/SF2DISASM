...
; ASM FILE code\gameflow\battle\ai\command\heal\determinehealingspelllevel-aienhancements.asm :
...
@Loop:          move.b  SPELLDEF_OFFSET_MP_COST(a0),d6
                ...
                move.w  d4,d1
                bsr.w   GetSpellDefinitionAddress ; Load spell definition for the new, lower level
