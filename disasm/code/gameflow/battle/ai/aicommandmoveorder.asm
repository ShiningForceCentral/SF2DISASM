...
; ASM FILE code\gameflow\battle\ai\aicommandmoveorder.asm :
...
;     d1.b = AI order target type (0 = move-to-point, 1 = follow target)
;     d2.b = AI order movement mode (0 = regular, 1 = block-non-movable, 2 = block-and-carve/tethered)
; 
...
aiOrderMovementMode = -4
moveOrder = -3
aiOrderTargetType = -2
combatant = -1

ExecuteAiCommand_MoveOrder:
...
@Enemy:
                ...
                move.b  d1,aiOrderTargetType(a6)
                move.b  d2,aiOrderMovementMode(a6)
                bsr.w   GetCurrentMov
                tst.b   d1
                bne.s   @CanMove
...
@CheckTargetType:
                ...
                move.b  aiOrderTargetType(a6),d0
                tst.b   d0
                bne.w   @FollowTarget
                ...
                move.w  #-1,d3
                bsr.w   UpdateBattleTerrainOccupiedByAllies ; set flags
                bsr.w   InitializeMovementArrays            ; initialize and populate movement arrays
                bsr.w   PopulateMovementArrays
                clr.w   d3
                bsr.w   UpdateBattleTerrainOccupiedByAllies ; clear flags
                
                ; Find a nearby attack position
                clr.w   d0
                move.b  combatant(a6),d0
                bsr.w   GetClosestAttackPositionForMoveOrder
                tst.b   d1
...
@FollowTarget:
                ...
                clr.w   d0
                move.b  combatant(a6),d0
                move.b  aiOrderTargetType(a6),d1
...
@ProcessMovementMode:
                ...
                clr.w   d2
                move.b  aiOrderMovementMode(a6),d2
                tst.w   d2
                beq.s   @Done
                
                cmpi.w  #1,d2
                bne.s   @IsCharacteristic2
...
@Done:
    ...
    ; End of function ExecuteAiCommand_MoveOrder
