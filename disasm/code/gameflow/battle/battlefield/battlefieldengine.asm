...
; ASM FILE code\gameflow\battle\battlefield\battlefieldengine.asm :
; 0xC09A..0xC22A : Battlefield engine general functions
...
; Get movecost to reach space at coordinates d1.w, d2.w
; 
