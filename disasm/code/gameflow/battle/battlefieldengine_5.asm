...
; ASM FILE code\gameflow\battle\battlefieldengine_5.asm :
; 0xD8F4..0xDEFC : Battlefield engine
tbl_HealPriority_MoveType:
                dc.b $FF
...
off_D9A2:       dc.l tbl_AttackPriority_Archer          ; moveType Archer
