...
MemorizePath:
		...
		movem.l d0-a6,-(sp)     
						; copy current moving unit's terrain list to memory
loc_C190:
...
SpellElements:
		incbin "data/stats/spells/spellelements.bin"
...
loc_C760:
		...
		bsr.w   GetDestinationMoveCost
		tst.w   d0              
						; already in range, so end because it can't get cheaper
		beq.w   loc_C7EA
		btst    #$F,d0
		bne.w   loc_C7BE
		cmp.b   -5(a6),d0
		...
		cmpi.b  #$FF,d0
		bne.w   loc_C7BE        
						; already someone there, so it can't be chosen
		move.b  d7,-5(a6)
		move.b  d1,-3(a6)
		move.b  d2,-4(a6)
loc_C7BE:
...
loc_D22E:
		...
		beq.s   loc_D23A
		eori.b  #$80,d0         
						; flip enemy bit, to get the opposite type when muddled
loc_D23A:
...
off_D9C2:
		dc.l byte_DA02          
						; Gives values from Upper Move Type and Class
		dc.l byte_DA02
		dc.l byte_DA02
		dc.l byte_DA02
		dc.l byte_DA02
