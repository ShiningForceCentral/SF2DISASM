...
AnimateSpecialSprite:
                ...
                conditionalPc lea,(SpecialSprite_EvilSpirit+CRAM_PALETTE_SIZE),a0
                tst.w   d0
                beq.s   @Continue
                cmpi.b  #1,d0
                bne.s   @Zeon
                conditionalPc lea,SpecialSprite_EvilSpiritAlt,a0
                bra.s   @Continue
@Zeon:
                
                conditionalPc lea,(SpecialSprite_Zeon+CRAM_PALETTE_SIZE),a0
@Continue:
