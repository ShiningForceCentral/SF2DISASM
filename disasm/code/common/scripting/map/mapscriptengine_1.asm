...
loc_46EB8:
                ...
                move.b  #$10,ENTITYDEF_OFFSET_LAYER(a5)
return_46EBE:
...
loc_46F2C:
                ...
                jsr     j_GetCurrentHP
                tst.w   d1
                beq.w   loc_46F40 ; replace dead member
                addq.l  #1,a0
                dbf     d7,loc_46F2C
				; else replace last active member
loc_46F40:
...
@FindEnd_Loop:
                ...
                cmpi.b  #$FF,(a0)
                beq.w   @Break       ; gets last follower
                move.b  (a0)+,d1
                bra.s   @FindEnd_Loop
@Break:
