...
sub_1288E:
                ...
                link    a6,#-32
                move.l  ((ENTITY_SPECIAL_SPRITE-$1000000)).w,var_32(a6)
                move.l  #$70007000,((ENTITY_SPECIAL_SPRITE-$1000000)).w
...
loc_1291E:
                ...
                move.l  var_32(a6),((ENTITY_SPECIAL_SPRITE-$1000000)).w
...
loc_12D34:						;show combatants on minimap
...
loc_12D6E:
                ...
                move.l  a0,d0
                cmpi.w  #ENTITYADDRESS_UNIT_CURSOR,d0
                bne.s   loc_12D7E
                lea     ((ENTITY_DATA-$1000000)).w,a0
loc_12D7E:
