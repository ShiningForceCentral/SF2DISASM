...
loc_221F8:
		...
		trap    #TEXTBOX
		dc.w $5D                
						; "It has a special effect when{N}used in battle.{W2}"
		bra.s   loc_22214
loc_22210:
		
		trap    #TEXTBOX
		dc.w $5E                
						; "It has no effect in battle.{W2}"
loc_22214:
...
loc_222A8:
		...
		trap    #TEXTBOX
		dc.w $66                
						; "You can't sell it at a shop.{W2}"
		bra.s   loc_222D4
loc_222C0:
		...
		trap    #TEXTBOX
		dc.w $65                
						; "It brings {#} gold coins{N}at a shop.{W2}"
loc_222D4:
