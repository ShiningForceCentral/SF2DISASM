...
AddStatusEffectTileIndexesToVdpTileOrder:
                ...
                addi.w  #WINDOW_MEMBERSTATS_OFFSET_NEXT_LINE,d3
                movea.l d3,a1
                endif
...
LoadTileDataForMemberScreen:
                ...
                move.w  #VDPTILE_JEWEL_OF_LIGHT|VDPTILE_PLT3|VDPTILE_PRIORITY,(a1)
@CheckJewelOfEvil:
                
                chkFlg  $181            ; Set after Bowie obtains King Galam's jewel
                beq.s   @SkipJewelOfEvil
                adda.w  #2,a1
                move.w  #VDPTILE_JEWEL_OF_EVIL|VDPTILE_PLT3|VDPTILE_PRIORITY,(a1)
@SkipJewelOfEvil:
