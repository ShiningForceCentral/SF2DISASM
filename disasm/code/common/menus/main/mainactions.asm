...
loc_215C0:
		...
		trap    #TEXTBOX
		dc.w $37                
						; "{LEADER}!  You can't{N}unequip the {ITEM}.{N}It's cursed!{W2}"
...
loc_2168E:
		...
		trap    #TEXTBOX
		dc.w $4A                
						; "{NAME} changed hands{N}to hold the {ITEM}.{W2}"
		bra.s   loc_216F4
loc_216E4:
		...
		trap    #TEXTBOX
		dc.w $41                
						; "The {ITEM} now{N}belongs to {NAME}.{W2}"
loc_216F4:
...
loc_21838:
		...
		trap    #TEXTBOX
		dc.w $42                
						; "The {ITEM} was{N}exchanged for {NAME}'s{N}{ITEM}.{W2}"
loc_2184E:
...
loc_21880:
		...
		trap    #TEXTBOX
		dc.w $46                
						; "{NAME} is already{N}equipped with the{N}{ITEM}.{W2}"
loc_21894:
...
loc_218F2:
		...
		trap    #TEXTBOX
		dc.w $45                
						; "The {ITEM} will be{N}discarded.  OK?"
