...
loc_21A50:
		...
		trap    #TEXTBOX
		dc.w $C2                
						; "Welcome to the Dwarf{N}Craftsman!{D3}"
...
loc_21B0E:
		...
		trap    #TEXTBOX
		dc.w $CE                
						; "Oops...{N}I needs some more time.{W1}"
		move.w  -$12(a6),d0
		add.w   -$E(a6),d0
		sub.w   -$10(a6),d0
		cmpi.w  #4,d0
...
loc_21B38:
		...
		trap    #TEXTBOX
		dc.w $C3                
						; "We can create a great and{N}special weapon for you if you{N}have some special material.{W1}"
loc_21B3C:
...
sub_21B42:
		...
		trap    #TEXTBOX
		dc.w $CF                
						; "{CLEAR}I've been waiting!{N}This {ITEM} is for{N}you.  Isn't it great?!{W1}"
		trap    #TEXTBOX
		dc.w $A6                
						; "Who gets it?{W2}"
		trap    #TEXTBOX
...
loc_21B7C:
		...
		trap    #TEXTBOX
		dc.w $D0                
						; "{NAME}'s hands are are{N}full.  May I pass it to{N}somebody else?"
...
loc_21CD0:
		...
		trap    #TEXTBOX
		dc.w $D1                
						; "{CLEAR}Here you go!{N}It's a great weapon!{W2}"
loc_21CD4:
...
loc_21CDE:
		...
		trap    #TEXTBOX
		dc.w $C7                
						; "What kind of material do you{N}have?{D1}"
		trap    #TEXTBOX
		dc.w $FFFF
		...
		trap    #TEXTBOX
		dc.w $C8                
						; "Sorry, I've never worked{N}with that before....{W1}"
		bra.s   loc_21CDE
loc_21D1A:
		
		trap    #TEXTBOX
		dc.w $C9                
						; "{CLEAR}Whose weapon should I{N}make?{D1}"
		trap    #TEXTBOX
		dc.w $FFFF
		move.b  #0,((byte_FFB13C-$1000000)).w
		move.w  #ITEMIDX_NOTHING,((word_FFB13A-$1000000)).w
		...
		trap    #TEXTBOX
		dc.w $D3                
						; "{NAME} has to be promoted{N}first.{W1}"
		bra.s   loc_21D1A
loc_21D5C:
		...
		trap    #TEXTBOX
		dc.w $D4                
						; "Sorry, I can't create a{N}weapon for {NAME}.{W1}"
		bra.s   loc_21D1A
loc_21D74:
		...
		trap    #TEXTBOX
		dc.w $CA                
						; "For {NAME}!  It will cost{N}{#} gold coins.  OK?"
		jsr     sub_10050
		jsr     j_YesNoChoiceBox
		jsr     sub_10058
		cmpi.w  #0,d0
...
loc_21DA6:
		...
		trap    #TEXTBOX
		dc.w $CB                
						; "You have to bring more{N}money.{W2}"
		bra.w   loc_21E30
loc_21DC2:
		...
		trap    #TEXTBOX
		dc.w $CD                
						; "Please stop by shortly.{N}I'll surprise you!{W1}"
		move.w  -$E(a6),d0
		move.w  -$12(a6),d1
		move.w  -$10(a6),d2
		add.w   d1,d0
