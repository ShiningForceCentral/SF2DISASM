   ...
   include "sf2-10.asm"		; Backgrounds, invocation sprites, title screen
   include "sf2-11.asm"		; Enemy battle sprites
   include "sf2-12.asm"		; Ally battle sprites, status anim tiles, battlescene transition tiles, bolt graphics, ally and enemy animations
   include "sf2-13.asm"		; Battle setup functions, battle terrains, battle entity setups, end kiss graphics
   include "sf2-14.asm"		; Battlescene grounds, weapons, spell graphics, witch screens
   include "sf2-15.asm"		; Portraits
   include "sf2-16.asm"		; Icons
   include "sf2-17.asm"		; PCM Banks, YM Instruments, sound driver, char stats, witch screens
   include "sf2-18.asm"		; Music banks 1 and 0
