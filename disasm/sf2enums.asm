...
MAP_OVERWORLD_PACALON_KINGDOM_DROUGHT: equ 71 ; replaced with map 78 after Mitula is rescued
MAP_OVERWORLD_BEDOE_KINGDOM: equ 72     ; includes Polca, Bedoe, Volcanon Shrine, North Cliff, and Ketto
