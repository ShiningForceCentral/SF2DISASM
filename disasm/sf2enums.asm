...
SPELLANIMATION_25: equ $19
SPELLANIMATION_26: equ $1A
SPELLANIMATION_27: equ $1B
SPELLANIMATION_28: equ $1C
SPELLANIMATION_29: equ $1D
...
SPELLANIMATION_MIRROR: equ $80

; ---------------------------------------------------------------------------

; enum SpellAnimation_Bitmap
SPELLANIMATION_BIT_MIRROR: equ $7
...
MENU_MAGIC_OFFSET_MP_COST: equ $2C
MENU_MAGIC_SPELL_NAME_COORDS: equ $901
MENU_MAGIC_MP_COST_COORDS: equ $D04
    endif
...
WINDOW_FIGHTERMINISTATUS_OFFSET_STATBARS_START: equ $6
WINDOW_FIGHTERMINISTATUS_OFFSET_NEXT_TWO_LINES: equ WINDOW_FIGHTERMINISTATUS_OFFSET_NEXT_LINE*2
WINDOW_FIGHTERMINISTATUS_MAX_STATBAR_LENGTH: equ $64
WINDOW_FIGHTERMINISTATUS_DEST: equ $2001

    if (THREE_DIGITS_STATS=0)
WINDOW_FIGHTERMINISTATUS_OFFSET_MAX_HP: equ $6
WINDOW_FIGHTERMINISTATUS_SIDECOLUMNS_NUMBER_PLUS_ONE: equ $9
WINDOW_FIGHTERMINISTATUS_MIN_WIDTH: equ $A
WINDOW_FIGHTERMINISTATUS_OFFSET_STAT_VALUES: equ $C
WINDOW_FIGHTERMINISTATUS_MAX_WIDTH: equ $16
WINDOW_FIGHTERMINISTATUS_OFFSET_NEXT_LINE: equ $2C
WINDOW_FIGHTERMINISTATUS_LONGWORD_COUNTER: equ $36
WINDOW_FIGHTERMINISTATUS_SIZE: equ $1605
    else
WINDOW_FIGHTERMINISTATUS_OFFSET_MAX_HP: equ 8
WINDOW_FIGHTERMINISTATUS_SIDECOLUMNS_NUMBER_PLUS_ONE: equ $A
WINDOW_FIGHTERMINISTATUS_MIN_WIDTH: equ $C
WINDOW_FIGHTERMINISTATUS_OFFSET_STAT_VALUES: equ $10
WINDOW_FIGHTERMINISTATUS_MAX_WIDTH: equ $18
WINDOW_FIGHTERMINISTATUS_OFFSET_NEXT_LINE: equ $30
WINDOW_FIGHTERMINISTATUS_LONGWORD_COUNTER: equ $3B
...
; enum Window_MemberStats
WINDOW_MEMBERSTATS_NA_STRING_LENGTH: equ $3
WINDOW_MEMBERSTATS_OFFSET_NEXT_LINE: equ $2A
WINDOW_MEMBERSTATS_OFFSET_NAME: equ $2C
WINDOW_MEMBERSTATS_OFFSET_STATUSEFFECT_TILES: equ $4E
WINDOW_MEMBERSTATS_OFFSET_SPELL_LV_TILES: equ $58
WINDOW_MEMBERSTATS_OFFSET_EQUIPPED_STRING: equ $58
WINDOW_MEMBERSTATS_OFFSET_NEXT_SPELL: equ $7E
WINDOW_MEMBERSTATS_OFFSET_NEXT_ITEM: equ $7E
WINDOW_MEMBERSTATS_OFFSET_ATT: equ $A0
WINDOW_MEMBERSTATS_OFFSET_MAX_HP: equ $E2
WINDOW_MEMBERSTATS_OFFSET_DEF: equ $F4
WINDOW_MEMBERSTATS_OFFSET_MAX_MP: equ $136
WINDOW_MEMBERSTATS_OFFSET_AGI: equ $148
WINDOW_MEMBERSTATS_OFFSET_MOV: equ $19C
WINDOW_MEMBERSTATS_OFFSET_MAGIC_START: equ $224
WINDOW_MEMBERSTATS_OFFSET_ITEM_START: equ $236
WINDOW_MEMBERSTATS_OFFSET_MAGIC_NOTHING_STRING: equ $250
WINDOW_MEMBERSTATS_OFFSET_ITEM_NOTHING_STRING: equ $262
WINDOW_MEMBERSTATS_OFFSET_JEWEL_STRING_START: equ $374
WINDOW_MEMBERSTATS_OFFSET_JEWEL_STRING_END: equ $37E
WINDOW_MEMBERSTATS_OFFSET_JEWEL_OF_LIGHT: equ $39E
WINDOW_MEMBERSTATS_OFFSET_JEWEL_OF_EVIL: equ $3A2
WINDOW_MEMBERSTATS_VDPTILEORDER_BYTESIZE: equ $444
WINDOW_MEMBERSTATS_POSITION: equ $A01
WINDOW_MEMBERSTATS_SIZE: equ $151A
WINDOW_MEMBERSTATS_DEST: equ $2001

    if (THREE_DIGITS_STATS=0)
WINDOW_MEMBERSTATS_OFFSET_ENEMY_LV: equ $8C
WINDOW_MEMBERSTATS_OFFSET_LV: equ $8E
WINDOW_MEMBERSTATS_OFFSET_CURRENT_HP: equ $DC
WINDOW_MEMBERSTATS_OFFSET_CURRENT_MP: equ $130
WINDOW_MEMBERSTATS_OFFSET_ENEMY_EXP: equ $188
WINDOW_MEMBERSTATS_OFFSET_EXP: equ $18A
    else
WINDOW_MEMBERSTATS_OFFSET_ENEMY_LV: equ $8E
WINDOW_MEMBERSTATS_OFFSET_LV: equ $90
WINDOW_MEMBERSTATS_OFFSET_CURRENT_HP: equ $DA
WINDOW_MEMBERSTATS_OFFSET_CURRENT_MP: equ $12E
WINDOW_MEMBERSTATS_OFFSET_ENEMY_EXP: equ $18A
WINDOW_MEMBERSTATS_OFFSET_EXP: equ $18C
    endif
...
WINDOW_MEMBERLIST_HIGHLIGHTSPRITES_COUNTER: equ 2
    endif
...
WINDOW_MEMBERLIST_HEADER_LENGTH: equ $1A
        endif
    else
WINDOW_MEMBERLIST_PAGE_STATS: equ 2
WINDOW_MEMBERLIST_PAGE_NEWATTANDDEF: equ 3
WINDOW_MEMBERLIST_OFFSET_ENTRY_NEWDEFENSE: equ 4
WINDOW_MEMBERLIST_OFFSET_ENTRY_LEVEL: equ $14
WINDOW_MEMBERLIST_HEADER_LENGTH: equ $10
    endif
    
    if (THREE_DIGITS_STATS|EIGHT_CHARACTERS_MEMBER_NAMES=0)
WINDOW_MEMBERLIST_OFFSET_ENTRY_START: equ $10
    else
WINDOW_MEMBERLIST_OFFSET_ENTRY_START: equ $12
    endif

; ---------------------------------------------------------------------------

; enum Window_MiniStatus
WINDOW_MINISTATUS_PAGE_MEMBER: equ $0
WINDOW_MINISTATUS_PAGE_ITEMS: equ $1
WINDOW_MINISTATUS_PAGE_MAGIC: equ $2
WINDOW_MINISTATUS_HIGHLIGHTSPRITES_COUNTER: equ $2
WINDOW_MINISTATUS_PAGE_EQUIP: equ $3
WINDOW_MINISTATUS_OFFSET_NEXT_LINE: equ $2A
WINDOW_MINISTATUS_OFFSET_NAME: equ $2C
WINDOW_MINISTATUS_OFFSET_STATUSEFFECT_TILES: equ $4E
WINDOW_MINISTATUS_OFFSET_NEXT_ITEM: equ $54
WINDOW_MINISTATUS_OFFSET_NEXT_SPELL: equ $54
WINDOW_MINISTATUS_MEMBER_OFFSET_MAGICITEM_STRING: equ $80
WINDOW_MINISTATUS_ITEMS_OFFSET_ITEM_STRING: equ $82
WINDOW_MINISTATUS_MAGIC_OFFSET_MAGIC_STRING: equ $82
WINDOW_MINISTATUS_EQUIP_OFFSET_EQUIPMENT_STRING: equ $82
WINDOW_MINISTATUS_MEMBER_OFFSET_ITEMSLIST_START: equ $C0
WINDOW_MINISTATUS_ITEMS_OFFSET_ITEMSLIST_START: equ $C0
WINDOW_MINISTATUS_EQUIP_OFFSET_ATT_STRING: equ $EA
WINDOW_MINISTATUS_EQUIP_OFFSET_DEF_STRING: equ $13E
WINDOW_MINISTATUS_EQUIP_OFFSET_AGI_STRING: equ $192
WINDOW_MINISTATUS_EQUIP_OFFSET_MOV_STRING: equ $1E6
WINDOW_MINISTATUS_SIZE: equ $150D
WINDOW_MINISTATUS_DEST: equ $20F3

    if (EXTENDED_SPELL_NAMES=0)
WINDOW_MINISTATUS_OFFSET_SPELL_LEVEL: equ $2C
WINDOW_MINISTATUS_MEMBER_OFFSET_MAGICLIST_START: equ $AC
WINDOW_MINISTATUS_MAGIC_OFFSET_MAGICLIST_START: equ $C0
    else
WINDOW_MINISTATUS_OFFSET_SPELL_LEVEL: equ $10
WINDOW_MINISTATUS_MEMBER_OFFSET_MAGICLIST_START: equ $AA
WINDOW_MINISTATUS_MAGIC_OFFSET_MAGICLIST_START: equ $BE
    endif
...
UNKNOWN_STAT_VALUE_THRESHOLD: equ 400
    endif
...
VDPTILE_STATUSEFFECT_MUDDLE: equ $E2
...
VDPTILE_SPELL_LV1: equ $F0
VDPTILE_SPELL_LV2: equ $F1
VDPTILE_SPELL_LV3: equ $F2
VDPTILE_SPELL_LV4: equ $F3
VDPTILE_SPELL_LV5: equ $F4
VDPTILE_SPELL_LV6: equ $F5
VDPTILE_SPELL_LV7: equ $F6
VDPTILE_SPELL_LV8: equ $F7
...
VDPTILE_PLT2: equ $2000
VDPTILE_PLT3: equ $4000
VDPTILE_PLT4: equ $6000
