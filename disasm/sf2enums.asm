...
; enum Window_MemberList_Patch_ThreeDigitsStats
                if (THREE_DIGITS_STATS=1)
WINDOW_MEMBERLIST_ENTRY_NEW_DEFENSE_OFFSET: equ 4
WINDOW_MEMBERLIST_HEADER_LENGTH: equ $1A
                else
WINDOW_MEMBERLIST_ENTRY_NEW_DEFENSE_OFFSET: equ $8
...
WINDOW_MEMBERLIST_ENTRY_FIRST_OFFSET: equ $12
                else
WINDOW_MEMBERLIST_HIGHLIGHT_SPRITES_COUNTER: equ $1
WINDOW_MEMBERLIST_ENTRY_FIRST_OFFSET: equ $10
                endif
...
VDPTILE_IDX_MEMBERLIST_ARROWPOINTINGRIGHT: equ $C0A0
VDPTILE_IDX_MEMBERLIST_BATTLEPARTYSWORD: equ $C0B0
