...
cs_5A828:           dc.w $34                ; 0034 SET BLOCKS 110D 101 905
										...
										dc.w $101
										dc.w $905
										dc.w 4                  ; 0004 INIT TEXT CURSOR 76F : "{LEADER} decides to{N}take the fairy with him.{W1}"
										dc.w $76F
...
cs_5A8CA:           dc.w 4                  ; 0004 INIT TEXT CURSOR 773 : "I'm {NAME;14}, a knight.{N}I was looking for a magic{N}sword.{W2}"
										dc.w $773
										...
										dc.w $C                 ; 000C JUMP IF SET FLAG 59 5A8E6 : YES/NO prompt answer
										dc.w $59
										dc.l cs_5A8E6           
...
cs_5A8E6:           dc.w 8                  ; 0008 JOIN FORCE E
										...
										dc.w $E
										dc.w $FFFF              ; END OF CUTSCENE SCRIPT
cs_5A90E:           dc.w 4                  ; 0004 INIT TEXT CURSOR 780 : "I really want to find the{N}legendary magic sword....{W2}"
										dc.w $780
										...
										dc.w $E
										dc.w $11                ; 0011 STORY YESNO PROMPT
										dc.w $C                 ; 000C JUMP IF SET FLAG 59 5A92A : YES/NO prompt answer
										dc.w $59
										dc.l word_5A92A         
...
word_5A92A:         dc.w 8                  ; 0008 JOIN FORCE E
										...
										dc.w $E
										dc.w $FFFF              ; END OF CUTSCENE SCRIPT
cs_5A93A:           dc.w 4                  ; 0004 INIT TEXT CURSOR 776 : "Hee, hee...I'm not only a{N}dwarf, I'm {NAME;16}.{W2}"
										dc.w $776
										...
										dc.w $10
										dc.w $11                ; 0011 STORY YESNO PROMPT
										dc.w $C                 ; 000C JUMP IF SET FLAG 59 5A956 : YES/NO prompt answer
										dc.w $59
										dc.l word_5A956         
...
word_5A956:         dc.w 8                  ; 0008 JOIN FORCE 10
										...
										dc.w $10
										dc.w $FFFF              ; END OF CUTSCENE SCRIPT
cs_5A97E:           dc.w 4                  ; 0004 INIT TEXT CURSOR 783 : "I was surprised to find I{N}had returned to my original{N}size!{W2}"
										dc.w $783
										...
										dc.w $10
										dc.w $11                ; 0011 STORY YESNO PROMPT
										dc.w $C                 ; 000C JUMP IF SET FLAG 59 5A99A : YES/NO prompt answer
										dc.w $59
										dc.l word_5A99A         
...
word_5A99A:         dc.w 8                  ; 0008 JOIN FORCE 10
										...
										dc.w $10
										dc.w $FFFF              ; END OF CUTSCENE SCRIPT
cs_5A9AA:           dc.w 4                  ; 0004 INIT TEXT CURSOR 779 : "I'm {NAME;17}, a mage.{N}I studied magic in Ponpei.{W2}"
										dc.w $779
										...
										dc.w $11
										dc.w $11                ; 0011 STORY YESNO PROMPT
										dc.w $C                 ; 000C JUMP IF SET FLAG 59 5A9C6 : YES/NO prompt answer
										dc.w $59
										dc.l word_5A9C6         
...
word_5A9C6:         dc.w 8                  ; 0008 JOIN FORCE 11
										...
										dc.w $11
										dc.w $FFFF              ; END OF CUTSCENE SCRIPT
cs_5A9EE:           dc.w 4                  ; 0004 INIT TEXT CURSOR 786 : "I'm not sure why, but I'm{N}free.{W2}"
										dc.w $786
										...
										dc.w $11
										dc.w $11                ; 0011 STORY YESNO PROMPT
										dc.w $C                 ; 000C JUMP IF SET FLAG 59 5AA0A : YES/NO prompt answer
										dc.w $59
										dc.l word_5AA0A         
...
word_5AA0A:         dc.w 8                  ; 0008 JOIN FORCE 11
										...
										dc.w $11
										dc.w $FFFF              ; END OF CUTSCENE SCRIPT
cs_5AA1A:           dc.w 4                  ; 0004 INIT TEXT CURSOR 77C : "I'm {NAME;15}, a priest.{N}I think I'm rather young{N}for my profession....{W2}"
										dc.w $77C
										...
										dc.w $F
										dc.w $11                ; 0011 STORY YESNO PROMPT
										dc.w $C                 ; 000C JUMP IF SET FLAG 59 5AA36 : YES/NO prompt answer
										dc.w $59
										dc.l word_5AA36         
...
word_5AA36:         dc.w 8                  ; 0008 JOIN FORCE F
										...
										dc.w $F
										dc.w $FFFF              ; END OF CUTSCENE SCRIPT
cs_5AA5E:           dc.w 4                  ; 0004 INIT TEXT CURSOR 789 : "I'm free!  Fresh air smells{N}so good!{W2}"
										dc.w $789
										...
										dc.w $F
										dc.w $11                ; 0011 STORY YESNO PROMPT
										dc.w $C                 ; 000C JUMP IF SET FLAG 59 5AA7A : YES/NO prompt answer
										dc.w $59
										dc.l word_5AA7A         
