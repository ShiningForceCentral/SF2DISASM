...
sub_52EF2:
										...
										trap    #CHECK_FLAG
										dc.w $25F               ; set after talking to Astral about going to the tower
										bne.s   loc_52F04
										lea     cs_52F0C(pc), a0
										trap    #6
										trap    #SET_FLAG
...
cs_52F0C:           dc.w 4                  ; 0004 INIT TEXT CURSOR 23F : "I didn't want to involve{N}you, my children...but{N}this might be a good{W2}{N}opportunity for you to{N}learn how to properly{N}serve your King.{W2}{N}Are you ready, {LEADER}?{W1}"
										dc.w $23F
										...
										dc.w $C                 ; 000C JUMP IF SET FLAG 59 52F40 : YES/NO prompt answer
...
cs_52F24:           dc.w 4                  ; 0004 INIT TEXT CURSOR 241 : "Are you ready, {LEADER}?{W1}"
										dc.w $241
										...
										dc.w $59
										dc.l cs_52F40           ; 0005 PLAY SOUND 
										dc.w 4                  ; 0004 INIT TEXT CURSOR 240 : "Then, I'll wait for you here.{W2}{N}We have to hurry.{N}Come back when you're{N}ready.{W1}"
										dc.w $240
										dc.w 0                  ; 0000 DISPLAY SINGLE TEXTBOX 8C : "Then, I'll wait for you here.{W2}{N}We have to hurry.{N}Come back when you're{N}ready.{W1}"
										dc.w $8C
										dc.w $FFFF              ; END OF CUTSCENE SCRIPT
cs_52F40:           dc.w 4                  ; 0004 INIT TEXT CURSOR 242 : "Good!{N}Let's go to the tower.{N}Follow me.{W1}"
										dc.w $242
										...
										dc.b $3F
										dc.b 2
										dc.w $10                ; 0010 SET FLAG 260 FFFF : set after agreeing to go to the tower with Astral
										dc.w $260
										dc.w $FFFF
										dc.w $FFFF              ; END OF CUTSCENE SCRIPT
