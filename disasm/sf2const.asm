...
SAVE1_DATA: equ $2000B1
    if (EXPANDED_SRAM=1)
SRAM_STRING: equ $202011+EXPANDED_SAVE_SLOT_SIZE*2
SAVE_FLAGS: equ $202035+EXPANDED_SAVE_SLOT_SIZE*2
SAVE1_CHECKSUM: equ $202037+EXPANDED_SAVE_SLOT_SIZE*2
SAVE2_CHECKSUM: equ $202039+EXPANDED_SAVE_SLOT_SIZE*2
SAVE2_DATA: equ $20203B+EXPANDED_SAVE_SLOT_SIZE*2
    else
...
CARAVAN_ITEMS_NUMBER: equ $FFF644+DEALS_ITEMS_EXPANSION_SIZE
CARAVAN_ITEMS: equ $FFF646+DEALS_ITEMS_EXPANSION_SIZE
GAME_FLAGS: equ $FFF686+DEALS_ITEMS_EXPANSION_SIZE+CARAVAN_ITEMS_EXPANSION_SIZE
BATTLE_AREA_X: equ $FFF706+DEALS_ITEMS_EXPANSION_SIZE+CARAVAN_ITEMS_EXPANSION_SIZE
BATTLE_AREA_Y: equ $FFF707+DEALS_ITEMS_EXPANSION_SIZE+CARAVAN_ITEMS_EXPANSION_SIZE
BATTLE_AREA_WIDTH: equ $FFF708+DEALS_ITEMS_EXPANSION_SIZE+CARAVAN_ITEMS_EXPANSION_SIZE
BATTLE_AREA_HEIGHT: equ $FFF709+DEALS_ITEMS_EXPANSION_SIZE+CARAVAN_ITEMS_EXPANSION_SIZE
PLAYER_TYPE: equ $FFF710+DEALS_ITEMS_EXPANSION_SIZE+CARAVAN_ITEMS_EXPANSION_SIZE
CURRENT_MAP: equ $FFF711+DEALS_ITEMS_EXPANSION_SIZE+CARAVAN_ITEMS_EXPANSION_SIZE
CURRENT_BATTLE: equ $FFF712+DEALS_ITEMS_EXPANSION_SIZE+CARAVAN_ITEMS_EXPANSION_SIZE
RAFT_MAP_INDEX: equ $FFF713+DEALS_ITEMS_EXPANSION_SIZE+CARAVAN_ITEMS_EXPANSION_SIZE
RAFT_X: equ $FFF714+DEALS_ITEMS_EXPANSION_SIZE+CARAVAN_ITEMS_EXPANSION_SIZE
RAFT_Y: equ $FFF715+DEALS_ITEMS_EXPANSION_SIZE+CARAVAN_ITEMS_EXPANSION_SIZE
MESSAGE_SPEED: equ $FFF717+DEALS_ITEMS_EXPANSION_SIZE+CARAVAN_ITEMS_EXPANSION_SIZE
DISPLAY_BATTLE_MESSAGES: equ $FFF718+DEALS_ITEMS_EXPANSION_SIZE+CARAVAN_ITEMS_EXPANSION_SIZE
EGRESS_MAP_INDEX: equ $FFF719+DEALS_ITEMS_EXPANSION_SIZE+CARAVAN_ITEMS_EXPANSION_SIZE
BATTLE_TURN_ORDER: equ $FFF71A+DEALS_ITEMS_EXPANSION_SIZE+CARAVAN_ITEMS_EXPANSION_SIZE
BATTLE_CURRENT_TURN_OFFSET: equ $FFF79A+DEALS_ITEMS_EXPANSION_SIZE+CARAVAN_ITEMS_EXPANSION_SIZE
SECONDS_COUNTER_FROM_SRAM: equ $FFF79C+DEALS_ITEMS_EXPANSION_SIZE+CARAVAN_ITEMS_EXPANSION_SIZE
SPECIAL_BATTLE_RECORD: equ $FFF7A0+DEALS_ITEMS_EXPANSION_SIZE+CARAVAN_ITEMS_EXPANSION_SIZE
ENEMY_ITEM_DROPS: equ $FFF7A4+DEALS_ITEMS_EXPANSION_SIZE+CARAVAN_ITEMS_EXPANSION_SIZE
CURRENT_MITHRIL_WEAPON_INDEX: equ $FFF7A8+DEALS_ITEMS_EXPANSION_SIZE+CARAVAN_ITEMS_EXPANSION_SIZE
