...
SPRITE_BATTLE_CURSOR: equ $FFDCC0
SPRITE_NAME_HIGHLIGHT_LINK: equ $FFDCCB
SPRITE_BATTLESCENE_WEAPON: equ $FFDCD0
SPRITE_BATTLESCENE_GROUND: equ $FFDCF0
...
NO_BATTLE_MESSAGES_TOGGLE: equ $FFF718
