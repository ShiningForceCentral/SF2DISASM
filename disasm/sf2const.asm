...
Z80_CHANNEL_1_NOT_IN_USE: equ $A01713
    else
...
TILE_ANIMATION_DATA_ADDRESS: equ $FFA852
TILE_ANIMATION_COUNTER: equ $FFA856
TILE_ANIMATION_MAP_INDEX: equ $FFA858
WINDOW_LAYOUTS_END: equ $FFA859
WINDOW_ENTRIES: equ $FFA85D
byte_FFA8FE: equ $FFA8DD
byte_FFA8FF: equ $FFA8DE
MOVING_WINDOWS_BITMAP: equ $FFA8DF
...
ENTITY_RAFT_DATA: equ ENTITY_DATA+NEXT_ENTITYDEF*ENTITY_UNIT_RAFT
...
ENTITY_UNIT_CURSOR_DATA: equ ENTITY_DATA+NEXT_ENTITYDEF*ENTITY_UNIT_CURSOR
FOLLOWERS_LIST: equ $FFAF53
byte_FFAF23: equ $FFAF54
byte_FFAF26: equ $FFAF57
word_FFAF42: equ $FFAF5A
SPRITE_SIZE: equ $FFAF5C
MAP_AREA_LAYER_TYPE: equ $FFAF5E
byte_FFAF47: equ $FFA8E0
...
BATTLESCENE_BATTLESPRITE_TOGGLE: equ $FFAFA1
BATTLESCENE_WEAPONSPRITE_TOGGLE: equ $FFAFAA
BATTLESCENE_GROUNDSPRITE_TOGGLE: equ $FFAFAE
...
PORTRAIT_TILE_FLAGS: equ $FFB07E
...
SPRITE_TRADEMARK: equ $FFDCA0
SPRITE_TRADEMARK_TILE_FLAGS: equ $FFDCA4
SPRITE_05: equ $FFDCA8
SPRITE_07: equ $FFDCB8
SPRITE_07_LINK: equ $FFDCBB
SPRITE_CURSOR_DATA: equ $FFDCC0
SPRITE_NAME_HILIGHT_END: equ $FFDCCB
SPRITE_WEAPON_DATA: equ $FFDCD0
SPRITE_NAME_HILIGHT_END_NEW: equ $FFDCD3 ; EIGHT_CHARACTERS_MEMBER_NAMES
SPRITE_GROUND_DATA: equ $FFDCF0
SPRITE_GROUND_TILE_FLAGS: equ $FFDCF4
SPRITE_GROUND_Y: equ $FFDCF6
...
ALLY_NAME_LOADING_SPACE: equ $FFE800
    ...
    rsset savedDataStart
COMBATANT_ENTRIES:          rs.b COMBATANT_ENTRIES_SIZE
CURRENT_GOLD:               rs.b CURRENT_GOLD_SIZE
DEALS_ITEMS:                rs.b DEALS_ITEMS_SIZE
CARAVAN_ITEMS_NUMBER:       rs.b CARAVAN_ITEMS_NUMBER_SIZE
CARAVAN_ITEMS:              rs.b CARAVAN_ITEMS_SIZE
GAME_FLAGS:                 rs.b GAME_FLAGS_SIZE
BATTLE_AREA_X:              rs.b BATTLE_AREA_X_SIZE
BATTLE_AREA_Y:              rs.b BATTLE_AREA_Y_SIZE
BATTLE_AREA_WIDTH:          rs.b BATTLE_AREA_WIDTH_SIZE
BATTLE_AREA_HEIGHT:         rs.b BATTLE_AREA_HEIGHT_SIZE
PLAYER_TYPE:                rs.b PLAYER_TYPE_SIZE
CURRENT_MAP:                rs.b CURRENT_MAP_SIZE
CURRENT_BATTLE:             rs.b CURRENT_BATTLE_SIZE
RAFT_MAP:                   rs.b RAFT_MAP_SIZE
RAFT_X:                     rs.b RAFT_MAP_SIZE
RAFT_Y:                     rs.b RAFT_Y_SIZE
MESSAGE_SPEED:              rs.b MESSAGE_SPEED_SIZE
DISPLAY_BATTLE_MESSAGES:    rs.b DISPLAY_BATTLE_MESSAGES_SIZE
EGRESS_MAP:                 rs.b EGRESS_MAP_SIZE
BATTLE_TURN_ORDER:          rs.b BATTLE_TURN_ORDER_SIZE
CURRENT_BATTLE_TURN:        rs.b CURRENT_BATTLE_TURN_SIZE
SAVED_SECONDS_COUNTER:      rs.b SAVED_SECONDS_COUNTER_SIZE
SPECIAL_BATTLE_RECORD:      rs.b SPECIAL_BATTLE_RECORD_SIZE
ENEMY_ITEM_DROPPED_FLAGS:   rs.b ENEMY_ITEM_DROPPED_FLAGS_SIZE
MITHRIL_WEAPONS_ON_ORDER:   rs.b MITHRIL_WEAPONS_ON_ORDER_SIZE
...
; For use with MOVEP instruction when RELOCATED_SAVED_DATA_TO_SRAM is enabled.
CURRENT_GOLD_OFFSET:                equ CURRENT_GOLD-COMBATANT_ENTRIES
DEALS_ITEMS_OFFSET:                 equ DEALS_ITEMS-COMBATANT_ENTRIES
CARAVAN_ITEMS_NUMBER_OFFSET:        equ CARAVAN_ITEMS_NUMBER-COMBATANT_ENTRIES
CARAVAN_ITEMS_OFFSET:               equ CARAVAN_ITEMS-COMBATANT_ENTRIES
GAME_FLAGS_OFFSET:                  equ GAME_FLAGS-COMBATANT_ENTRIES
BATTLE_AREA_X_OFFSET:               equ BATTLE_AREA_X-COMBATANT_ENTRIES
BATTLE_AREA_Y_OFFSET:               equ BATTLE_AREA_Y-COMBATANT_ENTRIES
BATTLE_AREA_WIDTH_OFFSET:           equ BATTLE_AREA_WIDTH-COMBATANT_ENTRIES
BATTLE_AREA_HEIGHT_OFFSET:          equ BATTLE_AREA_HEIGHT-COMBATANT_ENTRIES
PLAYER_TYPE_OFFSET:                 equ PLAYER_TYPE-COMBATANT_ENTRIES
CURRENT_MAP_OFFSET:                 equ CURRENT_MAP-COMBATANT_ENTRIES
CURRENT_BATTLE_OFFSET:              equ CURRENT_BATTLE-COMBATANT_ENTRIES
RAFT_MAP_OFFSET:                    equ RAFT_MAP-COMBATANT_ENTRIES
RAFT_X_OFFSET:                      equ RAFT_X-COMBATANT_ENTRIES
RAFT_Y_OFFSET:                      equ RAFT_Y-COMBATANT_ENTRIES
MESSAGE_SPEED_OFFSET:               equ MESSAGE_SPEED-COMBATANT_ENTRIES
DISPLAY_BATTLE_MESSAGES_OFFSET:     equ DISPLAY_BATTLE_MESSAGES-COMBATANT_ENTRIES
EGRESS_MAP_OFFSET:                  equ EGRESS_MAP-COMBATANT_ENTRIES
BATTLE_TURN_ORDER_OFFSET:           equ BATTLE_TURN_ORDER-COMBATANT_ENTRIES
CURRENT_BATTLE_TURN_OFFSET:         equ CURRENT_BATTLE_TURN-COMBATANT_ENTRIES
SAVED_SECONDS_COUNTER_OFFSET:       equ SAVED_SECONDS_COUNTER-COMBATANT_ENTRIES
SPECIAL_BATTLE_RECORD_OFFSET:       equ SPECIAL_BATTLE_RECORD-COMBATANT_ENTRIES
ENEMY_ITEM_DROPPED_FLAGS_OFFSET:    equ ENEMY_ITEM_DROPPED_FLAGS-COMBATANT_ENTRIES
MITHRIL_WEAPONS_ON_ORDER_OFFSET:    equ MITHRIL_WEAPONS_ON_ORDER-COMBATANT_ENTRIES
