...
saveSlotsStart = savedDataStart+SAVE_SLOT_SIZE
    else
...
SAVE1_DATA:     equ saveSlotsStart
SRAM_STRING:    equ SAVE1_DATA+SAVE_SLOT_SIZE
SAVE_FLAGS:     equ SRAM_STRING+SRAM_STRING_SIZE
SAVE1_CHECKSUM: equ SAVE_FLAGS+SAVE_FLAGS_SIZE
SAVE2_CHECKSUM: equ SAVE1_CHECKSUM+SAVE_CHECKSUM_SIZE
SAVE2_DATA:     equ SAVE2_CHECKSUM+SAVE_CHECKSUM_SIZE
...
SPRITE_10_LINK: equ $FFDCD3 ; EIGHT_CHARACTERS_MEMBER_NAMES
...
COMBATANT_ENTRIES:          equ savedDataStart
CURRENT_GOLD:               equ COMBATANT_ENTRIES+COMBATANT_ENTRIES_SIZE
DEALS_ITEMS:                equ CURRENT_GOLD+CURRENT_GOLD_SIZE
CARAVAN_ITEMS_NUMBER:       equ DEALS_ITEMS+DEALS_ITEMS_SIZE
CARAVAN_ITEMS:              equ CARAVAN_ITEMS_NUMBER+CARAVAN_ITEMS_NUMBER_SIZE
GAME_FLAGS:                 equ CARAVAN_ITEMS+CARAVAN_ITEMS_SIZE
BATTLE_AREA_X:              equ GAME_FLAGS+GAME_FLAGS_SIZE
BATTLE_AREA_Y:              equ BATTLE_AREA_X+BATTLE_AREA_X_SIZE
BATTLE_AREA_WIDTH:          equ BATTLE_AREA_Y+BATTLE_AREA_Y_SIZE
BATTLE_AREA_HEIGHT:         equ BATTLE_AREA_WIDTH+BATTLE_AREA_WIDTH_SIZE
PLAYER_TYPE:                equ BATTLE_AREA_HEIGHT+BATTLE_AREA_HEIGHT_SIZE
CURRENT_MAP:                equ PLAYER_TYPE+PLAYER_TYPE_SIZE
CURRENT_BATTLE:             equ CURRENT_MAP+CURRENT_MAP_SIZE
RAFT_MAP:                   equ CURRENT_BATTLE+CURRENT_BATTLE_SIZE
RAFT_X:                     equ RAFT_MAP+RAFT_MAP_SIZE
RAFT_Y:                     equ RAFT_X+RAFT_X_SIZE
MESSAGE_SPEED:              equ RAFT_Y+RAFT_Y_SIZE
DISPLAY_BATTLE_MESSAGES:    equ MESSAGE_SPEED+MESSAGE_SPEED_SIZE
EGRESS_MAP:                 equ DISPLAY_BATTLE_MESSAGES+DISPLAY_BATTLE_MESSAGES_SIZE
BATTLE_TURN_ORDER:          equ EGRESS_MAP+EGRESS_MAP_SIZE
CURRENT_BATTLE_TURN:        equ BATTLE_TURN_ORDER+BATTLE_TURN_ORDER_SIZE
SAVED_SECONDS_COUNTER:      equ CURRENT_BATTLE_TURN+CURRENT_BATTLE_TURN_SIZE
SPECIAL_BATTLE_RECORD:      equ SAVED_SECONDS_COUNTER+SAVED_SECONDS_COUNTER_SIZE
ENEMY_ITEM_DROPPED_FLAGS:   equ SPECIAL_BATTLE_RECORD+SPECIAL_BATTLE_RECORD_SIZE
MITHRIL_WEAPONS_ON_ORDER:   equ ENEMY_ITEM_DROPPED_FLAGS+ENEMY_ITEM_DROPPED_FLAGS_SIZE
