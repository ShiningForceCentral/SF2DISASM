...
;BATTLESCENE
BATTLESCENE_BACKGROUND_MODIFICATION: equ $FFB3C0
word_FFB3C4: equ $FFB3C4
BATTLESCENE_BATTLESPRITE_MODIFICATION: equ $FFB3C6
...
OTHER_FORCE_MEMBER_LIST: equ $FFB653
...
SPRITE_CURSOR_DATA: equ $FFDCC0				; 08-15: battle cursor 8-12: name highlight
SPRITE_NAME_HILIGHT_END: equ $FFDCCB		; last name highlight sprite +3
SPRITE_WEAPON_DATA: equ $FFDCD0				; 10-13
SPRITE_GROUND_DATA: equ $FFDCF0				; 14-16
