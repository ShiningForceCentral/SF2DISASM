...
RAFT_MAP_INDEX: equ $FFF713+CARAVAN_ITEMS_EXPANSION_SIZE
...
EGRESS_MAP_INDEX: equ $FFF719+CARAVAN_ITEMS_EXPANSION_SIZE
BATTLE_TURN_ORDER: equ $FFF71A+CARAVAN_ITEMS_EXPANSION_SIZE
BATTLE_CURRENT_TURN_OFFSET: equ $FFF79A+CARAVAN_ITEMS_EXPANSION_SIZE
SECONDS_COUNTER_FROM_SRAM: equ $FFF79C+CARAVAN_ITEMS_EXPANSION_SIZE
SPECIAL_BATTLE_RECORD: equ $FFF7A0+CARAVAN_ITEMS_EXPANSION_SIZE
ENEMY_ITEM_DROPS: equ $FFF7A4+CARAVAN_ITEMS_EXPANSION_SIZE
CURRENT_MITHRIL_WEAPON_INDEX: equ $FFF7A8+CARAVAN_ITEMS_EXPANSION_SIZE
