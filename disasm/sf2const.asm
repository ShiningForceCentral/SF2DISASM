...
word_FFA82A: equ $FFA82A
PLAYER_ENTITY_IDX: equ $FFA82C
...
FOREGROUND_SCROLLING: equ $FFA846
byte_FFA847: equ $FFA847
BACKGROUND_SCROLLING: equ $FFA848
byte_FFA849: equ $FFA849
...
byte_FFA904: equ $FFA904
word_FFA90E: equ $FFA90E
word_FFA910: equ $FFA910
byte_FFA912: equ $FFA912
...
FIGHTER_BATTLE_XPOS: equ $FFAF90
FIGHTER_BATTLE_YPOS: equ $FFAF91
...
CURRENT_ATTACKER: equ $FFB64E
word_FFB64F: equ $FFB64F
byte_FFB651: equ $FFB651
CURRENT_TARGET: equ $FFB652
byte_FFB653: equ $FFB653
BATTLE_PARTY: equ $FFB682
REST_OF_THE_FORCE: equ $FFB68E
byte_FFB6A2: equ $FFB6A2
MOVE_COST_LIST: equ $FFB6C2
CURRENT_SHOP: equ $FFB6D2
byte_FFB6D4: equ $FFB6D4
byte_FFB6D5: equ $FFB6D5
byte_FFB6D6: equ $FFB6D6
byte_FFB6D7: equ $FFB6D7
byte_FFB6D8: equ $FFB6D8
DIALOG_LINE_NAME: equ $FFB6E8
DIALOG_LINE_SPELL_ITEM: equ $FFB6EA
dword_FFB6EC: equ $FFB6EC
TEXT_NAMES: equ $FFB6F0
DIALOG_LINE_NUMBER: equ $FFB776
word_FFB778: equ $FFB778
dword_FFB77A: equ $FFB77A
dword_FFB77E: equ $FFB77E
dword_FFB782: equ $FFB782
...
byte_FFDC83: equ $FFDC83
dword_FFDC84: equ $FFDC84
...
P1_INPUT_STATE_A: equ $FFDE97
P2_INPUT_STATE_A: equ $FFDE99
