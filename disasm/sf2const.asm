...
ENTITY_CURSOR_DATA: equ ENTITY_DATA+NEXT_ENTITYDEF*ENTITY_UNIT_CURSOR
...
entityEventEnemyStart = $FFB160
    if (STANDARD_BUILD&EXPANDED_FORCE_MEMBERS=1)
entityEventEnemyStart = $FFB17F
    endif
ENTITY_EVENT_ENEMY_START: equ entityEventEnemyStart
...
TEST_BUILD_CURRENT_MESSAGE: equ $FFFFB6C0
