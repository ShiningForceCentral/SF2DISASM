...
; FREE SPACE : 626 bytes.
                ...
                includeIfStandard "code\gameflow\battle\battleloop-standard\triggerregions.asm"
                includeIfStandard "code\gameflow\battle\battleloop-standard\activateenemies.asm"
