...
CreateFighterMiniStatusWindow:
										...
										jmp     CreateFighterMiniStatusWindow_0(pc)
...
CreateLandEffectWindow:
										...
										jmp     CreateLandEffectWindow_0(pc)
...
j_witchSpeechBubbleMenu:
										
										jmp     executeWitchMainMenu(pc)

	; End of function j_witchSpeechBubbleMenu
...
pt_VDPTileOrder_MemberStatsWindow:
										dc.l VDPTileOrder_MemberStatsWindow
...
loc_100F2:
										...
										move.b  (a0)+,d0
										beq.w   loc_10186
										or.w    #VDPTILE_PALETTE3_MASK,d0
										cmp.b   #TEXT_CODE_MOVEDOWN,d0
										beq.s   loc_1016A
										cmp.b   #TEXT_CODE_TOGGLEFONTCOLOR,d0
										beq.s   loc_10174       
										cmp.b   #TEXT_CODE_NEWLINE,d0
										beq.s   loc_1017C
										tst.b   d0
										bpl.s   loc_10118
										sub.w   #$40,d0 
...
loc_10174:
										...
										eor.w   #$FFFF,-2(a6)   ; 0x5C: toggle to/from orange font
										bra.s   loc_10182
loc_1017C:
...
loc_10616:
										...
										beq.s   loc_10630
										moveq   #1,d1
										cmp.w   #$7F,((DISPLAYED_ICON_2-$1000000)).w 
										beq.s   loc_10630
										trap    #0
										dc.w SFX_MENU_SELECTION
										bra.w   loc_106B4
loc_10630:
										...
										beq.s   loc_1064A
										moveq   #2,d1
										cmp.w   #$7F,((DISPLAYED_ICON_3-$1000000)).w 
										beq.s   loc_1064A
										trap    #0
										dc.w SFX_MENU_SELECTION
										bra.w   loc_106B4
...
loc_1065C:
										...
										beq.s   loc_10676
										moveq   #3,d1
										cmp.w   #$7F,((DISPLAYED_ICON_4-$1000000)).w 
										beq.s   loc_10676
										trap    #0
										dc.w SFX_MENU_SELECTION
										bra.w   loc_106B4
...
loc_10AD8:
										...
										beq.s   loc_10AF2
										moveq   #1,d1
										cmp.w   #$3F,((DISPLAYED_ICON_2-$1000000)).w 
										beq.s   loc_10AF2
										trap    #0
										dc.w SFX_MENU_SELECTION
										bra.w   loc_10B76
loc_10AF2:
										...
										beq.s   loc_10B0C
										moveq   #2,d1
										cmp.w   #$3F,((DISPLAYED_ICON_3-$1000000)).w 
										beq.s   loc_10B0C
										trap    #0
										dc.w SFX_MENU_SELECTION
										bra.w   loc_10B76
...
loc_10B1E:
										...
										beq.s   loc_10B38
										moveq   #3,d1
										cmp.w   #$3F,((DISPLAYED_ICON_4-$1000000)).w 
										beq.s   loc_10B38
										trap    #0
										dc.w SFX_MENU_SELECTION
										bra.w   loc_10B76
...
; START OF FUNCTION CHUNK FOR sub_10CC6
...
DIAMENU_LAYOUT:     dc.b   0                ; tile layout for diamond menus
										dc.b   0
										dc.b   0
										dc.b   0
										dc.b   0
...
sub_113C6:
										...
										lea     aAAAAAAAAPATT99PPPPD(pc), a0
										move.w  #$B4,d7 
										jsr     (copyBytes).w   
...
CreateFighterMiniStatusWindow_0:
...
loc_115C4:
	...
	; End of function CreateFighterMiniStatusWindow_0
...
loc_11A4C:
										...
										add.w   #$58,a1 
										move.l  a1,-(sp)
										add.w   ((FIGHTER_MINISTATUS_WINDOW_WIDTH-$1000000)).w,a1
										add.w   ((FIGHTER_MINISTATUS_WINDOW_WIDTH-$1000000)).w,a1
										sub.w   #$C,a1
										move.l  a1,-(sp)
										moveq   #2,d7
...
LoadTileDataForMemberScreen:
										...
										bsr.w   sub_11FF0
										move.w  -8(a6),d0
										lea     VDPTileOrder_MemberKDWindow(pc), a0
										clr.w   d1
										jsr     (GetAddressOfWindowTileDataStartingAtCoord).w
										move.w  #WINDOW_MEMBER_KD_VDPTILEORDER_BYTESIZE,d7
										jsr     (copyBytes).w   
										add.w   #WINDOW_MEMBER_KD_TEXT_KILLS_OFFSET,a1
										move.w  -2(a6),d0
										tst.b   d0
										...
										bsr.w   WriteTilesFromNumber
										add.w   #WINDOW_MEMBER_KD_TEXT_DEFEATS_OFFSET,a1
										move.w  -2(a6),d0
										jsr     j_GetDefeats
										move.w  d1,d0
										ext.l   d0
...
sub_11FF0:
										...
										move.w  d0,-2(a6)
										move.l  a1,-6(a6)
										movea.l (pt_VDPTileOrder_MemberStatsWindow).l,a0
										move.w  #WINDOW_MEMBER_STATS_VDPTILEORDER_BYTESIZE,d7
										jsr     (copyBytes).w   
										move.w  -2(a6),d0
										movea.l -6(a6),a1
										add.w   #WINDOW_MEMBER_STATS_TEXT_CLASS_OFFSET,a1
										tst.b   d0
										blt.s   loc_1202E
										jsr     j_GetClass      
										jsr     j_getClassName
...
windowBorderTiles:  dc.b $C0                ; compressed
										dc.b $F9
										dc.b $C0
										dc.b $FA
										dc.b $C0
...
sub_129E8:
										...
										divs.w  #3,d0
										move.w  d0,-$14(a6)
										move.w  ((word_FFA830-$1000000)).w,d0
										lsr.w   #7,d0
										ext.l   d0
										divs.w  #3,d0
										move.w  d0,-$12(a6)
										move.w  ((word_FFA832-$1000000)).w,d0
										sub.w   ((word_FFA82E-$1000000)).w,d0
										lsr.w   #7,d0
										ext.l   d0
										divs.w  #3,d0
										cmp.w   #$2F,d0 
...
loc_12A20:
										...
										sub.w   ((word_FFA830-$1000000)).w,d1
										lsr.w   #7,d1
										ext.l   d1
										divs.w  #3,d1
										cmp.w   #$2F,d1 
...
loc_132C6:
										...
										cmp.b   #1,((word_FFAF8C-$1000000)).w
										bne.w   loc_13314
										btst    #0,((byte_FFB13C-$1000000)).w
										beq.s   return_13312
										cmp.b   #1,((byte_FFB13C-$1000000)).w
										bne.s   loc_132F6
										clr.w   d1
										jsr     j_GetItemAndNumberOfItems
										tst.w   d2
...
getCharPortraitIdx:
										...
										bhi.w   loc_1576E
										jsr     j_GetClass      
										cmp.b   #$C,d1          ; stupid CMP mechanism for alternate portraits, need to improve that one day
										bne.s   loc_1574E
										moveq   #$2F,d0 
loc_1574E:
...
CreateLandEffectWindow_0:
										...
										move.w  #$201,d1
										move.w  #4,d2
										cmp.w   #$16,((FIGHTER_MINISTATUS_WINDOW_WIDTH-$1000000)).w
										blt.s   loc_157A6
										move.w  #$101,d1
loc_157A6:
	...
	; End of function CreateLandEffectWindow_0
...
copyBattlefieldOptionsMenuLayout:
										...
										lea     menuLayout_BattlefieldConfig(pc), a0
										movea.l -4(a6),a1
										move.w  #$156,d7
										jmp     (copyBytes).w   
...
loc_15D2C:
										...
										cmp.w   #$13,d0
										blt.s   loc_15D46
										cmp.b   #4,((RAM_Battle_CurrentMovingEntityChosenY-$1000000)).w
										beq.w   loc_15D9A
loc_15D46:
...
loc_15D9A:
										...
										cmp.b   #$17,((RAM_Battle_CurrentMovingEntityChosenX-$1000000)).w
										beq.w   loc_15F22
										cmp.b   #$13,((RAM_Battle_CurrentMovingEntityChosenX-$1000000)).w
										bne.s   loc_15D46
loc_15DAC:
...
sub_15FD8:
										...
										lea     menuLayout_AlphabetEnd(pc), a0
										movea.l -8(a6),a1
										move.w  #$2A,d7 
										jsr     (copyBytes).w   
										lea     (byte_FF8805).l,a0
...
sub_1604A:
										...
										lea     menuLayout_NameEntry(pc), a0
										movea.l -$C(a6),a1
										move.w  #$366,d7
										jsr     (copyBytes).w   
										lea     menuLayout_AlphabetEnd(pc), a0
...
loc_1634A:
	...
	; End of function ExecuteNumberPrompt
...
sub_165C0:
										...
										jsr     (GetAddressOfWindowTileDataStartingAtCoord).l
										movem.l a1,-(sp)
										lea     VDPTileOrder_TimerWindow(pc), a0
										moveq   #$40,d7 
										jsr     (copyBytes).w   
										movem.l (sp)+,a1
										add.w   #$22,a1 
...
VDPTileOrder_MemberStatsWindow:
										dc.b $C0 
										dc.b $60 
										dc.b $C0 
										dc.b $61 
